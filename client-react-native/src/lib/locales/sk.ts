...
export const sk: Record<string, string> = {
  ...
  'canasta.round.closed': '{player} zavrel(a) s rozdielom {diff} bodov',
  ...
  'err.BLACK_THREE_GO_OUT_ONLY': 'Čierne trojky sa vykladajú len ťahom, ktorý vyprázdni tvoju ruku',
  ...
  'err.UNDO_MELDS_FIRST': 'Najprv vráť to, čo si vyložil po vzatí kôpky',
  ...
  'canasta.remedy.needMorePoints': 'Prvej kombinácii tvojej strany chýba {n} bodov do {floor}.',
  ...
  'canasta.remedy.undoMeldsFirst':
    'Najprv vráť kombinácie vyložené po vzatí kôpky — potom sa dá vrátiť aj samotná kôpka.',
  ...
  'match.you': 'ty',
  'match.yourTeam': 'Tvoj tím',
  'match.teammates': 'Tím: {names}',
  ...
  'option.openDiscardPile': 'Odhadzovací balíček',
  'choice.openDiscardPile.1': 'Možno prezerať',
  'choice.openDiscardPile.0': 'Len vrchná karta',
  ...
  'replay.round': 'Kolo',
  'replay.track.all': 'Všetko',
  'replay.track.yours': 'Tvoje ťahy',
  'replay.track.rounds': 'Kolá',
  ...
  'err.ALREADY_SHOWN': 'Vaše karty už ležia lícom nahor',
  'err.NOTHING_TO_SHOW': 'Nemáte čo ukázať',
  'holdem.offer.show': 'Ukázať karty',
  'holdem.offer.finish': 'Ukončiť zápas',
  'holdem.remedy.nothingToShow': 'V tomto rozdaní ste nehrali — počkajte na ďalšie.',
  'holdem.rules.section.showdown': 'Po rozdaní',
  'holdem.rules.stopEveryHand': 'Hra sa po každom rozdaní zastaví, aby bolo vidieť na karty.',
  'holdem.rules.revealEveryone': 'Pri vyložení sa odkryjú všetky dohraté listy.',
  'holdem.rules.revealWinners': 'Pri vyložení sa odkryje len víťazný list.',
  'holdem.rules.showYourOwn': 'Svoje karty môžete odkryť vždy, kým nepotvrdíte pokračovanie.',
  'holdem.rules.showOnce': 'Karty možno ukázať iba raz.',
  'holdem.seat.won': 'Vyhral',
  'holdem.seat.mucked': 'Neukázal',
  'holdem.status.mucked': '{playerId} karty neukázal',
  'holdem.status.shownVoluntary': '{playerId} ukázal svoje karty',
  'zone.shownHand': 'Odkryté karty',
  'option.showdownReveal': 'Odkrytie pri vyložení',
  'choice.showdownReveal.2': 'Všetci dohrávajúci',
  'choice.showdownReveal.1': 'Len víťaz',
  'home.playOffline': 'Hrať offline',
  'offline.title': 'Hrať offline',
  'offline.subtitle': 'Bez internetu',
  'offline.body': 'Stôl hostí priamo tento telefón, takže môžete hrať proti botom kdekoľvek — aj v režime lietadla.',
  'offline.nameLabel': 'Vaše meno pri stole',
  'offline.start': 'Založiť offline stôl',
  'offline.starting': 'Spúšťam…',
  'offline.active': 'Ste pri offline stole tohto telefónu. Hry, ktoré tu založíte, zostanú v tomto telefóne.',
  'offline.chooseGame': 'Vybrať hru',
  'offline.backOnline': 'Späť k hraniu online',
  'offline.failed': 'Offline stôl sa nespustil: {reason}',
  'offline.nearbyTitle': 'Stoly v okolí',
  'offline.nearbyLooking': 'Hľadám stoly v tejto sieti…',
  'offline.nearbyNothing': 'Zatiaľ žiadne stoly. Overte, že ste na rovnakej Wi-Fi alebo hotspote ako hostiteľ a že Zolik smie používať miestnu sieť.',
  'offline.joinThis': 'Pripojiť sa',
  'offline.byAddressTitle': 'Pripojiť sa podľa adresy',
  'offline.versionMismatch': 'Tento stôl beží na inej verzii Zoliku. Aktualizujte aplikáciu na oboch telefónoch.',
  'offline.roomTitle': 'Hráči v okolí',
  'offline.roomBody': 'Umožnite ostatným telefónom na tejto Wi-Fi alebo hotspote prisadnúť si k vášmu stolu. Internet nie je potrebný.',
  'offline.roomOpenButton': 'Pozvať hráčov v okolí',
  'offline.roomOpen': 'Ostatné telefóny v tejto sieti teraz váš stôl nájdu. Ak ho nevidia, môžu zadať adresu alebo naskenovať kód.',
  'offline.roomClose': 'Prestať pozývať',
  'offline.guestActive': 'Sedíte pri stole, ktorý hostí iný telefón ({host}).',
  'offline.joinFailed': 'K tomuto stolu sa nepodarilo pripojiť: {reason}',
  'invite.offlineExplain': 'Hráči pri tomto offline stole sa pripoja týmto kódom v ponuke „{menu}“.',
  'invite.offlineCode': 'Kód:',
  'offline.bleTitle': 'Cez Bluetooth',
  'offline.bleLook': 'Hľadať stoly cez Bluetooth',
  'offline.bleLooking': 'Hľadám stoly cez Bluetooth…',
  'offline.bleOff': 'Zapnite Bluetooth, aby ste našli stoly bez Wi-Fi.',
  'offline.bleDenied': 'Povoľte Zoliku v Nastaveniach používať Bluetooth, aby ste mohli hrať bez Wi-Fi.',
  'offline.bleInvite': 'Pozvať cez Bluetooth',
  'offline.bleInviteBody': 'Pre telefóny, ktoré s vaším nezdieľajú Wi-Fi. Párovanie nie je potrebné.',
  'offline.bleOpen': 'Telefóny v okolí sa môžu pripojiť cez Bluetooth. Pripojené: {n}.',
  'offline.bleStop': 'Vypnúť Bluetooth',
  'offline.bleCheck': 'Kontrolný kód: {code}',
  'offline.guestBle': 'Sedíte pri stole, ktorý hostí iný telefón, cez Bluetooth.',
  'offline.keyChanged': 'Toto nie je telefón, pri ktorom ste pod týmto menom hrali predtým. Opýtajte sa hostiteľa alebo sa pripojte cez Wi-Fi.',
  // --- game notifications: invites, the game circle, push (src/notify) ---
  'err.NOT_PLAYED_TOGETHER': 'Pridať môžete len ľudí, s ktorými ste hrali. Pošlite im odkaz pre priateľov alebo ich požiadajte cez používateľské meno.',
  'err.UNKNOWN_PLAYER': 'Pod týmto menom nikto nehrá.',
  'err.UNKNOWN_FRIEND_CODE': 'Tento odkaz pre priateľov už nefunguje.',
  'err.CANNOT_ADD_SELF': 'To ste vy. Pridajte niekoho iného.',
  'err.RATE_LIMITED': 'Príliš veľa naraz. Skúste to o pár minút.',
  'err.PUSH_UNAVAILABLE': 'Tento server nemá nastavené upozornenia.',
  'notify.someone': 'Niekto',
  'notify.join': 'Prisadnúť',
  'notify.joining': 'Prisadám…',
  'notify.goToTable': 'K stolu',
  'notify.notNow': 'Teraz nie',
  'notify.moreOptions': 'Ďalšie možnosti',
  'notify.muteHost': 'Neprijímať pozvánky od hráča {host}',
  'notify.joinFailed': 'Nepodarilo sa prisadnúť: {reason}',
  'notify.hostingOffline': 'Na tomto telefóne hostíte stôl. Najprv ho opustite, potom môžete prisadnúť inde.',
  'notify.on': 'Zapnuté',
  'notify.off': 'Vypnuté',
  'notify.channelName': 'Pozvánky na hru',
  'notify.banner.online': '{host} otvoril(a) stôl: {game}',
  'notify.banner.onlineNoGame': '{host} otvoril(a) stôl',
  'notify.banner.nearby': '{host} hostí stôl nablízku',
  'notify.banner.seated': 'Posadili vás k stolu',
  'notify.banner.fromCircle': 'Z vášho herného kruhu',
  'notify.banner.known': 'Už ste spolu hrali',
  'notify.banner.nearbyDetail': 'Na telefóne vo vašej blízkosti',
  'notify.banner.seatedDetail': 'Hostiteľ si vás vybral z čakárne',
  'notify.banner.more': '+{n} ďalšie',
  'notify.pillOne': 'Čaká 1 stôl',
  'notify.pillMany': 'Čakajúce stoly: {n}',
  'notify.waitingCard.title': 'Stoly, ktoré na vás čakajú',
  'notify.waitingCard.empty': 'Žiadny stôl na vás nečaká.',
  'notify.prompt.title': 'Dozviete sa, keď váš kruh začína hru',
  'notify.prompt.body': 'Len stoly, ktoré otvoria ľudia z vášho herného kruhu. Vypnúť to môžete v Nastaveniach.',
  'notify.prompt.enable': 'Zapnúť',
  'notify.prompt.later': 'Neskôr',
  'notify.settings.heading': 'Upozornenia',
  'notify.settings.invites': 'Pozvánky na hru',
  'notify.settings.invitesBody': 'Kto vám smie dať vedieť, že otvoril stôl.',
  'notify.settings.invitesCircle': 'Môj kruh',
  'notify.settings.invitesOff': 'Nikto',
  'notify.settings.nearby': 'Stoly nablízku',
  'notify.settings.nearbyBody': 'Zobraziť upozornenie, keď telefón vo vašej blízkosti otvorí stôl. Funguje, keď je aplikácia otvorená.',
  'notify.settings.push': 'Upozornenia na tomto zariadení',
  'notify.settings.pushOn': 'Zapnuté. O stoloch sa dozviete, aj keď je aplikácia zatvorená.',
  'notify.settings.pushOff': 'Vypnuté. Pozvánky sa zobrazia len v otvorenej aplikácii.',
  'notify.settings.pushBlocked': 'Zablokované. Povoľte upozornenia pre túto aplikáciu v nastaveniach telefónu.',
  'notify.settings.pushBlockedWeb': 'Zablokované. Povoľte upozornenia pre tento web v nastaveniach prehliadača.',
  'notify.settings.pushInstall': 'Na iPhone a iPade najprv pridajte tento web na plochu a upozornenia zapnite tam.',
  'notify.settings.pushUnavailable': 'Tento server upozornenia neposiela.',
  'notify.settings.pushUnsupported': 'Toto zariadenie alebo prehliadač nevie zobrazovať upozornenia.',
  'notify.settings.signIn': 'Prihláste sa alebo hrajte ako hosť, aby ste dostávali pozvánky na hru.',
  'notify.announce.heading': 'Dať vedieť môjmu kruhu',
  'notify.announce.body': 'Ľudia z vášho herného kruhu sa o tomto stole dozvedia a môžu prisadnúť jedným ťuknutím.',
  'notify.announce.toggle': 'Dať vedieť kruhu, keď otvorím stôl',
  'notify.announce.sending': 'Dávam vedieť vášmu kruhu…',
  'notify.announce.toldOne': 'Dali sme vedieť 1 hráčovi',
  'notify.announce.toldMany': 'Dali sme vedieť hráčom: {n}',
  'notify.announce.already': 'Váš kruh už o tomto stole vie.',
  'notify.announce.nobody': 'Zatiaľ nie je komu dať vedieť. Pridajte ľudí do svojho kruhu.',
  'notify.announce.circleLink': 'Herný kruh',
  'notify.addToCircle': 'Pridať hráča {name} do kruhu',
  ...
  'offline.tellNearbyBody': 'Telefónom v miestnosti s otvorenou aplikáciou sa tento stôl ponúkne.',
  'circle.title': 'Herný kruh',
  'circle.subtitle': 'Ľudia, ktorým dáte vedieť, keď otvoríte stôl, a ľudia, ktorí dajú vedieť vám.',
  'circle.signInRequired': 'Prihláste sa alebo hrajte ako hosť, aby ste si mohli vytvoriť herný kruh.',
  'circle.requests.heading': 'Žiadosti',
  'circle.requests.body': 'Chceli by vám dávať vedieť, keď otvoria stôl.',
  'circle.accept': 'Prijať',
  'circle.decline': 'Odmietnuť',
  'circle.members.heading': 'Váš kruh',
  'circle.members.body': 'Dozvedia sa o stoloch, ktoré otvoríte pre priateľov.',
  'circle.members.empty': 'Zatiaľ nikto. Pridajte ľudí nižšie.',
  'circle.pending': 'Čaká na prijatie',
  'circle.since': 'Od {date}',
  'circle.remove': 'Odobrať',
  'circle.notifiers.heading': 'Kto vás môže pozvať',
  'circle.notifiers.body': 'Stlmte každého, o koho stoloch nechcete počuť.',
  'circle.notifiers.empty': 'Zatiaľ si vás nikto nepridal.',
  'circle.mute': 'Stlmiť',
  'circle.unmute': 'Zrušiť stlmenie',
  'circle.muted': 'Stlmené',
  'circle.suggestions.heading': 'Nedávno ste hrali',
  'circle.suggestions.body': 'Ľudia, s ktorými ste sedeli pri stole. Pridajte ich a budú vedieť o vašich stoloch.',
  'circle.lastPlayed': 'Naposledy hrané {date}',
  'circle.add': 'Pridať',
  'circle.added': '{name} je vo vašom kruhu.',
  'circle.addSomeone.heading': 'Pridať niekoho',
  'circle.friendLink.body': 'Kto otvorí váš odkaz pre priateľov, pridá sa do vášho kruhu a vy do jeho.',
  'circle.shareMessage': 'Pridaj sa do môjho herného kruhu na Jokerless',
  'circle.username.body': 'Alebo požiadajte cez používateľské meno. Druhá strana musí súhlasiť.',
  'circle.username.placeholder': 'Používateľské meno',
  'circle.username.submit': 'Poslať žiadosť',
  'circle.username.sent': 'Žiadosť odoslaná hráčovi {name}.',
  'circle.settingsLink': 'Nastavenia upozornení',
  'circle.addFriend.title': 'Pridať do herného kruhu',
  'circle.addFriend.loading': 'Načítavam odkaz…',
  'circle.addFriend.missing': 'V tomto odkaze chýba kód priateľa.',
  'circle.addFriend.body': '{name} vás pozýva do svojho herného kruhu. Obaja sa dozviete, keď ten druhý otvorí stôl.',
