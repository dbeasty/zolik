...
export const nl: Record<string, string> = {
  ...
  'holdem.status.pot': '{winners} wint {amount} met {hand} — {cards}',
  'holdem.status.potSplit': '{winners} wint {amount} met {hand}',
  ...
  'match.abandonedWaitingFor': 'Wachten tot {names} terugkomt aan tafel.',
  ...
  'replay.round': 'Ronde',
  'replay.track.all': 'Alles',
  'replay.track.yours': 'Jouw zetten',
  'replay.track.rounds': 'Rondes',
  'replay.track.marks': 'Markeringen',
  ...
  'home.playOffline': 'Offline spelen',
  'offline.title': 'Offline spelen',
  'offline.subtitle': 'Geen internet nodig',
  'offline.body': 'Deze telefoon host de tafel zelf, dus je kunt overal tegen bots spelen — zelfs in vliegtuigmodus.',
  'offline.nameLabel': 'Je naam aan tafel',
  'offline.start': 'Offline tafel starten',
  'offline.starting': 'Starten…',
  'offline.active': 'Je zit aan de offline tafel van deze telefoon. Spellen die je hier start blijven op deze telefoon.',
  'offline.chooseGame': 'Kies een spel',
  'offline.backOnline': 'Terug naar online spelen',
  'offline.failed': 'De offline tafel is niet gestart: {reason}',
  'offline.nearbyTitle': 'Tafels in de buurt',
  'offline.nearbyLooking': 'Zoeken naar tafels op dit netwerk…',
  'offline.nearbyNothing': 'Nog geen tafels gevonden. Controleer of je op dezelfde wifi of hotspot zit als de host en of Zolik het lokale netwerk mag gebruiken.',
  'offline.joinThis': 'Meedoen',
  'offline.byAddressTitle': 'Meedoen via adres',
  'offline.versionMismatch': 'Deze tafel draait een andere versie van Zolik. Werk de app op beide telefoons bij.',
  'offline.roomTitle': 'Spelers in de buurt',
  'offline.roomBody': 'Laat andere telefoons op deze wifi of hotspot aan je tafel meedoen. Geen internet nodig.',
  'offline.roomOpenButton': 'Spelers in de buurt uitnodigen',
  'offline.roomOpen': 'Andere telefoons op dit netwerk kunnen je tafel nu vinden. Zien ze hem niet, dan kunnen ze het adres typen of de code scannen.',
  'offline.roomClose': 'Stoppen met uitnodigen',
  'offline.guestActive': 'Je zit aan een tafel die een andere telefoon host ({host}).',
  'offline.joinFailed': 'Kon niet aan die tafel meedoen: {reason}',
  'invite.offlineExplain': 'Spelers aan deze offline tafel doen mee met deze code, via ‘{menu}’.',
  'invite.offlineCode': 'Code:',
  'offline.bleTitle': 'Via Bluetooth',
  'offline.bleLook': 'Tafels zoeken via Bluetooth',
  'offline.bleLooking': 'Tafels zoeken via Bluetooth…',
  'offline.bleOff': 'Zet Bluetooth aan om tafels zonder wifi te vinden.',
  'offline.bleDenied': 'Sta Zolik in Instellingen Bluetooth toe om zonder wifi te spelen.',
  'offline.bleInvite': 'Uitnodigen via Bluetooth',
  'offline.bleInviteBody': 'Voor telefoons die geen wifi met de jouwe delen. Koppelen is niet nodig.',
  'offline.bleOpen': 'Telefoons in de buurt kunnen via Bluetooth meedoen. Verbonden: {n}.',
  'offline.bleStop': 'Bluetooth stoppen',
  'offline.bleCheck': 'Controlecode: {code}',
  'offline.guestBle': 'Je zit via Bluetooth aan een tafel die een andere telefoon host.',
  'offline.keyChanged': 'Dit is niet de telefoon waaraan je eerder onder die naam speelde. Vraag het de host, of doe mee via wifi.',
  // --- game notifications: invites, the game circle, push (src/notify) ---
  'err.NOT_PLAYED_TOGETHER': 'Je kunt alleen mensen toevoegen met wie je hebt gespeeld. Stuur ze je vriendenlink of vraag het via hun gebruikersnaam.',
  'err.UNKNOWN_PLAYER': 'Niemand speelt onder die naam.',
  'err.UNKNOWN_FRIEND_CODE': 'Die vriendenlink werkt niet meer.',
  'err.CANNOT_ADD_SELF': 'Dat ben jij. Voeg iemand anders toe.',
  'err.RATE_LIMITED': 'Te veel tegelijk. Probeer het over een paar minuten opnieuw.',
  'err.PUSH_UNAVAILABLE': 'Meldingen zijn niet ingesteld op deze server.',
  'notify.someone': 'Iemand',
  'notify.join': 'Meedoen',
  'notify.joining': 'Aanschuiven…',
  'notify.goToTable': 'Naar de tafel',
  'notify.notNow': 'Niet nu',
  'notify.moreOptions': 'Meer opties',
  'notify.muteHost': 'Geen uitnodigingen meer van {host}',
  'notify.joinFailed': 'Meedoen mislukt: {reason}',
  'notify.hostingOffline': 'Je host een tafel op deze telefoon. Verlaat die eerst om ergens anders aan te schuiven.',
  'notify.on': 'Aan',
  'notify.off': 'Uit',
  'notify.channelName': 'Speluitnodigingen',
  'notify.banner.online': '{host} heeft een tafel {game} geopend',
  'notify.banner.onlineNoGame': '{host} heeft een tafel geopend',
  'notify.banner.nearby': '{host} host een tafel in de buurt',
  'notify.banner.seated': 'Je bent aan een tafel gezet',
  'notify.banner.fromCircle': 'Uit je spelkring',
  'notify.banner.known': 'Jullie hebben al eens samen gespeeld',
  'notify.banner.nearbyDetail': 'Op een telefoon bij jou in de buurt',
  'notify.banner.seatedDetail': 'Een host heeft je uit de wachtkamer gekozen',
  'notify.banner.more': '+{n} meer',
  'notify.pillOne': '1 tafel wacht',
  'notify.pillMany': '{n} tafels wachten',
  'notify.waitingCard.title': 'Tafels die op je wachten',
  'notify.waitingCard.empty': 'Er wachten geen tafels op je.',
  'notify.prompt.title': 'Weet het wanneer je kring een spel begint',
  'notify.prompt.body': 'Alleen tafels van mensen uit je spelkring. Je kunt het uitzetten in Instellingen.',
  'notify.prompt.enable': 'Inschakelen',
  'notify.prompt.later': 'Later',
  'notify.settings.heading': 'Meldingen',
  'notify.settings.invites': 'Speluitnodigingen',
  'notify.settings.invitesBody': 'Wie je mag laten weten dat er een tafel open is.',
  'notify.settings.invitesCircle': 'Mijn kring',
  'notify.settings.invitesOff': 'Niemand',
  'notify.settings.nearby': 'Tafels in de buurt',
  'notify.settings.nearbyBody': 'Een banner tonen als een telefoon in de buurt een tafel opent. Werkt zolang de app open is.',
  'notify.settings.push': 'Meldingen op dit apparaat',
  'notify.settings.pushOn': 'Aan. Je hoort van tafels, ook als de app dicht is.',
  'notify.settings.pushOff': 'Uit. Uitnodigingen verschijnen alleen als de app open is.',
  'notify.settings.pushBlocked': 'Geblokkeerd. Sta meldingen voor deze app toe in de instellingen van je telefoon.',
  'notify.settings.pushBlockedWeb': 'Geblokkeerd. Sta meldingen voor deze site toe in de instellingen van je browser.',
  'notify.settings.pushInstall': 'Zet deze site op iPhone en iPad eerst op je beginscherm en schakel daar meldingen in.',
  'notify.settings.pushUnavailable': 'Deze server stuurt geen meldingen.',
  'notify.settings.pushUnsupported': 'Dit apparaat of deze browser kan geen meldingen tonen.',
  'notify.settings.signIn': 'Log in of speel als gast om speluitnodigingen te krijgen.',
  'notify.announce.heading': 'Mijn kring laten weten',
  'notify.announce.body': 'De mensen in je spelkring horen van deze tafel en kunnen met één tik meedoen.',
  'notify.announce.toggle': 'Mijn kring laten weten als ik een tafel open',
  'notify.announce.sending': 'Je kring wordt ingelicht…',
  'notify.announce.toldOne': '1 speler ingelicht',
  'notify.announce.toldMany': '{n} spelers ingelicht',
  'notify.announce.already': 'Je kring weet al van deze tafel.',
  'notify.announce.nobody': 'Nog niemand om in te lichten. Voeg mensen toe aan je kring.',
  'notify.announce.circleLink': 'Spelkring',
  'notify.addToCircle': '{name} aan je kring toevoegen',
  ...
  'offline.tellNearbyBody': 'Telefoons in de ruimte met de app open krijgen deze tafel aangeboden.',
  'circle.title': 'Spelkring',
  'circle.subtitle': 'De mensen die je inlicht als je een tafel opent, en de mensen die jou inlichten.',
  'circle.signInRequired': 'Log in of speel als gast om een spelkring op te bouwen.',
  'circle.requests.heading': 'Verzoeken',
  'circle.requests.body': 'Zij willen je laten weten wanneer ze een tafel openen.',
  'circle.accept': 'Accepteren',
  'circle.decline': 'Weigeren',
  'circle.members.heading': 'Je kring',
  'circle.members.body': 'Zij horen van de tafels die je voor vrienden opent.',
  'circle.members.empty': 'Nog niemand. Voeg hieronder mensen toe.',
  'circle.pending': 'Wacht op acceptatie',
  'circle.since': 'Sinds {date}',
  'circle.remove': 'Verwijderen',
  'circle.notifiers.heading': 'Wie je mag uitnodigen',
  'circle.notifiers.body': 'Demp iedereen van wie je liever niets over tafels hoort.',
  'circle.notifiers.empty': 'Nog niemand heeft je toegevoegd.',
  'circle.mute': 'Dempen',
  'circle.unmute': 'Dempen opheffen',
  'circle.muted': 'Gedempt',
  'circle.suggestions.heading': 'Onlangs gespeeld',
  'circle.suggestions.body': 'Mensen met wie je aan tafel hebt gezeten. Voeg ze toe om ze over je tafels in te lichten.',
  'circle.lastPlayed': 'Laatst gespeeld {date}',
  'circle.add': 'Toevoegen',
  'circle.added': '{name} zit in je kring.',
  'circle.addSomeone.heading': 'Iemand toevoegen',
  'circle.friendLink.body': 'Wie je vriendenlink opent, komt in je kring, en jij in de zijne.',
  'circle.shareMessage': 'Kom in mijn spelkring op Jokerless',
  'circle.username.body': 'Of vraag het via gebruikersnaam. De ander moet het accepteren.',
  'circle.username.placeholder': 'Gebruikersnaam',
  'circle.username.submit': 'Verzoek sturen',
  'circle.username.sent': 'Verzoek verstuurd naar {name}.',
  'circle.settingsLink': 'Meldingsinstellingen',
  'circle.addFriend.title': 'Aan spelkring toevoegen',
  'circle.addFriend.loading': 'Link wordt gecontroleerd…',
  'circle.addFriend.missing': 'Deze link bevat geen vriendencode.',
  'circle.addFriend.body': '{name} nodigt je uit in de eigen spelkring. Jullie horen het allebei als de ander een tafel opent.',
