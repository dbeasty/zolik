...
export const cs: Record<string, string> = {
  ...
  'err.WRONG_PHASE': 'V téhle části tahu ne',
  ...
  'err.DISPLACED': 'Otevřeno v jiné kartě — tahle přestala synchronizovat',
  ...
  'err.TABLE_HAS_PLAYERS_AWAY': 'Aby se hra dala obnovit, musí být u stolu zase všichni',
  'err.NOTHING_TO_REPLAY': 'Tady zatím není žádná hra k přehrání',
  'err.REPLAY_UNAVAILABLE': 'Přehrávání her není na tomto serveru dostupné',
  ...
  'prsi.remedy.matchOrDraw': 'Zahraj kartu {suit} nebo takovou, která sedí na {card} — jinak si lízni.',
  'prsi.remedy.answerSevenOrTake': 'Odpověz vlastní sedmou, nebo si vezmi {n} karet.',
  'prsi.remedy.playOrDraw': 'Žádné stopnutí tě nečeká — zahraj kartu {suit}, nebo si lízni.',
  'prsi.remedy.nameASuit': 'Řekni, jaká barva jde po tvé dámě.',
  'prsi.remedy.nothingLeftToDraw': 'Není z čeho líznout — zahraj kartu, pokud můžeš.',
  ...
  'canasta.rules.section.turn': 'Tvůj tah',
  ...
  'canasta.rules.goingOutBonus':
    'Vyjití samo o sobě má hodnotu {n} bodů — {concealed}, pokud to tvá strana zvládne v jediném tahu, aniž by předtím vyložila jedinou kombinaci.',
  'canasta.rules.goingOutBonusFlat': 'Vyjití samo o sobě má hodnotu {n} bodů.',
  'canasta.rules.turn':
  ...
  'canasta.rules.pileTopCard': 'Odhazovací balíček lze vzít jen tahem, který hned použije jeho vrchní kartu.',
  ...
  'canasta.rules.wildRatio':
    'Kombinace potřebuje {n} přirozené karty na každou žolíkovou a nikdy víc než {wilds} žolíkové celkem.',
  'canasta.rules.oneMeldPerRank':
    'Tvoje strana má od každé hodnoty jednu kombinaci — další karty té hodnoty se na ni přikládají.',
  'canasta.rules.meldsPerRankUnlimited': 'Tvoje strana může mít několik kombinací stejné hodnoty.',
  'canasta.rules.canastaCloses': 'Canasta o {n} kartách je hotová a víc už nepřijme.',
  'canasta.rules.meldsAreShared':
    'Kombinace patří dvojici: rozšířit je smí kterýkoli z partnerů, a na soupeřovy se nesahá.',
  'canasta.rules.layOffAfterOpening':
    'Dokud tvoje strana nevyložila svou první kombinaci, nesmí nic na stole doplňovat.',
  'canasta.rules.goOutKeepsACard':
    'Musíš být vždycky schopný svůj tah dokončit, takže celou ruku nevyložíš, ledaže je to právě tah, kterým vycházíš.',
  ...
  'holdem.rules.checkOrCall': 'Čekat smíš, jen když nic nedlužíš; jinak dorovnáváš, zvyšuješ, nebo skládáš.',
  'holdem.rules.minRaise': 'Navýšení musí být aspoň tak velké jako to předchozí.',
  'holdem.rules.allIn':
    'Nikdy nevsadíš víc, než máš, a all-in je vždycky dovolený — i když je menší než plné navýšení.',
  'holdem.rules.foldedOut': 'Jakmile složíš, jsi venku až do dalšího rozdání.',
  'holdem.remedy.callOrFold': 'Dlužíš {n} — dorovnej, zvyš, nebo slož.',
  'holdem.remedy.checkOrRaise': 'Nic se nedluží — čekej, nebo zvyš.',
  'holdem.remedy.callAllInOrFold': 'Nad sázku se svým stackem nedostaneš — dorovnej {n} all-in, nebo slož.',
  'holdem.remedy.raiseAtLeast': 'Zvyš aspoň na {n}.',
  'holdem.remedy.raiseAtMost': 'Zvyš nejvýš na {n} — to je celý tvůj stack.',
  'holdem.remedy.nameAnAmount': 'Řekni, na kolik zvyšuješ — mezi {min} a {max}.',
  'holdem.remedy.waitForNextHand': 'V tomhle rozdání nejsi — počkej na další.',
  ...
  'err.NOTHING_TO_SKIP': 'Není co stopnout',
  ...
  'err.CANNOT_RAISE': 'Zvýšit nemůžeš — se svým stackem se nad sázku nedostaneš',
  ...
  'canasta.remedy.drawOrTakePile':
    'Nejdřív si lízni z balíčku nebo vezmi odhazovací balíček, teprve pak vykládej.',
  'canasta.remedy.meldOrDiscard': 'Už sis lízl — vylož kombinaci, nebo odhoď kartu a tah tím ukonči.',
  'canasta.remedy.drawFromStock': 'Lízni si místo toho z balíčku.',
  'canasta.remedy.takePileInstead': 'Balíček došel — vezmi místo toho odhazovací balíček.',
  'canasta.remedy.pileBlocked': 'Lízni si z balíčku — černá trojka navrchu drží odhazovací balíček zavřený.',
  'canasta.remedy.pileFrozen':
    'Lízni si z balíčku, nebo vezmi balíček dvěma přirozenými kartami z ruky, které sedí na {card}.',
  'canasta.remedy.topCardUnusable': 'Lízni si z balíčku — tvoje strana s kartou {card} navrchu nic nezmůže.',
  ...
  'holdem.cost.pot': 'bank po dorovnání',
  ...
  'ginrummy.rules.upcardDance':
    'Před prvním líznutím může vrchní kartu vzít nerozdávající, pak rozdávající; když ji oba odmítnou, nerozdávající si musí líznout z balíčku.',
  'ginrummy.rules.knockOnDiscard': 'Klepnutí nahrazuje tvůj odhoz, takže přichází jen na konci tvého tahu.',
  ...
  'ginrummy.remedy.takeOrPassUpcard': 'Vezmi si vrchní kartu, nebo ji přenech.',
  'ginrummy.remedy.drawFirst': 'Nejdřív si lízni kartu — z balíčku, nebo z odhazovacího balíčku.',
  'ginrummy.remedy.discardToEndTurn': 'Odhoď jednu kartu a tah tím ukonči.',
  'ginrummy.remedy.finishLayoff': 'Nic dalšího z tvých karet se sem nevejde — dokonči přikládání.',
  'ginrummy.remedy.stockDrawForced': 'Tu kartu jste oba přenechali — lízni si z balíčku.',
  'ginrummy.remedy.drawElsewhere': 'Tenhle balíček je prázdný — lízni si z toho druhého.',
  'ginrummy.remedy.getDeadwoodDown': 'Klepnout můžeš, až tvoje zbytkové body klesnou na {n} nebo míň.',
  ...
  'err.TILE_DOES_NOT_FIT': 'Tenhle kámen do té sestavy nepatří',
  ...
  'err.TABLE_NOT_VALID': 'Některá sestava na stole není platná skupina ani postupka',
  ...
  'rummytiles.remedy.emptyTheTray': 'Umísti {n} kamenů, které máš ještě v přihrádce, nebo tah vrať.',
  'rummytiles.remedy.playFromHandOrDraw':
    'Samotné přerovnání není tah — polož aspoň jeden kámen z ruky, nebo si lízni.',
  'rummytiles.remedy.fixOrReset':
    'Každá sestava na stole musí být platná skupina nebo postupka — sprav je, nebo tah vrať.',
  'rummytiles.remedy.needMorePoints': 'Tvému prvnímu vyložení chybí {n} bodů do {floor}.',
  'rummytiles.remedy.ownNewSetsOnly':
    'Dokud nevyložíš svých prvních {n} bodů, smíš přerovnávat jen sestavy, které jsi vytvořil v tomhle tahu.',
  'rummytiles.remedy.startANewSet': 'Dej ji místo toho do nové sestavy.',
  'rummytiles.remedy.splitLeavesThree': 'Rozděl postupku tak, aby oběma půlkám zůstaly aspoň {n} kameny.',
  'rummytiles.remedy.matchTheJoker': 'Vyměň žolíka přesně za ten kámen, který zastupuje.',
  ...
  'blackjack.rules.roundOrder':
    'Kolo jde v pořadí: sázky, rozdání karet, pojištění když krupiér ukazuje eso, a pak každé místo hraje svou ruku po řadě.',
  'blackjack.rules.oneStakePerRound': 'Jedna sázka na kolo — jakmile je na stole, už se nemění.',
  'blackjack.rules.stakeFromStack': 'Vsadit můžeš jen žetony, které opravdu máš.',
  'blackjack.remedy.putAStakeUp': 'Nejdřív vsaď — {n} nebo víc.',
  'blackjack.remedy.answerInsurance': 'Nejdřív řekni ano, nebo ne k pojištění.',
  'blackjack.remedy.playThisHand': 'Hraj ruku před sebou — ber, nebo stůj.',
  'blackjack.remedy.stakeIsUp': 'Tvoje sázka už je na stole — počkej na rozdání.',
  'blackjack.remedy.stakeAtLeast': 'Vsaď aspoň {n}.',
  'blackjack.remedy.stakeAtMost': 'Vsaď nejvýš {n} — to je všechno, co máš.',
  'blackjack.remedy.sayHowMuch': 'Řekni, kolik sázíš — {n} nebo víc.',
  'blackjack.remedy.hitOrStand': 'Ber, nebo stůj.',
  'blackjack.remedy.waitForNextRound': 'V tomhle kole nejsi — počkej na další rozdání.',
  ...
  'match.you': 'ty',
  'match.yourTeam': 'Tvůj tým',
  'match.teammates': 'Tým: {names}',
  ...
  'option.openDiscardPile': 'Odhazovací balíček',
  'choice.openDiscardPile.1': 'Lze prohlížet',
  'choice.openDiscardPile.0': 'Jen vrchní karta',
  ...
  'replay.round': 'Kolo',
  'replay.track.all': 'Vše',
  'replay.track.yours': 'Tvoje tahy',
  'replay.track.rounds': 'Kola',
  'replay.track.marks': 'Značky',
  'replay.play': 'Přehrát',
  'replay.pause': 'Pauza',
  ...
  'home.playOffline': 'Hrát offline',
  'offline.title': 'Hrát offline',
  'offline.subtitle': 'Bez internetu',
  'offline.body': 'Stůl hostí přímo tento telefon, takže můžete hrát proti botům kdekoli — i v režimu letadla.',
  'offline.nameLabel': 'Vaše jméno u stolu',
  'offline.start': 'Založit offline stůl',
  'offline.starting': 'Spouštím…',
  'offline.active': 'Jste u offline stolu tohoto telefonu. Hry, které zde založíte, zůstanou v tomto telefonu.',
  'offline.chooseGame': 'Vybrat hru',
  'offline.backOnline': 'Zpět k hraní online',
  'offline.failed': 'Offline stůl se nespustil: {reason}',
  'offline.nearbyTitle': 'Stoly v okolí',
  'offline.nearbyLooking': 'Hledám stoly v této síti…',
  'offline.nearbyNothing': 'Zatím žádné stoly. Ověřte, že jste na stejné Wi-Fi nebo hotspotu jako hostitel a že Zolik smí používat místní síť.',
  'offline.joinThis': 'Připojit se',
  'offline.byAddressTitle': 'Připojit se podle adresy',
  'offline.versionMismatch': 'Tento stůl běží na jiné verzi Zoliku. Aktualizujte aplikaci na obou telefonech.',
  'offline.roomTitle': 'Hráči v okolí',
  'offline.roomBody': 'Umožněte ostatním telefonům na této Wi-Fi nebo hotspotu přisednout k vašemu stolu. Internet není potřeba.',
  'offline.roomOpenButton': 'Pozvat hráče v okolí',
  'offline.roomOpen': 'Ostatní telefony v této síti teď váš stůl najdou. Pokud ho nevidí, mohou zadat adresu nebo naskenovat kód.',
  'offline.roomClose': 'Přestat zvát',
  'offline.guestActive': 'Sedíte u stolu, který hostí jiný telefon ({host}).',
  'offline.joinFailed': 'K tomuto stolu se nepodařilo připojit: {reason}',
  'invite.offlineExplain': 'Hráči u tohoto offline stolu se připojí tímto kódem v nabídce „{menu}“.',
  'invite.offlineCode': 'Kód:',
  'offline.bleTitle': 'Přes Bluetooth',
  'offline.bleLook': 'Hledat stoly přes Bluetooth',
  'offline.bleLooking': 'Hledám stoly přes Bluetooth…',
  'offline.bleOff': 'Zapněte Bluetooth, abyste našli stoly bez Wi-Fi.',
  'offline.bleDenied': 'Povolte Zoliku v Nastavení používat Bluetooth, abyste mohli hrát bez Wi-Fi.',
  'offline.bleInvite': 'Pozvat přes Bluetooth',
  'offline.bleInviteBody': 'Pro telefony, které s vaším nesdílejí Wi-Fi. Párování není potřeba.',
  'offline.bleOpen': 'Telefony v okolí se mohou připojit přes Bluetooth. Připojeno: {n}.',
  'offline.bleStop': 'Vypnout Bluetooth',
  'offline.bleCheck': 'Kontrolní kód: {code}',
  'offline.guestBle': 'Sedíte u stolu, který hostí jiný telefon, přes Bluetooth.',
  'offline.keyChanged': 'Toto není telefon, u kterého jste pod tímto jménem hráli dříve. Zeptejte se hostitele nebo se připojte přes Wi-Fi.',
  // --- game notifications: invites, the game circle, push (src/notify) ---
  'err.NOT_PLAYED_TOGETHER': 'Přidat můžete jen lidi, se kterými jste hráli. Pošlete jim odkaz pro přátele nebo je požádejte přes uživatelské jméno.',
  'err.UNKNOWN_PLAYER': 'Pod tímto jménem nikdo nehraje.',
  'err.UNKNOWN_FRIEND_CODE': 'Tento odkaz pro přátele už nefunguje.',
  'err.CANNOT_ADD_SELF': 'To jste vy. Přidejte někoho jiného.',
  'err.RATE_LIMITED': 'Příliš mnoho najednou. Zkuste to za pár minut.',
  'err.PUSH_UNAVAILABLE': 'Tento server nemá nastavená oznámení.',
  'notify.someone': 'Někdo',
  'notify.join': 'Přisednout',
  'notify.joining': 'Přisedám…',
  'notify.goToTable': 'Ke stolu',
  'notify.notNow': 'Teď ne',
  'notify.moreOptions': 'Další možnosti',
  'notify.muteHost': 'Nepřijímat pozvánky od hráče {host}',
  'notify.joinFailed': 'Nepodařilo se přisednout: {reason}',
  'notify.hostingOffline': 'Na tomto telefonu hostíte stůl. Nejdřív ho opusťte, pak můžete přisednout jinam.',
  'notify.on': 'Zapnuto',
  'notify.off': 'Vypnuto',
  'notify.channelName': 'Pozvánky ke hře',
  'notify.banner.online': '{host} otevřel(a) stůl: {game}',
  'notify.banner.onlineNoGame': '{host} otevřel(a) stůl',
  'notify.banner.nearby': '{host} hostí stůl poblíž',
  'notify.banner.seated': 'Byli jste posazeni ke stolu',
  'notify.banner.fromCircle': 'Z vašeho herního kruhu',
  'notify.banner.known': 'Už jste spolu hráli',
  'notify.banner.nearbyDetail': 'Na telefonu ve vaší blízkosti',
  'notify.banner.seatedDetail': 'Hostitel si vás vybral z čekárny',
  'notify.banner.more': '+{n} další',
  'notify.pillOne': 'Čeká 1 stůl',
  'notify.pillMany': 'Čekající stoly: {n}',
  'notify.waitingCard.title': 'Stoly, které na vás čekají',
  'notify.waitingCard.empty': 'Žádný stůl na vás nečeká.',
  'notify.prompt.title': 'Dozvězte se, když váš kruh začíná hru',
  'notify.prompt.body': 'Jen stoly, které otevřou lidé z vašeho herního kruhu. Vypnout to můžete v Nastavení.',
  'notify.prompt.enable': 'Zapnout',
  'notify.prompt.later': 'Později',
  'notify.settings.heading': 'Oznámení',
  'notify.settings.invites': 'Pozvánky ke hře',
  'notify.settings.invitesBody': 'Kdo vám smí dát vědět, že otevřel stůl.',
  'notify.settings.invitesCircle': 'Můj kruh',
  'notify.settings.invitesOff': 'Nikdo',
  'notify.settings.nearby': 'Stoly poblíž',
  'notify.settings.nearbyBody': 'Zobrazit upozornění, když telefon ve vaší blízkosti otevře stůl. Funguje, když je aplikace otevřená.',
  'notify.settings.push': 'Oznámení na tomto zařízení',
  'notify.settings.pushOn': 'Zapnuto. O stolech se dozvíte, i když je aplikace zavřená.',
  'notify.settings.pushOff': 'Vypnuto. Pozvánky se zobrazí jen v otevřené aplikaci.',
  'notify.settings.pushBlocked': 'Zablokováno. Povolte oznámení pro tuto aplikaci v nastavení telefonu.',
  'notify.settings.pushBlockedWeb': 'Zablokováno. Povolte oznámení pro tento web v nastavení prohlížeče.',
  'notify.settings.pushInstall': 'Na iPhonu a iPadu nejdřív přidejte tento web na plochu a oznámení zapněte tam.',
  'notify.settings.pushUnavailable': 'Tento server oznámení neposílá.',
  'notify.settings.pushUnsupported': 'Toto zařízení nebo prohlížeč neumí zobrazovat oznámení.',
  'notify.settings.signIn': 'Přihlaste se nebo hrajte jako host, abyste dostávali pozvánky ke hře.',
  'notify.announce.heading': 'Dát vědět mému kruhu',
  'notify.announce.body': 'Lidé z vašeho herního kruhu se o tomto stolu dozvědí a mohou přisednout jedním klepnutím.',
  'notify.announce.toggle': 'Dát vědět kruhu, když otevřu stůl',
  'notify.announce.sending': 'Dávám vědět vašemu kruhu…',
  'notify.announce.toldOne': 'Dali jsme vědět 1 hráči',
  'notify.announce.toldMany': 'Dali jsme vědět hráčům: {n}',
  'notify.announce.already': 'Váš kruh už o tomto stolu ví.',
  'notify.announce.nobody': 'Zatím není komu dát vědět. Přidejte lidi do svého kruhu.',
  'notify.announce.circleLink': 'Herní kruh',
  'notify.addToCircle': 'Přidat hráče {name} do kruhu',
  ...
  'offline.tellNearbyBody': 'Telefonům v místnosti s otevřenou aplikací se tento stůl nabídne.',
  'circle.title': 'Herní kruh',
  'circle.subtitle': 'Lidé, kterým dáte vědět, když otevřete stůl, a lidé, kteří dají vědět vám.',
  'circle.signInRequired': 'Přihlaste se nebo hrajte jako host, abyste si mohli vytvořit herní kruh.',
  'circle.requests.heading': 'Žádosti',
  'circle.requests.body': 'Chtěli by vám dávat vědět, když otevřou stůl.',
  'circle.accept': 'Přijmout',
  'circle.decline': 'Odmítnout',
  'circle.members.heading': 'Váš kruh',
  'circle.members.body': 'Dozvědí se o stolech, které otevřete pro přátele.',
  'circle.members.empty': 'Zatím nikdo. Přidejte lidi níže.',
  'circle.pending': 'Čeká na přijetí',
  'circle.since': 'Od {date}',
  'circle.remove': 'Odebrat',
  'circle.notifiers.heading': 'Kdo vás může pozvat',
  'circle.notifiers.body': 'Ztlumte každého, o jehož stolech nechcete slyšet.',
  'circle.notifiers.empty': 'Zatím si vás nikdo nepřidal.',
  'circle.mute': 'Ztlumit',
  'circle.unmute': 'Zrušit ztlumení',
  'circle.muted': 'Ztlumeno',
  'circle.suggestions.heading': 'Nedávno jste hráli',
  'circle.suggestions.body': 'Lidé, se kterými jste seděli u stolu. Přidejte je a budou vědět o vašich stolech.',
  'circle.lastPlayed': 'Naposledy hráno {date}',
  'circle.add': 'Přidat',
  'circle.added': '{name} je ve vašem kruhu.',
  'circle.addSomeone.heading': 'Přidat někoho',
  'circle.friendLink.body': 'Kdo otevře váš odkaz pro přátele, přidá se do vašeho kruhu a vy do jeho.',
  'circle.shareMessage': 'Přidej se do mého herního kruhu na Jokerless',
  'circle.username.body': 'Nebo požádejte přes uživatelské jméno. Druhá strana musí souhlasit.',
  'circle.username.placeholder': 'Uživatelské jméno',
  'circle.username.submit': 'Poslat žádost',
  'circle.username.sent': 'Žádost odeslána hráči {name}.',
  'circle.settingsLink': 'Nastavení oznámení',
  'circle.addFriend.title': 'Přidat do herního kruhu',
  'circle.addFriend.loading': 'Načítám odkaz…',
  'circle.addFriend.missing': 'V tomto odkazu chybí kód přítele.',
  'circle.addFriend.body': '{name} vás zve do svého herního kruhu. Oba se dozvíte, když ten druhý otevře stůl.',
