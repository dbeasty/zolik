...
export const it: Record<string, string> = {
  ...
  'err.WRONG_PHASE': 'Non in questo punto del turno',
  ...
  'err.DISPLACED': 'Aperta in un\'altra scheda — questa ha smesso di sincronizzarsi',
  ...
  'err.REPLAY_UNAVAILABLE': 'La riproduzione delle partite non è disponibile su questo server',
  ...
  'prsi.remedy.matchOrDraw': 'Gioca una carta di {suit} o una che va su {card} — altrimenti pesca.',
  'prsi.remedy.answerSevenOrTake': 'Rispondi con un tuo sette, oppure prendi le {n} carte.',
  'prsi.remedy.playOrDraw': "Non c'è nessun turno da saltare — gioca una carta di {suit} o pesca.",
  'prsi.remedy.nameASuit': "Di' quale seme segue la tua donna.",
  'prsi.remedy.nothingLeftToDraw': 'Non è rimasto niente da pescare — gioca una carta se puoi.',
  ...
  'canasta.rules.section.turn': 'Il tuo turno',
  ...
  'canasta.rules.turnDiscard':
    'È lo scarto a chiudere il turno, quindi ti serve sempre una carta di riserva per farlo.',
  'canasta.rules.pileTopCard':
    'Il pozzo si può prendere solo con una mossa che usa subito la sua carta in cima.',
  ...
  'canasta.rules.wildRatio':
    'Una combinazione richiede {n} carte naturali per ogni matta e mai più di {wilds} matte in tutto.',
  'canasta.rules.oneMeldPerRank':
    'La tua parte tiene una combinazione per valore: le altre carte di quel valore si aggiungono a quella.',
  'canasta.rules.meldsPerRankUnlimited': 'La tua parte può avere più combinazioni dello stesso valore.',
  'canasta.rules.canastaCloses': 'Una canasta di {n} carte è completa e non ne accetta altre.',
  'canasta.rules.meldsAreShared':
    'Le combinazioni sono della coppia: entrambi i compagni possono allungarle, e quelle avversarie non si toccano.',
  'canasta.rules.layOffAfterOpening':
    'Finché la tua parte non ha fatto la sua apertura, non può aggiungere carte a nulla sul tavolo.',
  'canasta.rules.goOutKeepsACard':
    'Devi sempre poter finire il tuo turno, quindi non calare mai tutta la mano a meno che non sia la mossa che ti fa chiudere.',
  ...
  'holdem.rules.checkOrCall':
    'Puoi passare solo quando non devi nulla; altrimenti chiama, rilancia o lascia.',
  'holdem.rules.minRaise': "Un rilancio dev'essere grande almeno quanto il precedente.",
  'holdem.rules.allIn':
    "Non puoi mai mettere più del tuo stack, e l'all-in è sempre consentito, anche per meno di un rilancio pieno.",
  'holdem.rules.foldedOut': 'Una volta che lasci, sei fuori fino alla mano successiva.',
  'holdem.remedy.callOrFold': 'Devi {n}: chiama, rilancia o lascia.',
  'holdem.remedy.checkOrRaise': 'Non si deve nulla: passa o rilancia.',
  'holdem.remedy.callAllInOrFold': 'Il tuo stack non supera la puntata: chiama {n} all-in o lascia.',
  'holdem.remedy.raiseAtLeast': 'Rilancia ad almeno {n}.',
  'holdem.remedy.raiseAtMost': 'Rilancia al massimo a {n}: è tutto il tuo stack.',
  'holdem.remedy.nameAnAmount': "Di' a quanto rilanci, tra {min} e {max}.",
  'holdem.remedy.waitForNextHand': 'Sei fuori da questa mano: aspetta la prossima distribuzione.',
  ...
  'holdem.status.pot': '{winners} vince {amount} con {hand} — {cards}',
  'holdem.status.potSplit': '{winners} vince {amount} con {hand}',
  ...
  'canasta.round.closed': '{player} ha chiuso con una differenza di {diff} punti',
  ...
  'err.NOTHING_TO_SKIP': "Non c'è nessun turno da saltare",
  ...
  'canasta.remedy.drawOrTakePile': 'Pesca dal mazzo o prendi il pozzo prima di calare combinazioni.',
  'canasta.remedy.meldOrDiscard': 'Hai già pescato: cala una combinazione o scarta per chiudere il turno.',
  'canasta.remedy.drawFromStock': 'Pesca invece dal mazzo.',
  'canasta.remedy.takePileInstead': 'Il mazzo è finito: prendi invece il pozzo.',
  'canasta.remedy.pileBlocked': 'Pesca dal mazzo: il tre nero in cima tiene chiuso il pozzo.',
  'canasta.remedy.pileFrozen':
    'Pesca dal mazzo, oppure prendi il pozzo con due carte naturali della tua mano che vanno su {card}.',
  'canasta.remedy.topCardUnusable': 'Pesca dal mazzo: la tua parte non sa che farsene del {card} in cima.',
  ...
  'ginrummy.rules.upcardDance':
    'Prima della prima pescata la carta scoperta può prenderla il non mazziere, poi il mazziere; se passano entrambi, il non mazziere deve pescare dal mazzo.',
  'ginrummy.rules.knockOnDiscard':
    'Bussare sostituisce il tuo scarto, quindi avviene solo alla fine del turno.',
  ...
  'ginrummy.remedy.takeOrPassUpcard': 'Prendi la carta scoperta oppure passa.',
  'ginrummy.remedy.drawFirst': 'Pesca prima una carta, dal mazzo o dal pozzo.',
  'ginrummy.remedy.discardToEndTurn': 'Scarta una carta per chiudere il turno.',
  'ginrummy.remedy.finishLayoff': 'Non ti entra più nulla: finisci di aggiungere carte.',
  'ginrummy.remedy.stockDrawForced': "L'avete passata entrambi: pesca dal mazzo.",
  'ginrummy.remedy.drawElsewhere': "Quel mazzetto è vuoto: pesca dall'altro.",
  'ginrummy.remedy.getDeadwoodDown': 'Puoi bussare quando il tuo scarto morto scende a {n} o meno.',
  ...
  'err.TILE_DOES_NOT_FIT': 'Quella tessera non entra in quel gruppo',
  ...
  'err.TABLE_NOT_VALID': 'Un gruppo sul tavolo non è né un gruppo né una scala validi',
  ...
  'rummytiles.remedy.emptyTheTray': 'Posiziona le {n} tessere ancora sul leggio, oppure azzera il turno.',
  'rummytiles.remedy.playFromHandOrDraw':
    'Riorganizzare non è un turno: gioca almeno una tessera dalla mano, oppure pesca.',
  'rummytiles.remedy.fixOrReset':
    "Ogni gruppo sul tavolo dev'essere un gruppo o una scala validi: sistemali o azzera il turno.",
  'rummytiles.remedy.needMorePoints': 'Alla tua prima calata mancano {n} punti per arrivare a {floor}.',
  'rummytiles.remedy.ownNewSetsOnly':
    'Fino alla tua prima calata da {n} punti puoi riorganizzare solo i gruppi creati in questo turno.',
  'rummytiles.remedy.startANewSet': 'Mettila invece in un gruppo nuovo.',
  'rummytiles.remedy.splitLeavesThree':
    'Dividi la scala in modo che entrambe le metà conservino almeno {n} tessere.',
  'rummytiles.remedy.matchTheJoker': 'Scambia il jolly con esattamente la tessera che rappresenta.',
  ...
  'blackjack.rules.roundOrder':
    'Un giro segue un ordine: puntate, carte distribuite, assicurazione se il banco mostra un asso, poi ogni posto gioca la sua mano a turno.',
  'blackjack.rules.oneStakePerRound': 'Una puntata per giro: una volta fatta, non si cambia.',
  'blackjack.rules.stakeFromStack': 'Puoi puntare solo le fiche che hai davvero.',
  'blackjack.remedy.putAStakeUp': 'Fai prima una puntata: {n} o più.',
  'blackjack.remedy.answerInsurance': "Rispondi prima sì o no all'assicurazione.",
  'blackjack.remedy.playThisHand': 'Gioca la mano davanti a te: chiedi carta o stai.',
  'blackjack.remedy.stakeIsUp': 'La tua puntata è già fatta: aspetta la distribuzione.',
  'blackjack.remedy.stakeAtLeast': 'Punta almeno {n}.',
  'blackjack.remedy.stakeAtMost': 'Punta al massimo {n}: è tutto il tuo stack.',
  'blackjack.remedy.sayHowMuch': "Di' quanto punti: {n} o più.",
  'blackjack.remedy.hitOrStand': 'Chiedi carta o stai.',
  'blackjack.remedy.waitForNextRound': 'Sei fuori da questo giro: aspetta la prossima distribuzione.',
  ...
  'mine.subtitle': 'Partite da riprendere, o da eliminare',
  'mine.tabUnfinished': 'In corso',
  'mine.tabFinished': 'Concluse',
  'mine.emptyUnfinished': 'Nessuna partita in corso al momento',
  'mine.emptyFinished': 'Ancora nessuna partita conclusa',
  'mine.open': 'Apri',
  'mine.resume': 'Riprendi',
  'mine.delete': 'Elimina',
  'mine.deleteConfirmTitle': 'Eliminare questo tavolo?',
  ...
  'mine.status.abandoned': 'Messa da parte',
  'mine.status.completed': 'Conclusa',
  ...
  'match.you': 'tu',
  'match.yourTeam': 'La tua squadra',
  'match.teammates': 'Squadra: {names}',
  ...
  'build.app': 'app',
  'build.server': 'server',
  'about.subtitle': 'La versione con cui stai giocando e le note legali.',
  ...
  'option.openDiscardPile': 'Pila degli scarti',
  'choice.openDiscardPile.1': 'Consultabile',
  'choice.openDiscardPile.0': 'Solo la carta in cima',
  ...
  'replay.round': 'Mano',
  'replay.track.all': 'Tutto',
  'replay.track.yours': 'Le tue mosse',
  'replay.track.rounds': 'Mani',
  'replay.track.marks': 'Segni',
  ...
  'home.playOffline': 'Gioca offline',
  'offline.title': 'Gioca offline',
  'offline.subtitle': 'Nessuna connessione necessaria',
  'offline.body': 'Questo telefono ospita il tavolo da solo, così puoi giocare contro i bot ovunque, anche in modalità aereo.',
  'offline.nameLabel': 'Il tuo nome al tavolo',
  'offline.start': 'Apri un tavolo offline',
  'offline.starting': 'Avvio…',
  'offline.active': 'Sei al tavolo offline di questo telefono. Le partite avviate qui restano su questo telefono.',
  'offline.chooseGame': 'Scegli un gioco',
  'offline.backOnline': 'Torna al gioco online',
  'offline.failed': 'Il tavolo offline non si è avviato: {reason}',
  'offline.nearbyTitle': 'Tavoli vicini',
  'offline.nearbyLooking': 'Cerco tavoli su questa rete…',
  'offline.nearbyNothing': 'Nessun tavolo trovato. Verifica di essere sulla stessa Wi-Fi o hotspot dell\'host e che Zolik possa usare la rete locale.',
  'offline.joinThis': 'Unisciti',
  'offline.byAddressTitle': 'Unisciti tramite indirizzo',
  'offline.versionMismatch': 'Questo tavolo usa un\'altra versione di Zolik. Aggiorna l\'app su entrambi i telefoni.',
  'offline.roomTitle': 'Giocatori vicini',
  'offline.roomBody': 'Lascia che altri telefoni su questa Wi-Fi o hotspot si uniscano al tuo tavolo. Nessuna connessione necessaria.',
  'offline.roomOpenButton': 'Invita i giocatori vicini',
  'offline.roomOpen': 'Gli altri telefoni su questa rete ora possono trovare il tuo tavolo. Se non lo vedono, possono digitare l\'indirizzo o scansionare il codice.',
  'offline.roomClose': 'Smetti di invitare',
  'offline.guestActive': 'Sei a un tavolo ospitato da un altro telefono ({host}).',
  'offline.joinFailed': 'Impossibile unirsi a quel tavolo: {reason}',
  'invite.offlineExplain': 'I giocatori di questo tavolo offline si uniscono con questo codice, da «{menu}».',
  'invite.offlineCode': 'Codice:',
  'offline.bleTitle': 'Via Bluetooth',
  'offline.bleLook': 'Cerca tavoli via Bluetooth',
  'offline.bleLooking': 'Cerco tavoli via Bluetooth…',
  'offline.bleOff': 'Attiva il Bluetooth per trovare tavoli senza Wi-Fi.',
  'offline.bleDenied': 'Consenti a Zolik di usare il Bluetooth nelle Impostazioni per giocare senza Wi-Fi.',
  'offline.bleInvite': 'Invita via Bluetooth',
  'offline.bleInviteBody': 'Per i telefoni che non condividono il Wi-Fi con il tuo. Nessun abbinamento necessario.',
  'offline.bleOpen': 'I telefoni vicini possono unirsi via Bluetooth. Connessi: {n}.',
  'offline.bleStop': 'Ferma il Bluetooth',
  'offline.bleCheck': 'Codice di verifica: {code}',
  'offline.guestBle': 'Sei a un tavolo ospitato da un altro telefono, via Bluetooth.',
  'offline.keyChanged': 'Questo non è il telefono a cui hai giocato prima con quel nome. Chiedi all’host o unisciti via Wi-Fi.',
  // --- game notifications: invites, the game circle, push (src/notify) ---
  'err.NOT_PLAYED_TOGETHER': 'Puoi aggiungere solo persone con cui hai giocato. Invia il tuo link amico o chiedi tramite nome utente.',
  'err.UNKNOWN_PLAYER': 'Nessuno gioca con quel nome.',
  'err.UNKNOWN_FRIEND_CODE': 'Quel link amico non funziona più.',
  'err.CANNOT_ADD_SELF': 'Sei tu. Aggiungi qualcun altro.',
  'err.RATE_LIMITED': 'Troppe richieste insieme. Riprova tra qualche minuto.',
  'err.PUSH_UNAVAILABLE': 'Le notifiche non sono configurate su questo server.',
  'notify.someone': 'Qualcuno',
  'notify.join': 'Unisciti',
  'notify.joining': 'Ti stai unendo…',
  'notify.goToTable': 'Vai al tavolo',
  'notify.notNow': 'Non ora',
  'notify.moreOptions': 'Altre opzioni',
  'notify.muteHost': 'Non ricevere inviti da {host}',
  'notify.joinFailed': 'Impossibile unirsi: {reason}',
  'notify.hostingOffline': 'Stai ospitando un tavolo su questo telefono. Lascialo prima di unirti a un altro.',
  'notify.on': 'Attivo',
  'notify.off': 'Disattivo',
  'notify.channelName': 'Inviti di gioco',
  'notify.banner.online': '{host} ha aperto un tavolo di {game}',
  'notify.banner.onlineNoGame': '{host} ha aperto un tavolo',
  'notify.banner.nearby': '{host} ospita un tavolo qui vicino',
  'notify.banner.seated': 'Sei stato fatto sedere a un tavolo',
  'notify.banner.fromCircle': 'Dalla tua cerchia di gioco',
  'notify.banner.known': 'Avete già giocato insieme',
  'notify.banner.nearbyDetail': 'Su un telefono vicino a te',
  'notify.banner.seatedDetail': 'Un host ti ha scelto dalla sala d’attesa',
  'notify.banner.more': '+{n} altri',
  'notify.pillOne': '1 tavolo in attesa',
  'notify.pillMany': '{n} tavoli in attesa',
  'notify.waitingCard.title': 'Tavoli che ti aspettano',
  'notify.waitingCard.empty': 'Nessun tavolo ti aspetta.',
  'notify.prompt.title': 'Sappi quando la tua cerchia inizia una partita',
  'notify.prompt.body': 'Solo i tavoli aperti dalle persone della tua cerchia di gioco. Puoi disattivarlo nelle Impostazioni.',
  'notify.prompt.enable': 'Attiva',
  'notify.prompt.later': 'Più tardi',
  'notify.settings.heading': 'Notifiche',
  'notify.settings.invites': 'Inviti di gioco',
  'notify.settings.invitesBody': 'Chi può avvisarti quando apre un tavolo.',
  'notify.settings.invitesCircle': 'La mia cerchia',
  'notify.settings.invitesOff': 'Nessuno',
  'notify.settings.nearby': 'Tavoli vicini',
  'notify.settings.nearbyBody': 'Mostra un banner quando un telefono vicino apre un tavolo. Funziona con l’app aperta.',
  'notify.settings.push': 'Notifiche su questo dispositivo',
  'notify.settings.pushOn': 'Attive. Saprai dei tavoli anche con l’app chiusa.',
  'notify.settings.pushOff': 'Disattive. Gli inviti compaiono solo con l’app aperta.',
  'notify.settings.pushBlocked': 'Bloccate. Consenti le notifiche per questa app nelle impostazioni del telefono.',
  'notify.settings.pushBlockedWeb': 'Bloccate. Consenti le notifiche per questo sito nelle impostazioni del browser.',
  'notify.settings.pushInstall': 'Su iPhone e iPad, aggiungi prima questo sito alla schermata Home, poi attiva lì le notifiche.',
  'notify.settings.pushUnavailable': 'Questo server non invia notifiche.',
  'notify.settings.pushUnsupported': 'Questo dispositivo o browser non può mostrare notifiche.',
  'notify.settings.signIn': 'Accedi o gioca come ospite per ricevere inviti di gioco.',
  'notify.announce.heading': 'Avvisa la mia cerchia',
  'notify.announce.body': 'Le persone della tua cerchia di gioco sapranno di questo tavolo e potranno unirsi con un tocco.',
  'notify.announce.toggle': 'Avvisa la mia cerchia quando apro un tavolo',
  'notify.announce.sending': 'Avviso la tua cerchia…',
  'notify.announce.toldOne': 'Avvisato 1 giocatore',
  'notify.announce.toldMany': 'Avvisati {n} giocatori',
  'notify.announce.already': 'La tua cerchia sa già di questo tavolo.',
  'notify.announce.nobody': 'Ancora nessuno da avvisare. Aggiungi persone alla tua cerchia.',
  'notify.announce.circleLink': 'Cerchia di gioco',
  'notify.addToCircle': 'Aggiungi {name} alla tua cerchia',
  ...
  'offline.tellNearbyBody': 'Ai telefoni nella stanza con l’app aperta viene proposto questo tavolo.',
  'circle.title': 'Cerchia di gioco',
  'circle.subtitle': 'Le persone che avvisi quando apri un tavolo e quelle che avvisano te.',
  'circle.signInRequired': 'Accedi o gioca come ospite per creare una cerchia di gioco.',
  'circle.requests.heading': 'Richieste',
  'circle.requests.body': 'Vorrebbero avvisarti quando aprono un tavolo.',
  'circle.accept': 'Accetta',
  'circle.decline': 'Rifiuta',
  'circle.members.heading': 'La tua cerchia',
  'circle.members.body': 'Sanno dei tavoli che apri per gli amici.',
  'circle.members.empty': 'Ancora nessuno. Aggiungi persone qui sotto.',
  'circle.pending': 'In attesa di accettazione',
  'circle.since': 'Dal {date}',
  'circle.remove': 'Rimuovi',
  'circle.notifiers.heading': 'Chi può invitarti',
  'circle.notifiers.body': 'Silenzia chiunque di cui non vuoi sentire i tavoli.',
  'circle.notifiers.empty': 'Nessuno ti ha ancora aggiunto.',
  'circle.mute': 'Silenzia',
  'circle.unmute': 'Riattiva',
  'circle.muted': 'Silenziato',
  'circle.suggestions.heading': 'Giocato di recente',
  'circle.suggestions.body': 'Persone con cui hai condiviso un tavolo. Aggiungile per avvisarle dei tuoi tavoli.',
  'circle.lastPlayed': 'Ultima partita {date}',
  'circle.add': 'Aggiungi',
  'circle.added': '{name} è nella tua cerchia.',
  'circle.addSomeone.heading': 'Aggiungi qualcuno',
  'circle.friendLink.body': 'Chi apre il tuo link amico entra nella tua cerchia, e tu nella sua.',
  'circle.shareMessage': 'Entra nella mia cerchia di gioco su Jokerless',
  'circle.username.body': 'Oppure chiedi tramite nome utente. L’altra persona deve accettare.',
  'circle.username.placeholder': 'Nome utente',
  'circle.username.submit': 'Invia richiesta',
  'circle.username.sent': 'Richiesta inviata a {name}.',
  'circle.settingsLink': 'Impostazioni notifiche',
  'circle.addFriend.title': 'Aggiungi alla cerchia di gioco',
  'circle.addFriend.loading': 'Verifica del link…',
  'circle.addFriend.missing': 'Questo link non contiene un codice amico.',
  'circle.addFriend.body': '{name} ti invita nella sua cerchia di gioco. Ognuno saprà quando l’altro apre un tavolo.',
