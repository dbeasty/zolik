...
export const el: Record<string, string> = {
  ...
  'err.NOT_PLAYED_TOGETHER': 'Μπορείτε να προσθέσετε μόνο άτομα με τα οποία έχετε παίξει. Στείλτε τους τον σύνδεσμο φίλου σας ή ζητήστε μέσω ονόματος χρήστη.',
  'err.UNKNOWN_PLAYER': 'Κανείς δεν παίζει με αυτό το όνομα.',
  'err.UNKNOWN_FRIEND_CODE': 'Αυτός ο σύνδεσμος φίλου δεν λειτουργεί πια.',
  'err.CANNOT_ADD_SELF': 'Αυτός είστε εσείς. Προσθέστε κάποιον άλλο.',
  'err.RATE_LIMITED': 'Πάρα πολλά ταυτόχρονα. Δοκιμάστε ξανά σε λίγα λεπτά.',
  'err.PUSH_UNAVAILABLE': 'Οι ειδοποιήσεις δεν έχουν ρυθμιστεί σε αυτόν τον διακομιστή.',
  'notify.someone': 'Κάποιος',
  'notify.join': 'Συμμετοχή',
  'notify.joining': 'Συμμετοχή…',
  'notify.goToTable': 'Στο τραπέζι',
  'notify.notNow': 'Όχι τώρα',
  'notify.moreOptions': 'Περισσότερες επιλογές',
  'notify.muteHost': 'Χωρίς προσκλήσεις από {host}',
  'notify.joinFailed': 'Η συμμετοχή απέτυχε: {reason}',
  'notify.hostingOffline': 'Φιλοξενείτε ένα τραπέζι σε αυτό το τηλέφωνο. Αποχωρήστε πρώτα για να μπείτε σε άλλο.',
  'notify.on': 'Ενεργό',
  'notify.off': 'Ανενεργό',
  'notify.channelName': 'Προσκλήσεις παιχνιδιού',
  'notify.banner.online': '{host} άνοιξε τραπέζι: {game}',
  'notify.banner.onlineNoGame': '{host} άνοιξε τραπέζι',
  'notify.banner.nearby': '{host} φιλοξενεί τραπέζι κοντά σας',
  'notify.banner.seated': 'Σας έβαλαν σε ένα τραπέζι',
  'notify.banner.fromCircle': 'Από τον κύκλο παιχνιδιού σας',
  'notify.banner.known': 'Έχετε παίξει μαζί στο παρελθόν',
  'notify.banner.nearbyDetail': 'Σε ένα τηλέφωνο κοντά σας',
  'notify.banner.seatedDetail': 'Ένας οικοδεσπότης σάς επέλεξε από την αίθουσα αναμονής',
  'notify.banner.more': '+{n} ακόμη',
  'notify.pillOne': '1 τραπέζι περιμένει',
  'notify.pillMany': 'Τραπέζια σε αναμονή: {n}',
  'notify.waitingCard.title': 'Τραπέζια που σας περιμένουν',
  'notify.waitingCard.empty': 'Κανένα τραπέζι δεν σας περιμένει.',
  'notify.prompt.title': 'Μάθετε πότε ο κύκλος σας ξεκινά παιχνίδι',
  'notify.prompt.body': 'Μόνο τραπέζια που ανοίγουν άτομα του κύκλου σας. Μπορείτε να το απενεργοποιήσετε στις Ρυθμίσεις.',
  'notify.prompt.enable': 'Ενεργοποίηση',
  'notify.prompt.later': 'Αργότερα',
  'notify.settings.heading': 'Ειδοποιήσεις',
  'notify.settings.invites': 'Προσκλήσεις παιχνιδιού',
  'notify.settings.invitesBody': 'Ποιος μπορεί να σας ειδοποιεί όταν ανοίγει τραπέζι.',
  'notify.settings.invitesCircle': 'Ο κύκλος μου',
  'notify.settings.invitesOff': 'Κανείς',
  'notify.settings.nearby': 'Τραπέζια κοντά',
  'notify.settings.nearbyBody': 'Εμφάνιση ειδοποίησης όταν ένα κοντινό τηλέφωνο ανοίγει τραπέζι. Λειτουργεί όσο η εφαρμογή είναι ανοιχτή.',
  'notify.settings.push': 'Ειδοποιήσεις σε αυτή τη συσκευή',
  'notify.settings.pushOn': 'Ενεργές. Μαθαίνετε για τραπέζια ακόμη και με κλειστή εφαρμογή.',
  'notify.settings.pushOff': 'Ανενεργές. Οι προσκλήσεις εμφανίζονται μόνο με ανοιχτή εφαρμογή.',
  'notify.settings.pushBlocked': 'Αποκλεισμένες. Επιτρέψτε τις ειδοποιήσεις της εφαρμογής στις ρυθμίσεις του τηλεφώνου.',
  'notify.settings.pushBlockedWeb': 'Αποκλεισμένες. Επιτρέψτε τις ειδοποιήσεις του ιστότοπου στις ρυθμίσεις του προγράμματος περιήγησης.',
  'notify.settings.pushInstall': 'Σε iPhone και iPad, προσθέστε πρώτα τον ιστότοπο στην αρχική οθόνη και ενεργοποιήστε εκεί τις ειδοποιήσεις.',
  'notify.settings.pushUnavailable': 'Αυτός ο διακομιστής δεν στέλνει ειδοποιήσεις.',
  'notify.settings.pushUnsupported': 'Αυτή η συσκευή ή το πρόγραμμα περιήγησης δεν μπορεί να εμφανίσει ειδοποιήσεις.',
  'notify.settings.signIn': 'Συνδεθείτε ή παίξτε ως επισκέπτης για να λαμβάνετε προσκλήσεις παιχνιδιού.',
  'notify.announce.heading': 'Ειδοποίηση του κύκλου μου',
  'notify.announce.body': 'Τα άτομα του κύκλου σας μαθαίνουν για αυτό το τραπέζι και μπαίνουν με ένα άγγιγμα.',
  'notify.announce.toggle': 'Ειδοποίηση του κύκλου μου όταν ανοίγω τραπέζι',
  'notify.announce.sending': 'Ειδοποιούμε τον κύκλο σας…',
  'notify.announce.toldOne': 'Ειδοποιήθηκε 1 παίκτης',
  'notify.announce.toldMany': 'Ειδοποιήθηκαν παίκτες: {n}',
  'notify.announce.already': 'Ο κύκλος σας ήδη γνωρίζει για αυτό το τραπέζι.',
  'notify.announce.nobody': 'Δεν υπάρχει ακόμη κανείς να ειδοποιηθεί. Προσθέστε άτομα στον κύκλο σας.',
  'notify.announce.circleLink': 'Κύκλος παιχνιδιού',
  'notify.addToCircle': 'Προσθήκη του/της {name} στον κύκλο σας',
  ...
  'offline.tellNearbyBody': 'Στα τηλέφωνα του χώρου με ανοιχτή την εφαρμογή προσφέρεται αυτό το τραπέζι.',
  'circle.title': 'Κύκλος παιχνιδιού',
  'circle.subtitle': 'Τα άτομα που ειδοποιείτε όταν ανοίγετε τραπέζι και όσοι ειδοποιούν εσάς.',
  'circle.signInRequired': 'Συνδεθείτε ή παίξτε ως επισκέπτης για να φτιάξετε κύκλο παιχνιδιού.',
  'circle.requests.heading': 'Αιτήματα',
  'circle.requests.body': 'Θα ήθελαν να σας ειδοποιούν όταν ανοίγουν τραπέζι.',
  'circle.accept': 'Αποδοχή',
  'circle.decline': 'Απόρριψη',
  'circle.members.heading': 'Ο κύκλος σας',
  'circle.members.body': 'Μαθαίνουν για τα τραπέζια που ανοίγετε για φίλους.',
  'circle.members.empty': 'Κανείς ακόμη. Προσθέστε άτομα παρακάτω.',
  'circle.pending': 'Αναμένει αποδοχή',
  'circle.since': 'Από {date}',
  'circle.remove': 'Αφαίρεση',
  'circle.notifiers.heading': 'Ποιος μπορεί να σας προσκαλεί',
  'circle.notifiers.body': 'Σιγάστε όποιον δεν θέλετε να ακούτε για τα τραπέζια του.',
  'circle.notifiers.empty': 'Κανείς δεν σας έχει προσθέσει ακόμη.',
  'circle.mute': 'Σίγαση',
  'circle.unmute': 'Κατάργηση σίγασης',
  'circle.muted': 'Σε σίγαση',
  'circle.suggestions.heading': 'Παίξατε πρόσφατα',
  'circle.suggestions.body': 'Άτομα με τα οποία μοιραστήκατε τραπέζι. Προσθέστε τα για να μαθαίνουν για τα τραπέζια σας.',
  'circle.lastPlayed': 'Τελευταίο παιχνίδι {date}',
  'circle.add': 'Προσθήκη',
  'circle.added': '{name}: στον κύκλο σας.',
  'circle.addSomeone.heading': 'Προσθήκη ατόμου',
  'circle.friendLink.body': 'Όποιος ανοίξει τον σύνδεσμο φίλου σας μπαίνει στον κύκλο σας, κι εσείς στον δικό του.',
  'circle.shareMessage': 'Έλα στον κύκλο παιχνιδιού μου στο Jokerless',
  'circle.username.body': 'Ή ζητήστε μέσω ονόματος χρήστη. Ο άλλος πρέπει να αποδεχτεί.',
  'circle.username.placeholder': 'Όνομα χρήστη',
  'circle.username.submit': 'Αποστολή αιτήματος',
  'circle.username.sent': 'Το αίτημα στάλθηκε: {name}.',
  'circle.settingsLink': 'Ρυθμίσεις ειδοποιήσεων',
  'circle.addFriend.title': 'Προσθήκη στον κύκλο παιχνιδιού',
  'circle.addFriend.loading': 'Έλεγχος συνδέσμου…',
  'circle.addFriend.missing': 'Αυτός ο σύνδεσμος δεν έχει κωδικό φίλου.',
  'circle.addFriend.body': '{name} σας προσκαλεί στον κύκλο παιχνιδιού του/της. Θα μαθαίνετε και οι δύο όταν ο άλλος ανοίγει τραπέζι.',
