...
export const da: Record<string, string> = {
  ...
  'holdem.status.pot': '{winners} vandt {amount} med {hand} — {cards}',
  'holdem.status.potSplit': '{winners} vandt {amount} med {hand}',
  ...
  'canasta.round.closed': '{player} lukkede med en pointforskel på {diff}',
  ...
  'match.you': 'dig',
  'match.yourTeam': 'Dit hold',
  'match.teammates': 'Hold: {names}',
  ...
  'option.openDiscardPile': 'Kastebunke',
  'choice.openDiscardPile.1': 'Kan gennemses',
  'choice.openDiscardPile.0': 'Kun øverste kort',
  ...
  'replay.track.yours': 'Dine træk',
  'replay.track.rounds': 'Runder',
  'replay.track.marks': 'Mærker',
  'replay.play': 'Afspil',
  'replay.pause': 'Pause',
  ...
  'home.playOffline': 'Spil offline',
  'offline.title': 'Spil offline',
  'offline.subtitle': 'Intet internet nødvendigt',
  'offline.body': 'Denne telefon er selv vært for bordet, så du kan spille mod bots overalt — også i flytilstand.',
  'offline.nameLabel': 'Dit navn ved bordet',
  'offline.start': 'Start et offline-bord',
  'offline.starting': 'Starter…',
  'offline.active': 'Du sidder ved denne telefons offline-bord. Spil, du starter her, bliver på denne telefon.',
  'offline.chooseGame': 'Vælg et spil',
  'offline.backOnline': 'Tilbage til online spil',
  'offline.failed': 'Offline-bordet startede ikke: {reason}',
  'offline.nearbyTitle': 'Borde i nærheden',
  'offline.nearbyLooking': 'Leder efter borde på dette netværk…',
  'offline.nearbyNothing': 'Ingen borde fundet endnu. Tjek, at du er på samme wi-fi eller hotspot som værten, og at Zolik må bruge det lokale netværk.',
  'offline.joinThis': 'Deltag',
  'offline.byAddressTitle': 'Deltag via adresse',
  'offline.versionMismatch': 'Dette bord kører en anden version af Zolik. Opdater appen på begge telefoner.',
  'offline.roomTitle': 'Spillere i nærheden',
  'offline.roomBody': 'Lad andre telefoner på dette wi-fi eller hotspot deltage ved dit bord. Intet internet nødvendigt.',
  'offline.roomOpenButton': 'Inviter spillere i nærheden',
  'offline.roomOpen': 'Andre telefoner på dette netværk kan nu finde dit bord. Kan de ikke se det, kan de skrive adressen eller scanne koden.',
  'offline.roomClose': 'Stop med at invitere',
  'offline.guestActive': 'Du sidder ved et bord, som en anden telefon er vært for ({host}).',
  'offline.joinFailed': 'Kunne ikke deltage ved det bord: {reason}',
  'invite.offlineExplain': 'Spillere ved dette offline-bord deltager med denne kode under “{menu}”.',
  'invite.offlineCode': 'Kode:',
  'offline.bleTitle': 'Via Bluetooth',
  'offline.bleLook': 'Søg efter borde via Bluetooth',
  'offline.bleLooking': 'Søger efter borde via Bluetooth…',
  'offline.bleOff': 'Slå Bluetooth til for at finde borde uden wi-fi.',
  'offline.bleDenied': 'Tillad Zolik at bruge Bluetooth i Indstillinger for at spille uden wi-fi.',
  'offline.bleInvite': 'Inviter via Bluetooth',
  'offline.bleInviteBody': 'Til telefoner, der ikke deler wi-fi med din. Ingen parring nødvendig.',
  'offline.bleOpen': 'Telefoner i nærheden kan deltage via Bluetooth. Forbundet: {n}.',
  'offline.bleStop': 'Stop Bluetooth',
  'offline.bleCheck': 'Kontrolkode: {code}',
  'offline.guestBle': 'Du sidder via Bluetooth ved et bord, som en anden telefon er vært for.',
  'offline.keyChanged': 'Det er ikke den telefon, du har spillet ved under det navn før. Spørg værten, eller deltag via wi-fi.',
  // --- game notifications: invites, the game circle, push (src/notify) ---
  'err.NOT_PLAYED_TOGETHER': 'Du kan kun tilføje folk, du har spillet med. Send dem dit vennelink, eller spørg via brugernavn.',
  'err.UNKNOWN_PLAYER': 'Ingen spiller under det navn.',
  'err.UNKNOWN_FRIEND_CODE': 'Det vennelink virker ikke længere.',
  'err.CANNOT_ADD_SELF': 'Det er dig. Tilføj en anden.',
  'err.RATE_LIMITED': 'For mange på én gang. Prøv igen om et par minutter.',
  'err.PUSH_UNAVAILABLE': 'Notifikationer er ikke sat op på denne server.',
  'notify.someone': 'Nogen',
  'notify.join': 'Deltag',
  'notify.joining': 'Deltager…',
  'notify.goToTable': 'Gå til bordet',
  'notify.notNow': 'Ikke nu',
  'notify.moreOptions': 'Flere muligheder',
  'notify.muteHost': 'Ingen invitationer fra {host}',
  'notify.joinFailed': 'Kunne ikke deltage: {reason}',
  'notify.hostingOffline': 'Du er vært for et bord på denne telefon. Forlad det først for at deltage i et andet.',
  'notify.on': 'Til',
  'notify.off': 'Fra',
  'notify.channelName': 'Spilinvitationer',
  'notify.banner.online': '{host} har åbnet et bord med {game}',
  'notify.banner.onlineNoGame': '{host} har åbnet et bord',
  'notify.banner.nearby': '{host} er vært for et bord i nærheden',
  'notify.banner.seated': 'Du er blevet sat ved et bord',
  'notify.banner.fromCircle': 'Fra din spillekreds',
  'notify.banner.known': 'I har spillet sammen før',
  'notify.banner.nearbyDetail': 'På en telefon i nærheden',
  'notify.banner.seatedDetail': 'En vært valgte dig fra venteværelset',
  'notify.banner.more': '+{n} mere',
  'notify.pillOne': '1 bord venter',
  'notify.pillMany': '{n} borde venter',
  'notify.waitingCard.title': 'Borde, der venter på dig',
  'notify.waitingCard.empty': 'Ingen borde venter på dig.',
  'notify.prompt.title': 'Få besked, når din kreds starter et spil',
  'notify.prompt.body': 'Kun borde åbnet af folk i din spillekreds. Du kan slå det fra under Indstillinger.',
  'notify.prompt.enable': 'Slå til',
  'notify.prompt.later': 'Senere',
  'notify.settings.heading': 'Notifikationer',
  'notify.settings.invites': 'Spilinvitationer',
  'notify.settings.invitesBody': 'Hvem der må give dig besked, når de åbner et bord.',
  'notify.settings.invitesCircle': 'Min kreds',
  'notify.settings.invitesOff': 'Ingen',
  'notify.settings.nearby': 'Borde i nærheden',
  'notify.settings.nearbyBody': 'Vis et banner, når en telefon i nærheden åbner et bord. Virker, mens appen er åben.',
  'notify.settings.push': 'Notifikationer på denne enhed',
  'notify.settings.pushOn': 'Til. Du får besked om borde, selv når appen er lukket.',
  'notify.settings.pushOff': 'Fra. Invitationer vises kun, mens appen er åben.',
  'notify.settings.pushBlocked': 'Blokeret. Tillad notifikationer for denne app i telefonens indstillinger.',
  'notify.settings.pushBlockedWeb': 'Blokeret. Tillad notifikationer for dette websted i browserens indstillinger.',
  'notify.settings.pushInstall': 'På iPhone og iPad skal du først føje dette websted til hjemmeskærmen og slå notifikationer til der.',
  'notify.settings.pushUnavailable': 'Denne server sender ikke notifikationer.',
  'notify.settings.pushUnsupported': 'Denne enhed eller browser kan ikke vise notifikationer.',
  'notify.settings.signIn': 'Log ind, eller spil som gæst for at få spilinvitationer.',
  'notify.announce.heading': 'Giv min kreds besked',
  'notify.announce.body': 'Folk i din spillekreds får besked om dette bord og kan deltage med ét tryk.',
  'notify.announce.toggle': 'Giv min kreds besked, når jeg åbner et bord',
  'notify.announce.sending': 'Giver din kreds besked…',
  'notify.announce.toldOne': '1 spiller har fået besked',
  'notify.announce.toldMany': '{n} spillere har fået besked',
  'notify.announce.already': 'Din kreds kender allerede til dette bord.',
  'notify.announce.nobody': 'Ingen at give besked endnu. Tilføj folk til din kreds.',
  'notify.announce.circleLink': 'Spillekreds',
  'notify.addToCircle': 'Føj {name} til din kreds',
  ...
  'offline.tellNearbyBody': 'Telefoner i rummet med appen åben får tilbudt dette bord.',
  'circle.title': 'Spillekreds',
  'circle.subtitle': 'De folk, du giver besked, når du åbner et bord, og de folk, der giver dig besked.',
  'circle.signInRequired': 'Log ind, eller spil som gæst for at opbygge en spillekreds.',
  'circle.requests.heading': 'Anmodninger',
  'circle.requests.body': 'De vil gerne give dig besked, når de åbner et bord.',
  'circle.accept': 'Accepter',
  'circle.decline': 'Afvis',
  'circle.members.heading': 'Din kreds',
  'circle.members.body': 'De får besked om de borde, du åbner for venner.',
  'circle.members.empty': 'Ingen endnu. Tilføj folk nedenfor.',
  'circle.pending': 'Venter på accept',
  'circle.since': 'Siden {date}',
  'circle.remove': 'Fjern',
  'circle.notifiers.heading': 'Hvem der kan invitere dig',
  'circle.notifiers.body': 'Slå lyden fra for alle, hvis borde du helst ikke vil høre om.',
  'circle.notifiers.empty': 'Ingen har tilføjet dig endnu.',
  'circle.mute': 'Slå lyd fra',
  'circle.unmute': 'Slå lyd til',
  'circle.muted': 'Lyd slået fra',
  'circle.suggestions.heading': 'Spillet for nylig',
  'circle.suggestions.body': 'Folk, du har delt bord med. Tilføj dem for at give dem besked om dine borde.',
  'circle.lastPlayed': 'Sidst spillet {date}',
  'circle.add': 'Tilføj',
  'circle.added': '{name} er i din kreds.',
  'circle.addSomeone.heading': 'Tilføj nogen',
  'circle.friendLink.body': 'Alle, der åbner dit vennelink, kommer i din kreds, og du i deres.',
  'circle.shareMessage': 'Kom med i min spillekreds på Jokerless',
  'circle.username.body': 'Eller spørg via brugernavn. Den anden skal acceptere.',
  'circle.username.placeholder': 'Brugernavn',
  'circle.username.submit': 'Send anmodning',
  'circle.username.sent': 'Anmodning sendt til {name}.',
  'circle.settingsLink': 'Indstillinger for notifikationer',
  'circle.addFriend.title': 'Føj til spillekreds',
  'circle.addFriend.loading': 'Tjekker linket…',
  'circle.addFriend.missing': 'Dette link har ingen vennekode.',
  'circle.addFriend.body': '{name} inviterer dig i sin spillekreds. I får begge besked, når den anden åbner et bord.',
