...
export const lt: Record<string, string> = {
  ...
  'match.abandonedWaitingFor': 'Laukiama, kol {names} grįš prie stalo.',
  ...
  'option.openDiscardPile': 'Atmetimo krūvelė',
  'choice.openDiscardPile.1': 'Galima peržiūrėti',
  'choice.openDiscardPile.0': 'Tik viršutinė korta',
  ...
  'replay.track.all': 'Viskas',
  'replay.track.yours': 'Tavo ėjimai',
  'replay.track.rounds': 'Raundai',
  'replay.track.marks': 'Žymės',
  'replay.play': 'Groti',
  'replay.pause': 'Pauzė',
  ...
  'home.playOffline': 'Žaisti neprisijungus',
  'offline.title': 'Žaisti neprisijungus',
  'offline.subtitle': 'Internetas nereikalingas',
  'offline.body': 'Šis telefonas pats laiko stalą, todėl su robotais galite žaisti bet kur – net lėktuvo režimu.',
  'offline.nameLabel': 'Jūsų vardas prie stalo',
  'offline.start': 'Atidaryti stalą neprisijungus',
  'offline.starting': 'Paleidžiama…',
  'offline.active': 'Esate prie šio telefono stalo neprisijungus. Čia pradėti žaidimai lieka šiame telefone.',
  'offline.chooseGame': 'Pasirinkite žaidimą',
  'offline.backOnline': 'Grįžti į žaidimą internete',
  'offline.failed': 'Stalas neprisijungus nepasileido: {reason}',
  'offline.nearbyTitle': 'Stalai netoliese',
  'offline.nearbyLooking': 'Ieškoma stalų šiame tinkle…',
  'offline.nearbyNothing': 'Stalų dar nerasta. Įsitikinkite, kad esate tame pačiame „Wi-Fi“ ar viešosios interneto prieigos taške kaip šeimininkas ir kad „Zolik“ gali naudoti vietinį tinklą.',
  'offline.joinThis': 'Prisijungti',
  'offline.byAddressTitle': 'Prisijungti pagal adresą',
  'offline.versionMismatch': 'Šis stalas naudoja kitą „Zolik“ versiją. Atnaujinkite programą abiejuose telefonuose.',
  'offline.roomTitle': 'Žaidėjai netoliese',
  'offline.roomBody': 'Leiskite kitiems šio „Wi-Fi“ ar prieigos taško telefonams prisijungti prie jūsų stalo. Internetas nereikalingas.',
  'offline.roomOpenButton': 'Pakviesti žaidėjus netoliese',
  'offline.roomOpen': 'Kiti šio tinklo telefonai dabar gali rasti jūsų stalą. Jei jo nemato, gali įvesti adresą arba nuskaityti kodą.',
  'offline.roomClose': 'Nebekviesti',
  'offline.guestActive': 'Sėdite prie stalo, kurį laiko kitas telefonas ({host}).',
  'offline.joinFailed': 'Nepavyko prisijungti prie šio stalo: {reason}',
  'invite.offlineExplain': 'Šio stalo neprisijungus žaidėjai prisijungia šiuo kodu per „{menu}“.',
  'invite.offlineCode': 'Kodas:',
  'offline.bleTitle': 'Per „Bluetooth“',
  'offline.bleLook': 'Ieškoti stalų per „Bluetooth“',
  'offline.bleLooking': 'Ieškoma stalų per „Bluetooth“…',
  'offline.bleOff': 'Įjunkite „Bluetooth“, kad rastumėte stalus be „Wi-Fi“.',
  'offline.bleDenied': 'Nustatymuose leiskite „Zolik“ naudoti „Bluetooth“, kad galėtumėte žaisti be „Wi-Fi“.',
  'offline.bleInvite': 'Pakviesti per „Bluetooth“',
  'offline.bleInviteBody': 'Telefonams, kurie su jūsų telefonu nedalija „Wi-Fi“. Susieti nereikia.',
  'offline.bleOpen': 'Netoliese esantys telefonai gali prisijungti per „Bluetooth“. Prisijungę: {n}.',
  'offline.bleStop': 'Išjungti „Bluetooth“',
  'offline.bleCheck': 'Patikros kodas: {code}',
  'offline.guestBle': 'Per „Bluetooth“ sėdite prie stalo, kurį laiko kitas telefonas.',
  'offline.keyChanged': 'Tai ne tas telefonas, prie kurio anksčiau žaidėte šiuo vardu. Paklauskite šeimininko arba prisijunkite per „Wi-Fi“.',
  // --- game notifications: invites, the game circle, push (src/notify) ---
  'err.NOT_PLAYED_TOGETHER': 'Galite pridėti tik žmones, su kuriais žaidėte. Nusiųskite jiems savo draugo nuorodą arba paprašykite pagal naudotojo vardą.',
  'err.UNKNOWN_PLAYER': 'Tokiu vardu niekas nežaidžia.',
  'err.UNKNOWN_FRIEND_CODE': 'Ši draugo nuoroda nebeveikia.',
  'err.CANNOT_ADD_SELF': 'Tai jūs. Pridėkite ką nors kitą.',
  'err.RATE_LIMITED': 'Per daug vienu metu. Bandykite po kelių minučių.',
  'err.PUSH_UNAVAILABLE': 'Šiame serveryje pranešimai nenustatyti.',
  'notify.someone': 'Kažkas',
  'notify.join': 'Prisijungti',
  'notify.joining': 'Jungiamasi…',
  'notify.goToTable': 'Prie stalo',
  'notify.notNow': 'Ne dabar',
  'notify.moreOptions': 'Daugiau parinkčių',
  'notify.muteHost': 'Negauti kvietimų iš {host}',
  'notify.joinFailed': 'Nepavyko prisijungti: {reason}',
  'notify.hostingOffline': 'Šiame telefone rengiate stalą. Pirmiausia jį palikite, kad prisijungtumėte prie kito.',
  'notify.on': 'Įjungta',
  'notify.off': 'Išjungta',
  'notify.channelName': 'Kvietimai žaisti',
  'notify.banner.online': '{host} atidarė stalą: {game}',
  'notify.banner.onlineNoGame': '{host} atidarė stalą',
  'notify.banner.nearby': '{host} rengia stalą netoliese',
  'notify.banner.seated': 'Jus pasodino prie stalo',
  'notify.banner.fromCircle': 'Iš jūsų žaidimų rato',
  'notify.banner.known': 'Jau esate žaidę kartu',
  'notify.banner.nearbyDetail': 'Telefone šalia jūsų',
  'notify.banner.seatedDetail': 'Šeimininkas jus pasirinko iš laukiamojo',
  'notify.banner.more': '+{n} daugiau',
  'notify.pillOne': 'Laukia 1 stalas',
  'notify.pillMany': 'Laukiantys stalai: {n}',
  'notify.waitingCard.title': 'Jūsų laukiantys stalai',
  'notify.waitingCard.empty': 'Jūsų nelaukia joks stalas.',
  'notify.prompt.title': 'Sužinokite, kai jūsų ratas pradeda žaidimą',
  'notify.prompt.body': 'Tik stalai, kuriuos atidaro jūsų žaidimų rato žmonės. Tai galite išjungti nustatymuose.',
  'notify.prompt.enable': 'Įjungti',
  'notify.prompt.later': 'Vėliau',
  'notify.settings.heading': 'Pranešimai',
  'notify.settings.invites': 'Kvietimai žaisti',
  'notify.settings.invitesBody': 'Kas gali jums pranešti, kad atidarė stalą.',
  'notify.settings.invitesCircle': 'Mano ratas',
  'notify.settings.invitesOff': 'Niekas',
  'notify.settings.nearby': 'Stalai netoliese',
  'notify.settings.nearbyBody': 'Rodyti pranešimą, kai netoliese esantis telefonas atidaro stalą. Veikia, kai programėlė atidaryta.',
  'notify.settings.push': 'Pranešimai šiame įrenginyje',
  'notify.settings.pushOn': 'Įjungta. Apie stalus sužinosite net ir uždarius programėlę.',
  'notify.settings.pushOff': 'Išjungta. Kvietimai rodomi tik atidarytoje programėlėje.',
  'notify.settings.pushBlocked': 'Užblokuota. Leiskite šios programėlės pranešimus telefono nustatymuose.',
  'notify.settings.pushBlockedWeb': 'Užblokuota. Leiskite šios svetainės pranešimus naršyklės nustatymuose.',
  'notify.settings.pushInstall': 'iPhone ir iPad įrenginiuose pirmiausia pridėkite šią svetainę prie pradžios ekrano ir ten įjunkite pranešimus.',
  'notify.settings.pushUnavailable': 'Šis serveris nesiunčia pranešimų.',
  'notify.settings.pushUnsupported': 'Šis įrenginys ar naršyklė negali rodyti pranešimų.',
  'notify.settings.signIn': 'Prisijunkite arba žaiskite kaip svečias, kad gautumėte kvietimus žaisti.',
  'notify.announce.heading': 'Pranešti mano ratui',
  'notify.announce.body': 'Jūsų žaidimų rato žmonės sužinos apie šį stalą ir galės prisijungti vienu palietimu.',
  'notify.announce.toggle': 'Pranešti mano ratui, kai atidarau stalą',
  'notify.announce.sending': 'Pranešama jūsų ratui…',
  'notify.announce.toldOne': 'Pranešta 1 žaidėjui',
  'notify.announce.toldMany': 'Pranešta žaidėjų: {n}',
  'notify.announce.already': 'Jūsų ratas jau žino apie šį stalą.',
  'notify.announce.nobody': 'Kol kas nėra kam pranešti. Pridėkite žmonių į savo ratą.',
  'notify.announce.circleLink': 'Žaidimų ratas',
  'notify.addToCircle': 'Pridėti {name} į savo ratą',
  ...
  'offline.tellNearbyBody': 'Kambario telefonams su atidaryta programėle bus pasiūlytas šis stalas.',
  'circle.title': 'Žaidimų ratas',
  'circle.subtitle': 'Žmonės, kuriems pranešate atidarę stalą, ir žmonės, kurie praneša jums.',
  'circle.signInRequired': 'Prisijunkite arba žaiskite kaip svečias, kad sukurtumėte žaidimų ratą.',
  'circle.requests.heading': 'Prašymai',
  'circle.requests.body': 'Jie norėtų jums pranešti, kai atidaro stalą.',
  'circle.accept': 'Priimti',
  'circle.decline': 'Atmesti',
  'circle.members.heading': 'Jūsų ratas',
  'circle.members.body': 'Jie sužino apie stalus, kuriuos atidarote draugams.',
  'circle.members.empty': 'Kol kas nieko. Pridėkite žmonių žemiau.',
  'circle.pending': 'Laukia patvirtinimo',
  'circle.since': 'Nuo {date}',
  'circle.remove': 'Pašalinti',
  'circle.notifiers.heading': 'Kas gali jus pakviesti',
  'circle.notifiers.body': 'Nutildykite visus, apie kurių stalus nenorite girdėti.',
  'circle.notifiers.empty': 'Jūsų dar niekas nepridėjo.',
  'circle.mute': 'Nutildyti',
  'circle.unmute': 'Įjungti garsą',
  'circle.muted': 'Nutildyta',
  'circle.suggestions.heading': 'Neseniai žaista',
  'circle.suggestions.body': 'Žmonės, su kuriais sėdėjote prie vieno stalo. Pridėkite juos, kad sužinotų apie jūsų stalus.',
  'circle.lastPlayed': 'Paskutinį kartą žaista {date}',
  'circle.add': 'Pridėti',
  'circle.added': '{name} yra jūsų rate.',
  'circle.addSomeone.heading': 'Pridėti ką nors',
  'circle.friendLink.body': 'Kiekvienas, atidaręs jūsų draugo nuorodą, prisijungia prie jūsų rato, o jūs prie jo.',
  'circle.shareMessage': 'Prisijunk prie mano žaidimų rato Jokerless',
  'circle.username.body': 'Arba paprašykite pagal naudotojo vardą. Kitas turi sutikti.',
  'circle.username.placeholder': 'Naudotojo vardas',
  'circle.username.submit': 'Siųsti prašymą',
  'circle.username.sent': 'Prašymas išsiųstas: {name}.',
  'circle.settingsLink': 'Pranešimų nustatymai',
  'circle.addFriend.title': 'Pridėti į žaidimų ratą',
  'circle.addFriend.loading': 'Tikrinama nuoroda…',
  'circle.addFriend.missing': 'Šioje nuorodoje nėra draugo kodo.',
  'circle.addFriend.body': '{name} kviečia jus į savo žaidimų ratą. Abu sužinosite, kai kitas atidarys stalą.',
