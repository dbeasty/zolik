...
export const et: Record<string, string> = {
  ...
  'holdem.status.pot': '{winners} võitis {amount} käega {hand} — {cards}',
  'holdem.status.potSplit': '{winners} võitis {amount} käega {hand}',
  ...
  'match.you': 'sina',
  'match.yourTeam': 'Sinu meeskond',
  'match.teammates': 'Meeskond: {names}',
  ...
  'option.openDiscardPile': 'Viskepakk',
  'choice.openDiscardPile.1': 'Võib läbi vaadata',
  'choice.openDiscardPile.0': 'Ainult pealmine kaart',
  ...
  'replay.round': 'Voor',
  'replay.track.all': 'Kõik',
  'replay.track.yours': 'Sinu käigud',
  'replay.track.rounds': 'Voorud',
  'replay.track.marks': 'Märgid',
  'replay.play': 'Esita',
  'replay.pause': 'Paus',
  ...
  'home.playOffline': 'Mängi võrguta',
  'offline.title': 'Mängi võrguta',
  'offline.subtitle': 'Internetti pole vaja',
  'offline.body': 'See telefon peab lauda ise, nii et saad bottide vastu mängida kõikjal – isegi lennurežiimis.',
  'offline.nameLabel': 'Sinu nimi laua taga',
  'offline.start': 'Ava võrguta laud',
  'offline.starting': 'Käivitan…',
  'offline.active': 'Oled selle telefoni võrguta laua taga. Siin alustatud mängud jäävad sellesse telefoni.',
  'offline.chooseGame': 'Vali mäng',
  'offline.backOnline': 'Tagasi võrgumängu',
  'offline.failed': 'Võrguta laud ei käivitunud: {reason}',
  'offline.nearbyTitle': 'Lauad läheduses',
  'offline.nearbyLooking': 'Otsin selles võrgus laudu…',
  'offline.nearbyNothing': 'Laudu pole veel leitud. Veendu, et oled võõrustajaga samas WiFis või kuumkohas ja et Zolik tohib kasutada kohtvõrku.',
  'offline.joinThis': 'Liitu',
  'offline.byAddressTitle': 'Liitu aadressiga',
  'offline.versionMismatch': 'See laud kasutab teist Zoliku versiooni. Uuenda rakendust mõlemas telefonis.',
  'offline.roomTitle': 'Mängijad läheduses',
  'offline.roomBody': 'Lase selle WiFi või kuumkoha teistel telefonidel su lauaga liituda. Internetti pole vaja.',
  'offline.roomOpenButton': 'Kutsu lähedal olevad mängijad',
  'offline.roomOpen': 'Selle võrgu teised telefonid leiavad nüüd su laua. Kui nad seda ei näe, saavad nad sisestada aadressi või skannida koodi.',
  'offline.roomClose': 'Lõpeta kutsumine',
  'offline.guestActive': 'Istud laua taga, mida peab teine telefon ({host}).',
  'offline.joinFailed': 'Selle lauaga ei õnnestunud liituda: {reason}',
  'invite.offlineExplain': 'Selle võrguta laua mängijad liituvad selle koodiga menüüs „{menu}“.',
  'invite.offlineCode': 'Kood:',
  'offline.bleTitle': 'Bluetoothi kaudu',
  'offline.bleLook': 'Otsi laudu Bluetoothi kaudu',
  'offline.bleLooking': 'Otsin laudu Bluetoothi kaudu…',
  'offline.bleOff': 'Lülita Bluetooth sisse, et leida laudu ilma WiFita.',
  'offline.bleDenied': 'Luba seadetes Zolikul Bluetoothi kasutada, et mängida ilma WiFita.',
  'offline.bleInvite': 'Kutsu Bluetoothi kaudu',
  'offline.bleInviteBody': 'Telefonidele, millel pole sinuga ühist WiFit. Sidumist pole vaja.',
  'offline.bleOpen': 'Lähedal olevad telefonid saavad liituda Bluetoothi kaudu. Ühendatud: {n}.',
  'offline.bleStop': 'Lõpeta Bluetooth',
  'offline.bleCheck': 'Kontrollkood: {code}',
  'offline.guestBle': 'Istud Bluetoothi kaudu laua taga, mida peab teine telefon.',
  'offline.keyChanged': 'See pole telefon, mille laua taga sa varem selle nimega mängisid. Küsi võõrustajalt või liitu WiFi kaudu.',
  // --- game notifications: invites, the game circle, push (src/notify) ---
  'err.NOT_PLAYED_TOGETHER': 'Saad lisada ainult inimesi, kellega oled mänginud. Saada neile oma sõbralink või küsi kasutajanime kaudu.',
  'err.UNKNOWN_PLAYER': 'Selle nimega keegi ei mängi.',
  'err.UNKNOWN_FRIEND_CODE': 'See sõbralink enam ei tööta.',
  'err.CANNOT_ADD_SELF': 'See oled sina. Lisa keegi teine.',
  'err.RATE_LIMITED': 'Liiga palju korraga. Proovi mõne minuti pärast uuesti.',
  'err.PUSH_UNAVAILABLE': 'Selles serveris pole teavitusi seadistatud.',
  'notify.someone': 'Keegi',
  'notify.join': 'Liitu',
  'notify.joining': 'Liitumine…',
  'notify.goToTable': 'Laua juurde',
  'notify.notNow': 'Mitte praegu',
  'notify.moreOptions': 'Rohkem valikuid',
  'notify.muteHost': 'Ära saa kutseid mängijalt {host}',
  'notify.joinFailed': 'Liitumine ebaõnnestus: {reason}',
  'notify.hostingOffline': 'Sa pead selles telefonis lauda. Lahku sellest enne, kui liitud teisega.',
  'notify.on': 'Sees',
  'notify.off': 'Väljas',
  'notify.channelName': 'Mängukutsed',
  'notify.banner.online': '{host} avas laua: {game}',
  'notify.banner.onlineNoGame': '{host} avas laua',
  'notify.banner.nearby': '{host} peab lauda sinu lähedal',
  'notify.banner.seated': 'Sind pandi laua taha',
  'notify.banner.fromCircle': 'Sinu mänguringist',
  'notify.banner.known': 'Olete varem koos mänginud',
  'notify.banner.nearbyDetail': 'Sinu lähedal olevas telefonis',
  'notify.banner.seatedDetail': 'Võõrustaja valis su ooteruumist',
  'notify.banner.more': '+{n} veel',
  'notify.pillOne': '1 laud ootab',
  'notify.pillMany': 'Ootavaid laudu: {n}',
  'notify.waitingCard.title': 'Sind ootavad lauad',
  'notify.waitingCard.empty': 'Ükski laud sind ei oota.',
  'notify.prompt.title': 'Saa teada, kui su ring alustab mängu',
  'notify.prompt.body': 'Ainult sinu mänguringi inimeste avatud lauad. Saad selle seadetes välja lülitada.',
  'notify.prompt.enable': 'Lülita sisse',
  'notify.prompt.later': 'Hiljem',
  'notify.settings.heading': 'Teavitused',
  'notify.settings.invites': 'Mängukutsed',
  'notify.settings.invitesBody': 'Kes võib sulle teada anda, kui ta laua avab.',
  'notify.settings.invitesCircle': 'Minu ring',
  'notify.settings.invitesOff': 'Mitte keegi',
  'notify.settings.nearby': 'Lähedal olevad lauad',
  'notify.settings.nearbyBody': 'Näita teadet, kui lähedal olev telefon avab laua. Töötab, kui rakendus on avatud.',
  'notify.settings.push': 'Teavitused selles seadmes',
  'notify.settings.pushOn': 'Sees. Saad laudadest teada ka siis, kui rakendus on suletud.',
  'notify.settings.pushOff': 'Väljas. Kutsed ilmuvad ainult avatud rakenduses.',
  'notify.settings.pushBlocked': 'Blokeeritud. Luba selle rakenduse teavitused telefoni seadetes.',
  'notify.settings.pushBlockedWeb': 'Blokeeritud. Luba selle saidi teavitused brauseri seadetes.',
  'notify.settings.pushInstall': 'iPhone\'is ja iPadis lisa see sait esmalt avakuvale ja lülita teavitused sisse seal.',
  'notify.settings.pushUnavailable': 'See server teavitusi ei saada.',
  'notify.settings.pushUnsupported': 'See seade või brauser ei saa teavitusi näidata.',
  'notify.settings.signIn': 'Logi sisse või mängi külalisena, et saada mängukutseid.',
  'notify.announce.heading': 'Teavita minu ringi',
  'notify.announce.body': 'Sinu mänguringi inimesed saavad sellest lauast teada ja saavad liituda ühe puudutusega.',
  'notify.announce.toggle': 'Teavita mu ringi, kui avan laua',
  'notify.announce.sending': 'Teavitan sinu ringi…',
  'notify.announce.toldOne': 'Teavitatud 1 mängijat',
  'notify.announce.toldMany': 'Teavitatud mängijaid: {n}',
  'notify.announce.already': 'Sinu ring juba teab sellest lauast.',
  'notify.announce.nobody': 'Pole veel kedagi teavitada. Lisa inimesi oma ringi.',
  'notify.announce.circleLink': 'Mänguring',
  'notify.addToCircle': 'Lisa {name} oma ringi',
  ...
  'offline.tellNearbyBody': 'Ruumis olevatele telefonidele, kus rakendus on avatud, pakutakse seda lauda.',
  'circle.title': 'Mänguring',
  'circle.subtitle': 'Inimesed, keda teavitad laua avamisest, ja inimesed, kes teavitavad sind.',
  'circle.signInRequired': 'Logi sisse või mängi külalisena, et luua mänguring.',
  'circle.requests.heading': 'Taotlused',
  'circle.requests.body': 'Nad tahaksid sulle teada anda, kui nad laua avavad.',
  'circle.accept': 'Nõustu',
  'circle.decline': 'Keeldu',
  'circle.members.heading': 'Sinu ring',
  'circle.members.body': 'Nad saavad teada laudadest, mille avad sõpradele.',
  'circle.members.empty': 'Veel mitte kedagi. Lisa inimesi allpool.',
  'circle.pending': 'Ootab nõusolekut',
  'circle.since': 'Alates {date}',
  'circle.remove': 'Eemalda',
  'circle.notifiers.heading': 'Kes võivad sind kutsuda',
  'circle.notifiers.body': 'Vaigista kõik, kelle laudadest sa kuulda ei taha.',
  'circle.notifiers.empty': 'Keegi pole sind veel lisanud.',
  'circle.mute': 'Vaigista',
  'circle.unmute': 'Tühista vaigistus',
  'circle.muted': 'Vaigistatud',
  'circle.suggestions.heading': 'Hiljuti mängitud',
  'circle.suggestions.body': 'Inimesed, kellega oled laua taga istunud. Lisa nad, et nad sinu laudadest teada saaksid.',
  'circle.lastPlayed': 'Viimati mängitud {date}',
  'circle.add': 'Lisa',
  'circle.added': '{name} on sinu ringis.',
  'circle.addSomeone.heading': 'Lisa keegi',
  'circle.friendLink.body': 'Igaüks, kes su sõbralingi avab, liitub sinu ringiga ja sina tema omaga.',
  'circle.shareMessage': 'Liitu minu mänguringiga Jokerlessis',
  'circle.username.body': 'Või küsi kasutajanime kaudu. Teine peab nõustuma.',
  'circle.username.placeholder': 'Kasutajanimi',
  'circle.username.submit': 'Saada taotlus',
  'circle.username.sent': 'Taotlus saadetud: {name}.',
  'circle.settingsLink': 'Teavituste seaded',
  'circle.addFriend.title': 'Lisa mänguringi',
  'circle.addFriend.loading': 'Kontrollin linki…',
  'circle.addFriend.missing': 'Sellel lingil pole sõbrakoodi.',
  'circle.addFriend.body': '{name} kutsub sind oma mänguringi. Mõlemad saate teada, kui teine laua avab.',
