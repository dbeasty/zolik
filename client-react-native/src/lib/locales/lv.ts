...
export const lv: Record<string, string> = {
  ...
  'err.DISPLACED': 'Atvērts citā cilnē — šis pārtrauca sinhronizēties',
  ...
  'err.REPLAY_UNAVAILABLE': 'Spēļu atkārtojums šajā serverī nav pieejams',
  ...
  'holdem.status.pot': '{winners} uzvarēja {amount} ar {hand} — {cards}',
  'holdem.status.potSplit': '{winners} uzvarēja {amount} ar {hand}',
  ...
  'match.abandonedWaitingFor': 'Gaida, kad {names} atgriezīsies pie galda.',
  ...
  'replay.round': 'Raunds',
  'replay.track.all': 'Viss',
  'replay.track.yours': 'Tavi gājieni',
  'replay.track.rounds': 'Raundi',
  'replay.track.marks': 'Atzīmes',
  ...
  'home.playOffline': 'Spēlēt bezsaistē',
  'offline.title': 'Spēlēt bezsaistē',
  'offline.subtitle': 'Internets nav vajadzīgs',
  'offline.body': 'Šis tālrunis pats uztur galdu, tāpēc vari spēlēt pret robotiem jebkur — pat lidojuma režīmā.',
  'offline.nameLabel': 'Tavs vārds pie galda',
  'offline.start': 'Atvērt bezsaistes galdu',
  'offline.starting': 'Palaiž…',
  'offline.active': 'Tu esi pie šī tālruņa bezsaistes galda. Šeit sāktās spēles paliek šajā tālrunī.',
  'offline.chooseGame': 'Izvēlies spēli',
  'offline.backOnline': 'Atpakaļ uz tiešsaistes spēli',
  'offline.failed': 'Bezsaistes galds netika palaists: {reason}',
  'offline.nearbyTitle': 'Galdi tuvumā',
  'offline.nearbyLooking': 'Meklē galdus šajā tīklā…',
  'offline.nearbyNothing': 'Galdi vēl nav atrasti. Pārliecinies, ka esi tajā pašā Wi-Fi vai tīklājā kā saimnieks un ka Zolik drīkst izmantot lokālo tīklu.',
  'offline.joinThis': 'Pievienoties',
  'offline.byAddressTitle': 'Pievienoties pēc adreses',
  'offline.versionMismatch': 'Šis galds darbojas ar citu Zolik versiju. Atjaunini lietotni abos tālruņos.',
  'offline.roomTitle': 'Spēlētāji tuvumā',
  'offline.roomBody': 'Ļauj citiem šī Wi-Fi vai tīklāja tālruņiem pievienoties tavam galdam. Internets nav vajadzīgs.',
  'offline.roomOpenButton': 'Uzaicināt tuvumā esošos spēlētājus',
  'offline.roomOpen': 'Citi šī tīkla tālruņi tagad var atrast tavu galdu. Ja viņi to neredz, var ievadīt adresi vai noskenēt kodu.',
  'offline.roomClose': 'Pārtraukt aicināt',
  'offline.guestActive': 'Tu sēdi pie galda, ko uztur cits tālrunis ({host}).',
  'offline.joinFailed': 'Neizdevās pievienoties šim galdam: {reason}',
  'invite.offlineExplain': 'Šī bezsaistes galda spēlētāji pievienojas ar šo kodu sadaļā “{menu}”.',
  'invite.offlineCode': 'Kods:',
  'offline.bleTitle': 'Caur Bluetooth',
  'offline.bleLook': 'Meklēt galdus caur Bluetooth',
  'offline.bleLooking': 'Meklē galdus caur Bluetooth…',
  'offline.bleOff': 'Ieslēdz Bluetooth, lai atrastu galdus bez Wi-Fi.',
  'offline.bleDenied': 'Iestatījumos atļauj Zolik izmantot Bluetooth, lai spēlētu bez Wi-Fi.',
  'offline.bleInvite': 'Uzaicināt caur Bluetooth',
  'offline.bleInviteBody': 'Tālruņiem, kuriem ar tavējo nav kopīga Wi-Fi. Savienošana pārī nav vajadzīga.',
  'offline.bleOpen': 'Tuvumā esošie tālruņi var pievienoties caur Bluetooth. Pievienoti: {n}.',
  'offline.bleStop': 'Apturēt Bluetooth',
  'offline.bleCheck': 'Pārbaudes kods: {code}',
  'offline.guestBle': 'Tu caur Bluetooth sēdi pie galda, ko uztur cits tālrunis.',
  'offline.keyChanged': 'Šis nav tālrunis, pie kura tu iepriekš spēlēji ar šo vārdu. Pajautā saimniekam vai pievienojies caur Wi-Fi.',
  // --- game notifications: invites, the game circle, push (src/notify) ---
  'err.NOT_PLAYED_TOGETHER': 'Varat pievienot tikai cilvēkus, ar kuriem esi spēlējis. Nosūti viņiem savu drauga saiti vai lūdz pēc lietotājvārda.',
  'err.UNKNOWN_PLAYER': 'Ar šo vārdu neviens nespēlē.',
  'err.UNKNOWN_FRIEND_CODE': 'Šī drauga saite vairs nedarbojas.',
  'err.CANNOT_ADD_SELF': 'Tas esi tu. Pievieno kādu citu.',
  'err.RATE_LIMITED': 'Pārāk daudz uzreiz. Mēģini vēlreiz pēc dažām minūtēm.',
  'err.PUSH_UNAVAILABLE': 'Šajā serverī paziņojumi nav iestatīti.',
  'notify.someone': 'Kāds',
  'notify.join': 'Pievienoties',
  'notify.joining': 'Pievienojas…',
  'notify.goToTable': 'Pie galda',
  'notify.notNow': 'Ne tagad',
  'notify.moreOptions': 'Vairāk iespēju',
  'notify.muteHost': 'Nesaņemt ielūgumus no {host}',
  'notify.joinFailed': 'Neizdevās pievienoties: {reason}',
  'notify.hostingOffline': 'Tu vadi galdu šajā tālrunī. Vispirms to pamet, lai pievienotos citam.',
  'notify.on': 'Ieslēgts',
  'notify.off': 'Izslēgts',
  'notify.channelName': 'Spēļu ielūgumi',
  'notify.banner.online': '{host} atvēra galdu: {game}',
  'notify.banner.onlineNoGame': '{host} atvēra galdu',
  'notify.banner.nearby': '{host} vada galdu tuvumā',
  'notify.banner.seated': 'Tevi nosēdināja pie galda',
  'notify.banner.fromCircle': 'No tava spēļu loka',
  'notify.banner.known': 'Jūs jau esat spēlējuši kopā',
  'notify.banner.nearbyDetail': 'Tālrunī tavā tuvumā',
  'notify.banner.seatedDetail': 'Saimnieks tevi izvēlējās no uzgaidāmās telpas',
  'notify.banner.more': '+{n} vēl',
  'notify.pillOne': 'Gaida 1 galds',
  'notify.pillMany': 'Gaidošie galdi: {n}',
  'notify.waitingCard.title': 'Galdi, kas tevi gaida',
  'notify.waitingCard.empty': 'Neviens galds tevi negaida.',
  'notify.prompt.title': 'Uzzini, kad tavs loks sāk spēli',
  'notify.prompt.body': 'Tikai tava spēļu loka cilvēku atvērti galdi. To var izslēgt iestatījumos.',
  'notify.prompt.enable': 'Ieslēgt',
  'notify.prompt.later': 'Vēlāk',
  'notify.settings.heading': 'Paziņojumi',
  'notify.settings.invites': 'Spēļu ielūgumi',
  'notify.settings.invitesBody': 'Kas drīkst tev paziņot, ka atvēris galdu.',
  'notify.settings.invitesCircle': 'Mans loks',
  'notify.settings.invitesOff': 'Neviens',
  'notify.settings.nearby': 'Galdi tuvumā',
  'notify.settings.nearbyBody': 'Rādīt paziņojumu, kad tālrunis tavā tuvumā atver galdu. Darbojas, kamēr lietotne ir atvērta.',
  'notify.settings.push': 'Paziņojumi šajā ierīcē',
  'notify.settings.pushOn': 'Ieslēgti. Par galdiem uzzināsi arī tad, kad lietotne ir aizvērta.',
  'notify.settings.pushOff': 'Izslēgti. Ielūgumi parādās tikai atvērtā lietotnē.',
  'notify.settings.pushBlocked': 'Bloķēti. Atļauj šīs lietotnes paziņojumus tālruņa iestatījumos.',
  'notify.settings.pushBlockedWeb': 'Bloķēti. Atļauj šīs vietnes paziņojumus pārlūka iestatījumos.',
  'notify.settings.pushInstall': 'iPhone un iPad ierīcē vispirms pievieno šo vietni sākuma ekrānam un tur ieslēdz paziņojumus.',
  'notify.settings.pushUnavailable': 'Šis serveris nesūta paziņojumus.',
  'notify.settings.pushUnsupported': 'Šī ierīce vai pārlūks nevar rādīt paziņojumus.',
  'notify.settings.signIn': 'Pieslēdzies vai spēlē kā viesis, lai saņemtu spēļu ielūgumus.',
  'notify.announce.heading': 'Paziņot manam lokam',
  'notify.announce.body': 'Tava spēļu loka cilvēki uzzinās par šo galdu un varēs pievienoties ar vienu pieskārienu.',
  'notify.announce.toggle': 'Paziņot manam lokam, kad atveru galdu',
  'notify.announce.sending': 'Paziņo tavam lokam…',
  'notify.announce.toldOne': 'Paziņots 1 spēlētājam',
  'notify.announce.toldMany': 'Paziņots spēlētājiem: {n}',
  'notify.announce.already': 'Tavs loks jau zina par šo galdu.',
  'notify.announce.nobody': 'Vēl nav kam paziņot. Pievieno cilvēkus savam lokam.',
  'notify.announce.circleLink': 'Spēļu loks',
  'notify.addToCircle': 'Pievienot {name} savam lokam',
  ...
  'offline.tellNearbyBody': 'Tālruņiem telpā ar atvērtu lietotni tiek piedāvāts šis galds.',
  'circle.title': 'Spēļu loks',
  'circle.subtitle': 'Cilvēki, kuriem paziņo, kad atver galdu, un cilvēki, kas paziņo tev.',
  'circle.signInRequired': 'Pieslēdzies vai spēlē kā viesis, lai izveidotu spēļu loku.',
  'circle.requests.heading': 'Pieprasījumi',
  'circle.requests.body': 'Viņi vēlētos tev paziņot, kad atver galdu.',
  'circle.accept': 'Pieņemt',
  'circle.decline': 'Noraidīt',
  'circle.members.heading': 'Tavs loks',
  'circle.members.body': 'Viņi uzzina par galdiem, ko atver draugiem.',
  'circle.members.empty': 'Vēl neviena. Pievieno cilvēkus zemāk.',
  'circle.pending': 'Gaida apstiprinājumu',
  'circle.since': 'Kopš {date}',
  'circle.remove': 'Noņemt',
  'circle.notifiers.heading': 'Kas var tevi uzaicināt',
  'circle.notifiers.body': 'Apklusini ikvienu, par kura galdiem nevēlies dzirdēt.',
  'circle.notifiers.empty': 'Neviens tevi vēl nav pievienojis.',
  'circle.mute': 'Apklusināt',
  'circle.unmute': 'Ieslēgt skaņu',
  'circle.muted': 'Apklusināts',
  'circle.suggestions.heading': 'Nesen spēlēts',
  'circle.suggestions.body': 'Cilvēki, ar kuriem esi sēdējis pie viena galda. Pievieno viņus, lai viņi uzzinātu par taviem galdiem.',
  'circle.lastPlayed': 'Pēdējo reizi spēlēts {date}',
  'circle.add': 'Pievienot',
  'circle.added': '{name} ir tavā lokā.',
  'circle.addSomeone.heading': 'Pievienot kādu',
  'circle.friendLink.body': 'Ikviens, kas atver tavu drauga saiti, pievienojas tavam lokam, un tu viņa.',
  'circle.shareMessage': 'Pievienojies manam spēļu lokam Jokerless',
  'circle.username.body': 'Vai lūdz pēc lietotājvārda. Otram jāpiekrīt.',
  'circle.username.placeholder': 'Lietotājvārds',
  'circle.username.submit': 'Sūtīt pieprasījumu',
  'circle.username.sent': 'Pieprasījums nosūtīts: {name}.',
  'circle.settingsLink': 'Paziņojumu iestatījumi',
  'circle.addFriend.title': 'Pievienot spēļu lokam',
  'circle.addFriend.loading': 'Pārbauda saiti…',
  'circle.addFriend.missing': 'Šajā saitē nav drauga koda.',
  'circle.addFriend.body': '{name} aicina tevi savā spēļu lokā. Abi uzzināsiet, kad otrs atver galdu.',
