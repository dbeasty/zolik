...
export const pt: Record<string, string> = {
  ...
  'canasta.rules.drawCount': 'Compras {n} cartas no início do teu turno.',
  ...
  'seat.ready': 'Pronto',
  'zolik.seat.contractMet': 'Contrato cumprido',
  'results.you': '(tu)',
  ...
  'err.SEQUENCE_NO_WILDS': 'Uma sequência não pode conter jokers',
  'err.SEQUENCE_NEEDS_ONE_SUIT': 'Todas as cartas de uma sequência têm de ser do mesmo naipe',
  'err.RUN_NOT_CONSECUTIVE': 'Uma sequência tem de seguir por ordem, sem falhas',
  ...
  'err.BAD_SEATING': 'Essa ordem de lugares não corresponde a quem está à mesa',
  ...
  'holdem.cost.pot': 'pote após igualar',
  ...
  'lobby.table.side': 'Lado {n}',
  'lobby.table.shuffleSeats': 'Baralhar os lugares',
  'lobby.table.moveSeatUp': 'Subir {name} um lugar',
  ...
  'match.you': 'tu',
  'match.yourTeam': 'A tua equipa',
  'match.teammates': 'Equipa: {names}',
  ...
  'about.subtitle': 'A versão com que está a jogar e as letras pequenas.',
  ...
  'option.openDiscardPile': 'Monte de descartes',
  'choice.openDiscardPile.1': 'Pode ser consultado',
  'choice.openDiscardPile.0': 'Apenas a carta do topo',
  ...
  'verb.takeTopForSequence': 'Levar a carta do topo para uma sequência',
  ...
  'holdem.seat.folded': 'Desistiu',
  'holdem.seat.allIn': 'All in',
  'holdem.seat.out': 'Fora',
  ...
  'replay.round': 'Ronda',
  'replay.track.all': 'Tudo',
  'replay.track.yours': 'As tuas jogadas',
  ...
  'err.ALREADY_SHOWN': 'A sua mão já está virada para cima',
  'err.NOTHING_TO_SHOW': 'Não tem nenhuma mão para mostrar',
  'holdem.offer.show': 'Mostrar a minha mão',
  'holdem.offer.finish': 'Terminar a partida',
  'holdem.remedy.nothingToShow': 'Não participou nesta mão — espere pela próxima.',
  'holdem.rules.section.showdown': 'Depois da mão',
  'holdem.rules.stopEveryHand': 'O jogo para depois de cada mão, para que as cartas sejam vistas.',
  'holdem.rules.revealEveryone': 'No showdown são viradas todas as mãos que pagaram.',
  'holdem.rules.revealWinners': 'No showdown é virada apenas a mão vencedora.',
  'holdem.rules.showYourOwn': 'Pode sempre virar a sua própria mão, até aceitar continuar.',
  'holdem.rules.showOnce': 'Uma mão só pode ser mostrada uma vez.',
  'holdem.seat.won': 'Ganhou',
  'holdem.seat.mucked': 'Não mostrou',
  'holdem.status.mucked': '{playerId} não mostrou',
  'holdem.status.shownVoluntary': '{playerId} mostrou a mão',
  'zone.shownHand': 'Mostrada',
  'option.showdownReveal': 'Mostrar no showdown',
  'choice.showdownReveal.2': 'Todos os que pagaram',
  'choice.showdownReveal.1': 'Apenas o vencedor',
  'home.playOffline': 'Jogar offline',
  'offline.title': 'Jogar offline',
  'offline.subtitle': 'Sem internet',
  'offline.body': 'Este telemóvel aloja a mesa sozinho, por isso pode jogar contra bots em qualquer lado — até em modo de voo.',
  'offline.nameLabel': 'O seu nome à mesa',
  'offline.start': 'Abrir uma mesa offline',
  'offline.starting': 'A iniciar…',
  'offline.active': 'Está na mesa offline deste telemóvel. Os jogos que iniciar aqui ficam neste telemóvel.',
  'offline.chooseGame': 'Escolher um jogo',
  'offline.backOnline': 'Voltar ao jogo online',
  'offline.failed': 'A mesa offline não arrancou: {reason}',
  'offline.nearbyTitle': 'Mesas por perto',
  'offline.nearbyLooking': 'A procurar mesas nesta rede…',
  'offline.nearbyNothing': 'Ainda não há mesas. Confirme que está na mesma Wi-Fi ou hotspot do anfitrião e que o Zolik pode usar a rede local.',
  'offline.joinThis': 'Entrar',
  'offline.byAddressTitle': 'Entrar por endereço',
  'offline.versionMismatch': 'Esta mesa usa outra versão do Zolik. Atualize a app nos dois telemóveis.',
  'offline.roomTitle': 'Jogadores por perto',
  'offline.roomBody': 'Deixe outros telemóveis nesta Wi-Fi ou hotspot entrar na sua mesa. Sem internet.',
  'offline.roomOpenButton': 'Convidar jogadores por perto',
  'offline.roomOpen': 'Os outros telemóveis nesta rede já podem encontrar a sua mesa. Se não a virem, podem escrever o endereço ou ler o código.',
  'offline.roomClose': 'Deixar de convidar',
  'offline.guestActive': 'Está numa mesa alojada por outro telemóvel ({host}).',
  'offline.joinFailed': 'Não foi possível entrar nessa mesa: {reason}',
  'invite.offlineExplain': 'Os jogadores desta mesa offline entram com este código, em «{menu}».',
  'invite.offlineCode': 'Código:',
  'offline.bleTitle': 'Por Bluetooth',
  'offline.bleLook': 'Procurar mesas por Bluetooth',
  'offline.bleLooking': 'A procurar mesas por Bluetooth…',
  'offline.bleOff': 'Ligue o Bluetooth para encontrar mesas sem Wi-Fi.',
  'offline.bleDenied': 'Permita que o Zolik use o Bluetooth nas Definições para jogar sem Wi-Fi.',
  'offline.bleInvite': 'Convidar por Bluetooth',
  'offline.bleInviteBody': 'Para telemóveis que não partilham Wi-Fi com o seu. Sem emparelhamento.',
  'offline.bleOpen': 'Os telemóveis por perto podem entrar por Bluetooth. Ligados: {n}.',
  'offline.bleStop': 'Parar o Bluetooth',
  'offline.bleCheck': 'Código de verificação: {code}',
  'offline.guestBle': 'Está numa mesa alojada por outro telemóvel, por Bluetooth.',
  'offline.keyChanged': 'Este não é o telemóvel em que jogou antes com esse nome. Pergunte ao anfitrião ou entre por Wi-Fi.',
  // --- game notifications: invites, the game circle, push (src/notify) ---
  'err.NOT_PLAYED_TOGETHER': 'Só pode adicionar pessoas com quem já jogou. Envie-lhes a sua ligação de amigo ou peça pelo nome de utilizador.',
  'err.UNKNOWN_PLAYER': 'Ninguém joga com esse nome.',
  'err.UNKNOWN_FRIEND_CODE': 'Essa ligação de amigo já não funciona.',
  'err.CANNOT_ADD_SELF': 'Esse é você. Adicione outra pessoa.',
  'err.RATE_LIMITED': 'Demasiados pedidos de uma vez. Tente novamente dentro de alguns minutos.',
  'err.PUSH_UNAVAILABLE': 'As notificações não estão configuradas neste servidor.',
  'notify.someone': 'Alguém',
  'notify.join': 'Juntar-se',
  'notify.joining': 'A juntar-se…',
  'notify.goToTable': 'Ir para a mesa',
  'notify.notNow': 'Agora não',
  'notify.moreOptions': 'Mais opções',
  'notify.muteHost': 'Deixar de receber convites de {host}',
  'notify.joinFailed': 'Não foi possível juntar-se: {reason}',
  'notify.hostingOffline': 'Está a anfitriar uma mesa neste telemóvel. Saia dela primeiro para se juntar a outra.',
  'notify.on': 'Ligado',
  'notify.off': 'Desligado',
  'notify.channelName': 'Convites de jogo',
  'notify.banner.online': '{host} abriu uma mesa de {game}',
  'notify.banner.onlineNoGame': '{host} abriu uma mesa',
  'notify.banner.nearby': '{host} tem uma mesa aqui perto',
  'notify.banner.seated': 'Foi sentado numa mesa',
  'notify.banner.fromCircle': 'Do seu círculo de jogo',
  'notify.banner.known': 'Já jogaram juntos',
  'notify.banner.nearbyDetail': 'Num telemóvel perto de si',
  'notify.banner.seatedDetail': 'Um anfitrião escolheu-o na sala de espera',
  'notify.banner.more': '+{n} mais',
  'notify.pillOne': '1 mesa à espera',
  'notify.pillMany': '{n} mesas à espera',
  'notify.waitingCard.title': 'Mesas à sua espera',
  'notify.waitingCard.empty': 'Nenhuma mesa está à sua espera.',
  'notify.prompt.title': 'Saiba quando o seu círculo começa um jogo',
  'notify.prompt.body': 'Só mesas abertas por pessoas do seu círculo de jogo. Pode desligar nas Definições.',
  'notify.prompt.enable': 'Ativar',
  'notify.prompt.later': 'Mais tarde',
  'notify.settings.heading': 'Notificações',
  'notify.settings.invites': 'Convites de jogo',
  'notify.settings.invitesBody': 'Quem pode avisá-lo quando abre uma mesa.',
  'notify.settings.invitesCircle': 'O meu círculo',
  'notify.settings.invitesOff': 'Ninguém',
  'notify.settings.nearby': 'Mesas por perto',
  'notify.settings.nearbyBody': 'Mostrar um aviso quando um telemóvel perto de si abre uma mesa. Funciona com a app aberta.',
  'notify.settings.push': 'Notificações neste dispositivo',
  'notify.settings.pushOn': 'Ligadas. Fica a saber das mesas mesmo com a app fechada.',
  'notify.settings.pushOff': 'Desligadas. Os convites só aparecem com a app aberta.',
  'notify.settings.pushBlocked': 'Bloqueadas. Permita as notificações desta app nas definições do telemóvel.',
  'notify.settings.pushBlockedWeb': 'Bloqueadas. Permita as notificações deste site nas definições do navegador.',
  'notify.settings.pushInstall': 'No iPhone e iPad, adicione primeiro este site ao ecrã principal e ative lá as notificações.',
  'notify.settings.pushUnavailable': 'Este servidor não envia notificações.',
  'notify.settings.pushUnsupported': 'Este dispositivo ou navegador não consegue mostrar notificações.',
  'notify.settings.signIn': 'Inicie sessão ou jogue como convidado para receber convites de jogo.',
  'notify.announce.heading': 'Avisar o meu círculo',
  'notify.announce.body': 'As pessoas do seu círculo de jogo ficam a saber desta mesa e podem juntar-se com um toque.',
  'notify.announce.toggle': 'Avisar o meu círculo quando abro uma mesa',
  'notify.announce.sending': 'A avisar o seu círculo…',
  'notify.announce.toldOne': '1 jogador avisado',
  'notify.announce.toldMany': '{n} jogadores avisados',
  'notify.announce.already': 'O seu círculo já sabe desta mesa.',
  'notify.announce.nobody': 'Ainda não há ninguém a avisar. Adicione pessoas ao seu círculo.',
  'notify.announce.circleLink': 'Círculo de jogo',
  'notify.addToCircle': 'Adicionar {name} ao seu círculo',
  ...
  'offline.tellNearbyBody': 'Os telemóveis na sala com a app aberta recebem a oferta desta mesa.',
  'circle.title': 'Círculo de jogo',
  'circle.subtitle': 'As pessoas que avisa quando abre uma mesa e as que o avisam a si.',
  'circle.signInRequired': 'Inicie sessão ou jogue como convidado para criar um círculo de jogo.',
  'circle.requests.heading': 'Pedidos',
  'circle.requests.body': 'Gostariam de o avisar quando abrem uma mesa.',
  'circle.accept': 'Aceitar',
  'circle.decline': 'Recusar',
  'circle.members.heading': 'O seu círculo',
  'circle.members.body': 'Ficam a saber das mesas que abre para os amigos.',
  'circle.members.empty': 'Ninguém ainda. Adicione pessoas abaixo.',
  'circle.pending': 'À espera de aceitação',
  'circle.since': 'Desde {date}',
  'circle.remove': 'Remover',
  'circle.notifiers.heading': 'Quem o pode convidar',
  'circle.notifiers.body': 'Silencie quem não quiser ouvir quando abre uma mesa.',
  'circle.notifiers.empty': 'Ainda ninguém o adicionou.',
  'circle.mute': 'Silenciar',
  'circle.unmute': 'Reativar som',
  'circle.muted': 'Silenciado',
  'circle.suggestions.heading': 'Jogou recentemente',
  'circle.suggestions.body': 'Pessoas com quem partilhou uma mesa. Adicione-as para as avisar das suas mesas.',
  'circle.lastPlayed': 'Último jogo {date}',
  'circle.add': 'Adicionar',
  'circle.added': '{name} está no seu círculo.',
  'circle.addSomeone.heading': 'Adicionar alguém',
  'circle.friendLink.body': 'Quem abrir a sua ligação de amigo entra no seu círculo, e você no dele.',
  'circle.shareMessage': 'Junta-te ao meu círculo de jogo no Jokerless',
  'circle.username.body': 'Ou peça pelo nome de utilizador. A outra pessoa tem de aceitar.',
  'circle.username.placeholder': 'Nome de utilizador',
  'circle.username.submit': 'Enviar pedido',
  'circle.username.sent': 'Pedido enviado a {name}.',
  'circle.settingsLink': 'Definições de notificações',
  'circle.addFriend.title': 'Adicionar ao círculo de jogo',
  'circle.addFriend.loading': 'A verificar a ligação…',
  'circle.addFriend.missing': 'Esta ligação não tem código de amigo.',
  'circle.addFriend.body': '{name} convida-o para o seu círculo de jogo. Cada um fica a saber quando o outro abre uma mesa.',
