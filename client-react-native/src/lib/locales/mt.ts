...
export const mt: Record<string, string> = {
  ...
  'option.openDiscardPile': 'Munzell tal-iskart',
  'choice.openDiscardPile.1': 'Miftuħ għall-ispezzjoni',
  'choice.openDiscardPile.0': 'L-ogħla karta biss',
  ...
  'replay.round': 'Rawnd',
  'replay.track.all': 'Kollox',
  'replay.track.yours': 'Il-mosses tiegħek',
  'replay.track.rounds': 'Rawnds',
  'replay.track.marks': 'Marki',
  'replay.play': 'Ibda',
  'replay.pause': 'Pawża',
  ...
  'home.playOffline': 'Ilgħab offline',
  'offline.title': 'Ilgħab offline',
  'offline.subtitle': 'M’hemmx bżonn internet',
  'offline.body': 'Dan it-telefon jospita l-mejda hu stess, allura tista’ tilgħab kontra l-bots kullimkien — anke fil-modalità tal-ajruplan.',
  'offline.nameLabel': 'Ismek fuq il-mejda',
  'offline.start': 'Iftaħ mejda offline',
  'offline.starting': 'Qed jibda…',
  'offline.active': 'Qiegħed fuq il-mejda offline ta’ dan it-telefon. Il-logħob li tibda hawn jibqa’ fuq dan it-telefon.',
  'offline.chooseGame': 'Agħżel logħba',
  'offline.backOnline': 'Lura għal-logħob online',
  'offline.failed': 'Il-mejda offline ma bdietx: {reason}',
  'offline.nearbyTitle': 'Imwejjed fil-qrib',
  'offline.nearbyLooking': 'Qed infittex imwejjed fuq dan in-netwerk…',
  'offline.nearbyNothing': 'Għadu ma nstabet l-ebda mejda. Kun żgur li int fuq l-istess Wi-Fi jew hotspot bħall-ospitant, u li Zolik jista’ juża n-netwerk lokali.',
  'offline.joinThis': 'Ingħaqad',
  'offline.byAddressTitle': 'Ingħaqad bl-indirizz',
  'offline.versionMismatch': 'Din il-mejda tuża verżjoni oħra ta’ Zolik. Aġġorna l-app fuq iż-żewġ telefowns.',
  'offline.roomTitle': 'Plejers fil-qrib',
  'offline.roomBody': 'Ħalli telefowns oħra fuq dan il-Wi-Fi jew hotspot jingħaqdu mal-mejda tiegħek. M’hemmx bżonn internet.',
  'offline.roomOpenButton': 'Stieden plejers fil-qrib',
  'offline.roomOpen': 'Telefowns oħra fuq dan in-netwerk issa jistgħu jsibu l-mejda tiegħek. Jekk ma jarawhiex, jistgħu jiktbu l-indirizz jew jiskennjaw il-kodiċi.',
  'offline.roomClose': 'Ieqaf stieden',
  'offline.guestActive': 'Int fuq mejda ospitata minn telefown ieħor ({host}).',
  'offline.joinFailed': 'Ma setax tingħaqad ma’ dik il-mejda: {reason}',
  'invite.offlineExplain': 'Il-plejers f’din il-mejda offline jingħaqdu b’dan il-kodiċi, taħt “{menu}’ mejda”.',
  'invite.offlineCode': 'Kodiċi:',
  'offline.bleTitle': 'Permezz ta’ Bluetooth',
  'offline.bleLook': 'Fittex imwejjed permezz ta’ Bluetooth',
  'offline.bleLooking': 'Qed infittex imwejjed permezz ta’ Bluetooth…',
  'offline.bleOff': 'Ixgħel il-Bluetooth biex issib imwejjed mingħajr Wi-Fi.',
  'offline.bleDenied': 'Ħalli lil Zolik juża l-Bluetooth fis-Settings biex tilgħab mingħajr Wi-Fi.',
  'offline.bleInvite': 'Stieden permezz ta’ Bluetooth',
  'offline.bleInviteBody': 'Għal telefowns li ma jaqsmux Wi-Fi mat-tiegħek. M’hemmx bżonn pairing.',
  'offline.bleOpen': 'Telefowns fil-qrib jistgħu jingħaqdu permezz ta’ Bluetooth. Konnessi: {n}.',
  'offline.bleStop': 'Waqqaf il-Bluetooth',
  'offline.bleCheck': 'Kodiċi ta’ verifika: {code}',
  'offline.guestBle': 'Int permezz ta’ Bluetooth fuq mejda ospitata minn telefown ieħor.',
  'offline.keyChanged': 'Dan mhuwiex it-telefown li lgħabt fih qabel b’dak l-isem. Staqsi lill-ospitant, jew ingħaqad permezz tal-Wi-Fi.',
  // --- game notifications: invites, the game circle, push (src/notify) ---
  'err.NOT_PLAYED_TOGETHER': 'Tista’ żżid biss nies li lgħabt magħhom. Ibgħatilhom il-link tal-ħbieb tiegħek jew staqsi bl-isem tal-utent.',
  'err.UNKNOWN_PLAYER': 'Ħadd ma jilgħab b’dak l-isem.',
  'err.UNKNOWN_FRIEND_CODE': 'Dak il-link tal-ħbieb m’għadux jaħdem.',
  'err.CANNOT_ADD_SELF': 'Dak int. Żid lil xi ħadd ieħor.',
  'err.RATE_LIMITED': 'Wisq f’daqqa. Erġa’ pprova fi ftit minuti.',
  'err.PUSH_UNAVAILABLE': 'In-notifiki mhumiex imwaqqfa fuq dan is-server.',
  'notify.someone': 'Xi ħadd',
  'notify.join': 'Ingħaqad',
  'notify.joining': 'Qed tingħaqad…',
  'notify.goToTable': 'Mur għall-mejda',
  'notify.notNow': 'Mhux issa',
  'notify.moreOptions': 'Aktar għażliet',
  'notify.muteHost': 'L-ebda stedina minn {host}',
  'notify.joinFailed': 'Ma setgħetx tingħaqad: {reason}',
  'notify.hostingOffline': 'Qed tospita mejda fuq dan it-telefon. Ħalliha l-ewwel biex tingħaqad ma’ oħra.',
  'notify.on': 'Mixgħul',
  'notify.off': 'Mitfi',
  'notify.channelName': 'Stediniet għal-logħob',
  'notify.banner.online': '{host} fetaħ mejda ta’ {game}',
  'notify.banner.onlineNoGame': '{host} fetaħ mejda',
  'notify.banner.nearby': '{host} qed jospita mejda fil-qrib',
  'notify.banner.seated': 'Tpoġġejt fuq mejda',
  'notify.banner.fromCircle': 'Miċ-ċirku tal-logħob tiegħek',
  'notify.banner.known': 'Diġà lgħabtu flimkien',
  'notify.banner.nearbyDetail': 'Fuq telefon qribek',
  'notify.banner.seatedDetail': 'Ospitanti għażlek mis-sala tal-istennija',
  'notify.banner.more': '+{n} oħra',
  'notify.pillOne': 'Mejda 1 qed tistenna',
  'notify.pillMany': 'Imwejjed jistennew: {n}',
  'notify.waitingCard.title': 'Imwejjed li qed jistennewk',
  'notify.waitingCard.empty': 'L-ebda mejda ma qed tistennik.',
  'notify.prompt.title': 'Kun af meta ċ-ċirku tiegħek jibda logħba',
  'notify.prompt.body': 'Biss imwejjed li jiftħu nies fiċ-ċirku tal-logħob tiegħek. Tista’ titfih mis-Settings.',
  'notify.prompt.enable': 'Ixgħel',
  'notify.prompt.later': 'Aktar tard',
  'notify.settings.heading': 'Notifiki',
  'notify.settings.invites': 'Stediniet għal-logħob',
  'notify.settings.invitesBody': 'Min jista’ jgħarrfek meta jiftaħ mejda.',
  'notify.settings.invitesCircle': 'Iċ-ċirku tiegħi',
  'notify.settings.invitesOff': 'Ħadd',
  'notify.settings.nearby': 'Imwejjed fil-qrib',
  'notify.settings.nearbyBody': 'Uri banner meta telefon qribek jiftaħ mejda. Jaħdem waqt li l-app tkun miftuħa.',
  'notify.settings.push': 'Notifiki fuq dan l-apparat',
  'notify.settings.pushOn': 'Mixgħula. Issir taf bl-imwejjed anke meta l-app tkun magħluqa.',
  'notify.settings.pushOff': 'Mitfija. L-istediniet jidhru biss meta l-app tkun miftuħa.',
  'notify.settings.pushBlocked': 'Imblukkati. Ippermetti n-notifiki għal din l-app fis-settings tat-telefon.',
  'notify.settings.pushBlockedWeb': 'Imblukkati. Ippermetti n-notifiki għal dan is-sit fis-settings tal-browser.',
  'notify.settings.pushInstall': 'Fuq iPhone u iPad, l-ewwel żid dan is-sit mal-home screen, imbagħad ixgħel in-notifiki minn hemm.',
  'notify.settings.pushUnavailable': 'Dan is-server ma jibgħatx notifiki.',
  'notify.settings.pushUnsupported': 'Dan l-apparat jew browser ma jistax juri notifiki.',
  'notify.settings.signIn': 'Idħol jew ilgħab bħala mistieden biex tirċievi stediniet għal-logħob.',
  'notify.announce.heading': 'Għarraf liċ-ċirku tiegħi',
  'notify.announce.body': 'In-nies fiċ-ċirku tal-logħob tiegħek isiru jafu b’din il-mejda u jistgħu jingħaqdu b’mess wieħed.',
  'notify.announce.toggle': 'Għarraf liċ-ċirku tiegħi meta niftaħ mejda',
  'notify.announce.sending': 'Qed ngħarrfu ċ-ċirku tiegħek…',
  'notify.announce.toldOne': 'Ġie infurmat plejer 1',
  'notify.announce.toldMany': 'Plejers infurmati: {n}',
  'notify.announce.already': 'Iċ-ċirku tiegħek diġà jaf b’din il-mejda.',
  'notify.announce.nobody': 'Għad m’hemm ħadd x’tgħarraf. Żid nies maċ-ċirku tiegħek.',
  'notify.announce.circleLink': 'Ċirku tal-logħob',
  'notify.addToCircle': 'Żid lil {name} maċ-ċirku tiegħek',
  ...
  'offline.tellNearbyBody': 'It-telefowns fil-kamra bl-app miftuħa jiġu offruti din il-mejda.',
  'circle.title': 'Ċirku tal-logħob',
  'circle.subtitle': 'In-nies li tgħarraf meta tiftaħ mejda, u n-nies li jgħarrfuk.',
  'circle.signInRequired': 'Idħol jew ilgħab bħala mistieden biex tibni ċirku tal-logħob.',
  'circle.requests.heading': 'Talbiet',
  'circle.requests.body': 'Jixtiequ jgħarrfuk meta jiftħu mejda.',
  'circle.accept': 'Aċċetta',
  'circle.decline': 'Irrifjuta',
  'circle.members.heading': 'Iċ-ċirku tiegħek',
  'circle.members.body': 'Isiru jafu bl-imwejjed li tiftaħ għall-ħbieb.',
  'circle.members.empty': 'Għadu ħadd. Żid nies hawn taħt.',
  'circle.pending': 'Qed jistenna l-aċċettazzjoni',
  'circle.since': 'Minn {date}',
  'circle.remove': 'Neħħi',
  'circle.notifiers.heading': 'Min jista’ jistiednek',
  'circle.notifiers.body': 'Isikket lil kull min ma tridx tisma’ dwar l-imwejjed tiegħu.',
  'circle.notifiers.empty': 'Għad ħadd ma żiedek.',
  'circle.mute': 'Sikket',
  'circle.unmute': 'Neħħi s-silenzju',
  'circle.muted': 'Imsikket',
  'circle.suggestions.heading': 'Lgħabt dan l-aħħar',
  'circle.suggestions.body': 'Nies li qsamt mejda magħhom. Żidhom biex tgħarrafhom bl-imwejjed tiegħek.',
  'circle.lastPlayed': 'L-aħħar logħba {date}',
  'circle.add': 'Żid',
  'circle.added': '{name} jinsab fiċ-ċirku tiegħek.',
  'circle.addSomeone.heading': 'Żid lil xi ħadd',
  'circle.friendLink.body': 'Kull min jiftaħ il-link tal-ħbieb tiegħek jidħol fiċ-ċirku tiegħek, u int f’tiegħu.',
  'circle.shareMessage': 'Ingħaqad maċ-ċirku tal-logħob tiegħi fuq Jokerless',
  'circle.username.body': 'Jew staqsi bl-isem tal-utent. Il-persuna l-oħra trid taċċetta.',
  'circle.username.placeholder': 'Isem tal-utent',
  'circle.username.submit': 'Ibgħat talba',
  'circle.username.sent': 'Talba mibgħuta lil {name}.',
  'circle.settingsLink': 'Settings tan-notifiki',
  'circle.addFriend.title': 'Żid maċ-ċirku tal-logħob',
  'circle.addFriend.loading': 'Qed niċċekkjaw il-link…',
  'circle.addFriend.missing': 'Dan il-link m’għandux kodiċi tal-ħbieb.',
  'circle.addFriend.body': '{name} jistiednek fiċ-ċirku tal-logħob tiegħu. It-tnejn issiru tafu meta l-ieħor jiftaħ mejda.',
