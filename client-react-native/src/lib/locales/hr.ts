...
export const hr: Record<string, string> = {
  ...
  'holdem.status.pot': '{winners} osvaja {amount} s {hand} — {cards}',
  'holdem.status.potSplit': '{winners} osvaja {amount} s {hand}',
  ...
  'canasta.round.closed': '{player} je zatvorio/la s razlikom od {diff} bodova',
  ...
  'about.subtitle': 'Verzija koju igrate i sitni tisak.',
  ...
  'option.openDiscardPile': 'Hrpa odbačenih',
  'choice.openDiscardPile.1': 'Može se pregledavati',
  'choice.openDiscardPile.0': 'Samo gornja karta',
  ...
  'replay.round': 'Runda',
  'replay.track.all': 'Sve',
  'replay.track.yours': 'Tvoji potezi',
  'replay.track.rounds': 'Runde',
  ...
  'err.ALREADY_SHOWN': 'Tvoja ruka već je otvorena',
  'err.NOTHING_TO_SHOW': 'Nemaš ruku za pokazati',
  'holdem.offer.show': 'Pokaži ruku',
  'holdem.offer.finish': 'Završi meč',
  'holdem.remedy.nothingToShow': 'Nisi igrao ovu ruku — pričekaj sljedeću.',
  'holdem.rules.section.showdown': 'Nakon ruke',
  'holdem.rules.stopEveryHand': 'Igra se zaustavlja nakon svake ruke, da se karte vide.',
  'holdem.rules.revealEveryone': 'Na otvaranju se otkrivaju sve ruke koje su platile.',
  'holdem.rules.revealWinners': 'Na otvaranju se otkriva samo pobjednička ruka.',
  'holdem.rules.showYourOwn': 'Svoju ruku možeš otvoriti uvijek, dok ne pristaneš na nastavak.',
  'holdem.rules.showOnce': 'Ruka se može pokazati samo jednom.',
  'holdem.seat.won': 'Pobijedio',
  'holdem.seat.mucked': 'Nije pokazao',
  'holdem.status.mucked': '{playerId} nije pokazao karte',
  'holdem.status.shownVoluntary': '{playerId} je pokazao svoju ruku',
  'zone.shownHand': 'Otvorena',
  'option.showdownReveal': 'Otkrivanje na otvaranju',
  'choice.showdownReveal.2': 'Svi koji su platili',
  'choice.showdownReveal.1': 'Samo pobjednik',
  'home.playOffline': 'Igraj izvan mreže',
  'offline.title': 'Igraj izvan mreže',
  'offline.subtitle': 'Bez interneta',
  'offline.body': 'Ovaj telefon sam vodi stol, pa možete igrati protiv botova bilo gdje — čak i u načinu rada u zrakoplovu.',
  'offline.nameLabel': 'Vaše ime za stolom',
  'offline.start': 'Otvori stol izvan mreže',
  'offline.starting': 'Pokretanje…',
  'offline.active': 'Za stolom ste izvan mreže ovog telefona. Igre koje ovdje započnete ostaju na ovom telefonu.',
  'offline.chooseGame': 'Odaberite igru',
  'offline.backOnline': 'Natrag na igru na mreži',
  'offline.failed': 'Stol izvan mreže nije pokrenut: {reason}',
  'offline.nearbyTitle': 'Stolovi u blizini',
  'offline.nearbyLooking': 'Traženje stolova na ovoj mreži…',
  'offline.nearbyNothing': 'Još nema stolova. Provjerite jeste li na istom Wi-Fiju ili hotspotu kao domaćin i smije li Zolik koristiti lokalnu mrežu.',
  'offline.joinThis': 'Pridruži se',
  'offline.byAddressTitle': 'Pridruži se putem adrese',
  'offline.versionMismatch': 'Ovaj stol koristi drugu verziju Zolika. Ažurirajte aplikaciju na oba telefona.',
  'offline.roomTitle': 'Igrači u blizini',
  'offline.roomBody': 'Dopustite drugim telefonima na ovom Wi-Fiju ili hotspotu da sjednu za vaš stol. Internet nije potreban.',
  'offline.roomOpenButton': 'Pozovi igrače u blizini',
  'offline.roomOpen': 'Drugi telefoni na ovoj mreži sada mogu pronaći vaš stol. Ako ga ne vide, mogu upisati adresu ili skenirati kôd.',
  'offline.roomClose': 'Prestani pozivati',
  'offline.guestActive': 'Sjedite za stolom koji vodi drugi telefon ({host}).',
  'offline.joinFailed': 'Pridruživanje tom stolu nije uspjelo: {reason}',
  'invite.offlineExplain': 'Igrači za ovim stolom izvan mreže pridružuju se ovim kôdom, pod „{menu}”.',
  'invite.offlineCode': 'Kôd:',
  'offline.bleTitle': 'Putem Bluetootha',
  'offline.bleLook': 'Traži stolove putem Bluetootha',
  'offline.bleLooking': 'Tražim stolove putem Bluetootha…',
  'offline.bleOff': 'Uključite Bluetooth da biste pronašli stolove bez Wi-Fija.',
  'offline.bleDenied': 'Dopustite Zoliku korištenje Bluetootha u Postavkama da biste igrali bez Wi-Fija.',
  'offline.bleInvite': 'Pozovi putem Bluetootha',
  'offline.bleInviteBody': 'Za telefone koji s vašim ne dijele Wi-Fi. Uparivanje nije potrebno.',
  'offline.bleOpen': 'Telefoni u blizini mogu se pridružiti putem Bluetootha. Povezano: {n}.',
  'offline.bleStop': 'Zaustavi Bluetooth',
  'offline.bleCheck': 'Kontrolni kôd: {code}',
  'offline.guestBle': 'Putem Bluetootha sjedite za stolom koji vodi drugi telefon.',
  'offline.keyChanged': 'Ovo nije telefon za kojim ste prije igrali pod tim imenom. Pitajte domaćina ili se pridružite putem Wi-Fija.',
  // --- game notifications: invites, the game circle, push (src/notify) ---
  'err.NOT_PLAYED_TOGETHER': 'Možete dodati samo ljude s kojima ste igrali. Pošaljite im svoju poveznicu za prijatelje ili zamolite putem korisničkog imena.',
  'err.UNKNOWN_PLAYER': 'Nitko ne igra pod tim imenom.',
  'err.UNKNOWN_FRIEND_CODE': 'Ta poveznica za prijatelje više ne radi.',
  'err.CANNOT_ADD_SELF': 'To ste vi. Dodajte nekoga drugog.',
  'err.RATE_LIMITED': 'Previše odjednom. Pokušajte ponovno za nekoliko minuta.',
  'err.PUSH_UNAVAILABLE': 'Obavijesti nisu postavljene na ovom poslužitelju.',
  'notify.someone': 'Netko',
  'notify.join': 'Pridruži se',
  'notify.joining': 'Pridruživanje…',
  'notify.goToTable': 'Za stol',
  'notify.notNow': 'Ne sada',
  'notify.moreOptions': 'Više mogućnosti',
  'notify.muteHost': 'Bez pozivnica od igrača {host}',
  'notify.joinFailed': 'Pridruživanje nije uspjelo: {reason}',
  'notify.hostingOffline': 'Na ovom telefonu vodite stol. Najprije ga napustite da biste se pridružili drugome.',
  'notify.on': 'Uključeno',
  'notify.off': 'Isključeno',
  'notify.channelName': 'Pozivnice za igru',
  'notify.banner.online': '{host} je otvorio stol: {game}',
  'notify.banner.onlineNoGame': '{host} je otvorio stol',
  'notify.banner.nearby': '{host} vodi stol u blizini',
  'notify.banner.seated': 'Posjeli su vas za stol',
  'notify.banner.fromCircle': 'Iz vašeg kruga igrača',
  'notify.banner.known': 'Već ste igrali zajedno',
  'notify.banner.nearbyDetail': 'Na telefonu u vašoj blizini',
  'notify.banner.seatedDetail': 'Domaćin vas je odabrao iz čekaonice',
  'notify.banner.more': '+{n} više',
  'notify.pillOne': 'Čeka 1 stol',
  'notify.pillMany': 'Stolovi na čekanju: {n}',
  'notify.waitingCard.title': 'Stolovi koji vas čekaju',
  'notify.waitingCard.empty': 'Nijedan stol vas ne čeka.',
  'notify.prompt.title': 'Saznajte kada vaš krug započne igru',
  'notify.prompt.body': 'Samo stolovi koje otvore ljudi iz vašeg kruga igrača. Možete to isključiti u Postavkama.',
  'notify.prompt.enable': 'Uključi',
  'notify.prompt.later': 'Kasnije',
  'notify.settings.heading': 'Obavijesti',
  'notify.settings.invites': 'Pozivnice za igru',
  'notify.settings.invitesBody': 'Tko vam smije javiti da je otvorio stol.',
  'notify.settings.invitesCircle': 'Moj krug',
  'notify.settings.invitesOff': 'Nitko',
  'notify.settings.nearby': 'Stolovi u blizini',
  'notify.settings.nearbyBody': 'Prikaži obavijest kada telefon u blizini otvori stol. Radi dok je aplikacija otvorena.',
  'notify.settings.push': 'Obavijesti na ovom uređaju',
  'notify.settings.pushOn': 'Uključeno. Za stolove ćete saznati i kad je aplikacija zatvorena.',
  'notify.settings.pushOff': 'Isključeno. Pozivnice se pojavljuju samo u otvorenoj aplikaciji.',
  'notify.settings.pushBlocked': 'Blokirano. Dopustite obavijesti za ovu aplikaciju u postavkama telefona.',
  'notify.settings.pushBlockedWeb': 'Blokirano. Dopustite obavijesti za ovu stranicu u postavkama preglednika.',
  'notify.settings.pushInstall': 'Na iPhoneu i iPadu najprije dodajte ovu stranicu na početni zaslon, a zatim ondje uključite obavijesti.',
  'notify.settings.pushUnavailable': 'Ovaj poslužitelj ne šalje obavijesti.',
  'notify.settings.pushUnsupported': 'Ovaj uređaj ili preglednik ne može prikazivati obavijesti.',
  'notify.settings.signIn': 'Prijavite se ili igrajte kao gost da biste primali pozivnice za igru.',
  'notify.announce.heading': 'Javi mom krugu',
  'notify.announce.body': 'Ljudi iz vašeg kruga igrača saznat će za ovaj stol i moći će se pridružiti jednim dodirom.',
  'notify.announce.toggle': 'Javi mom krugu kad otvorim stol',
  'notify.announce.sending': 'Javljamo vašem krugu…',
  'notify.announce.toldOne': 'Javljeno 1 igraču',
  'notify.announce.toldMany': 'Javljeno igračima: {n}',
  'notify.announce.already': 'Vaš krug već zna za ovaj stol.',
  'notify.announce.nobody': 'Još nemate kome javiti. Dodajte ljude u svoj krug.',
  'notify.announce.circleLink': 'Krug igrača',
  'notify.addToCircle': 'Dodaj igrača {name} u krug',
  ...
  'offline.tellNearbyBody': 'Telefonima u prostoriji s otvorenom aplikacijom nudi se ovaj stol.',
  'circle.title': 'Krug igrača',
  'circle.subtitle': 'Ljudi kojima javljate kad otvorite stol i ljudi koji javljaju vama.',
  'circle.signInRequired': 'Prijavite se ili igrajte kao gost da biste izgradili krug igrača.',
  'circle.requests.heading': 'Zahtjevi',
  'circle.requests.body': 'Željeli bi vam javiti kad otvore stol.',
  'circle.accept': 'Prihvati',
  'circle.decline': 'Odbij',
  'circle.members.heading': 'Vaš krug',
  'circle.members.body': 'Saznaju za stolove koje otvorite za prijatelje.',
  'circle.members.empty': 'Još nitko. Dodajte ljude ispod.',
  'circle.pending': 'Čeka prihvaćanje',
  'circle.since': 'Od {date}',
  'circle.remove': 'Ukloni',
  'circle.notifiers.heading': 'Tko vas može pozvati',
  'circle.notifiers.body': 'Utišajte svakoga za čije stolove ne želite čuti.',
  'circle.notifiers.empty': 'Još vas nitko nije dodao.',
  'circle.mute': 'Utišaj',
  'circle.unmute': 'Uključi zvuk',
  'circle.muted': 'Utišano',
  'circle.suggestions.heading': 'Nedavno igrano',
  'circle.suggestions.body': 'Ljudi s kojima ste sjedili za stolom. Dodajte ih da saznaju za vaše stolove.',
  'circle.lastPlayed': 'Zadnja igra {date}',
  'circle.add': 'Dodaj',
  'circle.added': '{name} je u vašem krugu.',
  'circle.addSomeone.heading': 'Dodaj nekoga',
  'circle.friendLink.body': 'Tko otvori vašu poveznicu za prijatelje, ulazi u vaš krug, a vi u njegov.',
  'circle.shareMessage': 'Pridruži se mom krugu igrača na Jokerlessu',
  'circle.username.body': 'Ili zamolite putem korisničkog imena. Druga osoba mora prihvatiti.',
  'circle.username.placeholder': 'Korisničko ime',
  'circle.username.submit': 'Pošalji zahtjev',
  'circle.username.sent': 'Zahtjev poslan igraču {name}.',
  'circle.settingsLink': 'Postavke obavijesti',
  'circle.addFriend.title': 'Dodaj u krug igrača',
  'circle.addFriend.loading': 'Provjera poveznice…',
  'circle.addFriend.missing': 'Ova poveznica nema kod prijatelja.',
  'circle.addFriend.body': '{name} vas poziva u svoj krug igrača. Oboje ćete saznati kad drugi otvori stol.',
