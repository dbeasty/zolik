...
export const pl: Record<string, string> = {
  ...
  'err.DISPLACED': 'Otwarto w innej karcie — ta przestała się synchronizować',
  ...
  'err.REPLAY_UNAVAILABLE': 'Odtwarzanie partii nie jest dostępne na tym serwerze',
  ...
  'holdem.status.pot': '{winners} wygrywa {amount} układem {hand} — {cards}',
  'holdem.status.potSplit': '{winners} wygrywa {amount} układem {hand}',
  ...
  'canasta.round.closed': '{player} zamknął(-ęła) z różnicą {diff} pkt',
  ...
  'holdem.cost.pot': 'pula po sprawdzeniu',
  ...
  'match.you': 'ty',
  'match.yourTeam': 'Twoja drużyna',
  'match.teammates': 'Drużyna: {names}',
  ...
  'option.openDiscardPile': 'Stos odrzuconych',
  'choice.openDiscardPile.1': 'Można przeglądać',
  'choice.openDiscardPile.0': 'Tylko wierzchnia karta',
  ...
  'replay.round': 'Runda',
  'replay.track.all': 'Wszystko',
  'replay.track.yours': 'Twoje ruchy',
  'replay.track.rounds': 'Rundy',
  'replay.track.marks': 'Znaczniki',
  'replay.play': 'Odtwórz',
  'replay.pause': 'Pauza',
  ...
  'err.ALREADY_SHOWN': 'Twoje karty już leżą odkryte',
  'err.NOTHING_TO_SHOW': 'Nie masz kart do pokazania',
  'holdem.offer.show': 'Pokaż karty',
  'holdem.offer.finish': 'Zakończ mecz',
  'holdem.remedy.nothingToShow': 'Nie grałeś tego rozdania — poczekaj na następne.',
  'holdem.rules.section.showdown': 'Po rozdaniu',
  'holdem.rules.stopEveryHand': 'Gra zatrzymuje się po każdym rozdaniu, żeby było widać karty.',
  'holdem.rules.revealEveryone': 'Przy showdownie odkrywane są wszystkie sprawdzone układy.',
  'holdem.rules.revealWinners': 'Przy showdownie odkrywany jest tylko zwycięski układ.',
  'holdem.rules.showYourOwn': 'Swoje karty możesz odkryć zawsze, dopóki nie zgodzisz się grać dalej.',
  'holdem.rules.showOnce': 'Karty można pokazać tylko raz.',
  'holdem.seat.won': 'Wygrał',
  'holdem.seat.mucked': 'Nie pokazał',
  'holdem.status.mucked': '{playerId} nie pokazał kart',
  'holdem.status.shownVoluntary': '{playerId} pokazał swoje karty',
  'zone.shownHand': 'Odkryte',
  'option.showdownReveal': 'Pokazywanie przy showdownie',
  'choice.showdownReveal.2': 'Wszyscy, którzy sprawdzili',
  'choice.showdownReveal.1': 'Tylko zwycięzca',
  'home.playOffline': 'Graj offline',
  'offline.title': 'Graj offline',
  'offline.subtitle': 'Bez internetu',
  'offline.body': 'Ten telefon sam prowadzi stół, więc możesz grać z botami wszędzie — nawet w trybie samolotowym.',
  'offline.nameLabel': 'Twoje imię przy stole',
  'offline.start': 'Załóż stół offline',
  'offline.starting': 'Uruchamianie…',
  'offline.active': 'Siedzisz przy stole offline tego telefonu. Gry rozpoczęte tutaj zostają na tym telefonie.',
  'offline.chooseGame': 'Wybierz grę',
  'offline.backOnline': 'Wróć do gry online',
  'offline.failed': 'Stół offline się nie uruchomił: {reason}',
  'offline.nearbyTitle': 'Stoły w pobliżu',
  'offline.nearbyLooking': 'Szukam stołów w tej sieci…',
  'offline.nearbyNothing': 'Nie znaleziono jeszcze stołów. Sprawdź, czy jesteś w tej samej sieci Wi-Fi lub hotspocie co gospodarz i czy Zolik może używać sieci lokalnej.',
  'offline.joinThis': 'Dołącz',
  'offline.byAddressTitle': 'Dołącz po adresie',
  'offline.versionMismatch': 'Ten stół działa na innej wersji Zolika. Zaktualizuj aplikację na obu telefonach.',
  'offline.roomTitle': 'Gracze w pobliżu',
  'offline.roomBody': 'Pozwól innym telefonom w tej sieci Wi-Fi lub hotspocie dołączyć do stołu. Internet nie jest potrzebny.',
  'offline.roomOpenButton': 'Zaproś graczy w pobliżu',
  'offline.roomOpen': 'Inne telefony w tej sieci mogą teraz znaleźć twój stół. Jeśli go nie widzą, mogą wpisać adres lub zeskanować kod.',
  'offline.roomClose': 'Przestań zapraszać',
  'offline.guestActive': 'Siedzisz przy stole prowadzonym przez inny telefon ({host}).',
  'offline.joinFailed': 'Nie udało się dołączyć do tego stołu: {reason}',
  'invite.offlineExplain': 'Gracze przy tym stole offline dołączają tym kodem, w „{menu}”.',
  'invite.offlineCode': 'Kod:',
  'offline.bleTitle': 'Przez Bluetooth',
  'offline.bleLook': 'Szukaj stołów przez Bluetooth',
  'offline.bleLooking': 'Szukam stołów przez Bluetooth…',
  'offline.bleOff': 'Włącz Bluetooth, aby znaleźć stoły bez Wi-Fi.',
  'offline.bleDenied': 'Pozwól Zolikowi używać Bluetooth w Ustawieniach, aby grać bez Wi-Fi.',
  'offline.bleInvite': 'Zaproś przez Bluetooth',
  'offline.bleInviteBody': 'Dla telefonów, które nie dzielą z twoim sieci Wi-Fi. Parowanie nie jest potrzebne.',
  'offline.bleOpen': 'Telefony w pobliżu mogą dołączyć przez Bluetooth. Połączone: {n}.',
  'offline.bleStop': 'Wyłącz Bluetooth',
  'offline.bleCheck': 'Kod kontrolny: {code}',
  'offline.guestBle': 'Siedzisz przy stole prowadzonym przez inny telefon, przez Bluetooth.',
  'offline.keyChanged': 'To nie jest telefon, przy którym grałeś wcześniej pod tą nazwą. Zapytaj gospodarza lub dołącz przez Wi-Fi.',
  // --- game notifications: invites, the game circle, push (src/notify) ---
  'err.NOT_PLAYED_TOGETHER': 'Możesz dodać tylko osoby, z którymi grałeś. Wyślij im link dla znajomych albo poproś przez nazwę użytkownika.',
  'err.UNKNOWN_PLAYER': 'Nikt nie gra pod tą nazwą.',
  'err.UNKNOWN_FRIEND_CODE': 'Ten link dla znajomych już nie działa.',
  'err.CANNOT_ADD_SELF': 'To ty. Dodaj kogoś innego.',
  'err.RATE_LIMITED': 'Za dużo naraz. Spróbuj ponownie za kilka minut.',
  'err.PUSH_UNAVAILABLE': 'Ten serwer nie ma skonfigurowanych powiadomień.',
  'notify.someone': 'Ktoś',
  'notify.join': 'Dołącz',
  'notify.joining': 'Dołączanie…',
  'notify.goToTable': 'Do stołu',
  'notify.notNow': 'Nie teraz',
  'notify.moreOptions': 'Więcej opcji',
  'notify.muteHost': 'Nie przyjmuj zaproszeń od: {host}',
  'notify.joinFailed': 'Nie udało się dołączyć: {reason}',
  'notify.hostingOffline': 'Prowadzisz stół na tym telefonie. Najpierw go opuść, aby dołączyć do innego.',
  'notify.on': 'Wł.',
  'notify.off': 'Wył.',
  'notify.channelName': 'Zaproszenia do gry',
  'notify.banner.online': '{host} otwiera stół: {game}',
  'notify.banner.onlineNoGame': '{host} otwiera stół',
  'notify.banner.nearby': '{host} prowadzi stół w pobliżu',
  'notify.banner.seated': 'Posadzono cię przy stole',
  'notify.banner.fromCircle': 'Z twojego kręgu graczy',
  'notify.banner.known': 'Już razem graliście',
  'notify.banner.nearbyDetail': 'Na telefonie w pobliżu',
  'notify.banner.seatedDetail': 'Gospodarz wybrał cię z poczekalni',
  'notify.banner.more': '+{n} więcej',
  'notify.pillOne': 'Czeka 1 stół',
  'notify.pillMany': 'Czekające stoły: {n}',
  'notify.waitingCard.title': 'Stoły, które na ciebie czekają',
  'notify.waitingCard.empty': 'Żaden stół na ciebie nie czeka.',
  'notify.prompt.title': 'Dowiedz się, gdy twój krąg zaczyna grę',
  'notify.prompt.body': 'Tylko stoły otwarte przez osoby z twojego kręgu graczy. Możesz to wyłączyć w Ustawieniach.',
  'notify.prompt.enable': 'Włącz',
  'notify.prompt.later': 'Później',
  'notify.settings.heading': 'Powiadomienia',
  'notify.settings.invites': 'Zaproszenia do gry',
  'notify.settings.invitesBody': 'Kto może cię powiadomić, że otworzył stół.',
  'notify.settings.invitesCircle': 'Mój krąg',
  'notify.settings.invitesOff': 'Nikt',
  'notify.settings.nearby': 'Stoły w pobliżu',
  'notify.settings.nearbyBody': 'Pokaż baner, gdy telefon w pobliżu otworzy stół. Działa, gdy aplikacja jest otwarta.',
  'notify.settings.push': 'Powiadomienia na tym urządzeniu',
  'notify.settings.pushOn': 'Włączone. Dowiesz się o stołach nawet przy zamkniętej aplikacji.',
  'notify.settings.pushOff': 'Wyłączone. Zaproszenia pojawiają się tylko w otwartej aplikacji.',
  'notify.settings.pushBlocked': 'Zablokowane. Zezwól na powiadomienia dla tej aplikacji w ustawieniach telefonu.',
  'notify.settings.pushBlockedWeb': 'Zablokowane. Zezwól na powiadomienia dla tej strony w ustawieniach przeglądarki.',
  'notify.settings.pushInstall': 'Na iPhonie i iPadzie najpierw dodaj tę stronę do ekranu początkowego i tam włącz powiadomienia.',
  'notify.settings.pushUnavailable': 'Ten serwer nie wysyła powiadomień.',
  'notify.settings.pushUnsupported': 'To urządzenie lub przeglądarka nie obsługuje powiadomień.',
  'notify.settings.signIn': 'Zaloguj się lub graj jako gość, aby otrzymywać zaproszenia do gry.',
  'notify.announce.heading': 'Powiadom mój krąg',
  'notify.announce.body': 'Osoby z twojego kręgu graczy dowiedzą się o tym stole i dołączą jednym dotknięciem.',
  'notify.announce.toggle': 'Powiadamiaj mój krąg, gdy otwieram stół',
  'notify.announce.sending': 'Powiadamianie kręgu…',
  'notify.announce.toldOne': 'Powiadomiono 1 gracza',
  'notify.announce.toldMany': 'Powiadomieni gracze: {n}',
  'notify.announce.already': 'Twój krąg już wie o tym stole.',
  'notify.announce.nobody': 'Na razie nie ma kogo powiadomić. Dodaj osoby do swojego kręgu.',
  'notify.announce.circleLink': 'Krąg graczy',
  'notify.addToCircle': 'Dodaj {name} do kręgu',
  ...
  'offline.tellNearbyBody': 'Telefony w pomieszczeniu z otwartą aplikacją zobaczą ten stół.',
  'circle.title': 'Krąg graczy',
  'circle.subtitle': 'Osoby, które powiadamiasz, gdy otwierasz stół, i osoby, które powiadamiają ciebie.',
  'circle.signInRequired': 'Zaloguj się lub graj jako gość, aby zbudować krąg graczy.',
  'circle.requests.heading': 'Prośby',
  'circle.requests.body': 'Chcą cię powiadamiać, gdy otwierają stół.',
  'circle.accept': 'Akceptuj',
  'circle.decline': 'Odrzuć',
  'circle.members.heading': 'Twój krąg',
  'circle.members.body': 'Dowiadują się o stołach, które otwierasz dla znajomych.',
  'circle.members.empty': 'Na razie nikt. Dodaj osoby poniżej.',
  'circle.pending': 'Czeka na akceptację',
  'circle.since': 'Od {date}',
  'circle.remove': 'Usuń',
  'circle.notifiers.heading': 'Kto może cię zaprosić',
  'circle.notifiers.body': 'Wycisz każdego, o którego stołach nie chcesz słyszeć.',
  'circle.notifiers.empty': 'Nikt cię jeszcze nie dodał.',
  'circle.mute': 'Wycisz',
  'circle.unmute': 'Wyłącz wyciszenie',
  'circle.muted': 'Wyciszony',
  'circle.suggestions.heading': 'Ostatnio grane',
  'circle.suggestions.body': 'Osoby, z którymi siedziałeś przy stole. Dodaj je, aby wiedziały o twoich stołach.',
  'circle.lastPlayed': 'Ostatnia gra {date}',
  'circle.add': 'Dodaj',
  'circle.added': '{name} jest w twoim kręgu.',
  'circle.addSomeone.heading': 'Dodaj kogoś',
  'circle.friendLink.body': 'Kto otworzy twój link dla znajomych, dołączy do twojego kręgu, a ty do jego.',
  'circle.shareMessage': 'Dołącz do mojego kręgu graczy w Jokerless',
  'circle.username.body': 'Albo poproś przez nazwę użytkownika. Druga osoba musi się zgodzić.',
  'circle.username.placeholder': 'Nazwa użytkownika',
  'circle.username.submit': 'Wyślij prośbę',
  'circle.username.sent': 'Wysłano prośbę do: {name}.',
  'circle.settingsLink': 'Ustawienia powiadomień',
  'circle.addFriend.title': 'Dodaj do kręgu graczy',
  'circle.addFriend.loading': 'Sprawdzanie linku…',
  'circle.addFriend.missing': 'W tym linku brakuje kodu znajomego.',
  'circle.addFriend.body': '{name} zaprasza cię do swojego kręgu graczy. Oboje dowiecie się, gdy drugie otworzy stół.',
