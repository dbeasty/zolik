...
export const sl: Record<string, string> = {
  ...
  'err.WRONG_PHASE': 'Ne na tej točki poteze',
  ...
  'err.REPLAY_UNAVAILABLE': 'Ponovno predvajanje partij na tem strežniku ni na voljo',
  ...
  'prsi.remedy.matchOrDraw': 'Odigraj karto barve {suit} ali takšno, ki se poda na {card} — sicer vleci.',
  'prsi.remedy.answerSevenOrTake': 'Odgovori s svojo sedmico ali vzemi {n} kart.',
  'prsi.remedy.playOrDraw': 'Nobenega preskoka te ne čaka — odigraj karto barve {suit} ali vleci.',
  'prsi.remedy.nameASuit': 'Povej, katera barva sledi tvoji dami.',
  'prsi.remedy.nothingLeftToDraw': 'Vleči ni več ničesar — odigraj karto, če lahko.',
  ...
  'canasta.rules.section.turn': 'Tvoja poteza',
  'canasta.rules.goal': 'Igra se v parih; prva stran, ki doseže {n} točk, dobi tekmo.',
  'canasta.rules.deck': 'Igra se s {value} kartami — {decks} kompleta in jokerji.',
  'canasta.rules.deal': 'Vsak igralec dobi {n} kart.',
  'canasta.rules.drawCount': 'Na začetku poteze vlečeš {n} karti.',
  ...
  'canasta.rules.pileTopCard':
    'Odlagalni kup lahko prevzameš le s potezo, ki takoj uporabi njegovo vrhnjo karto.',
  ...
  'canasta.rules.wildRatio':
    'Kombinacija potrebuje {n} naravni karti za vsako divjo in skupaj nikoli več kot {wilds} divji.',
  'canasta.rules.oneMeldPerRank':
    'Tvoja stran ima od vsake vrednosti eno kombinacijo — nadaljnje karte te vrednosti se dodajajo nanjo.',
  'canasta.rules.meldsPerRankUnlimited': 'Tvoja stran ima lahko več kombinacij iste vrednosti.',
  'canasta.rules.canastaCloses': 'Kanasta iz {n} kart je dokončana in ne sprejme več kart.',
  'canasta.rules.meldsAreShared':
    'Kombinacije pripadajo paru: razširi jih lahko kateri koli od partnerjev, nasprotnikovih pa se nihče ne dotakne.',
  'canasta.rules.layOffAfterOpening':
    'Dokler tvoja stran ne položi svoje prve kombinacije, ne sme ničesar na mizi dopolnjevati.',
  'canasta.rules.goOutKeepsACard':
    'Vedno moraš biti sposoben dokončati svojo potezo, zato nikoli ne položi cele roke, razen če je to prav poteza, s katero izideš.',
  ...
  'holdem.rules.checkOrCall':
    'Čekiraš lahko le, kadar ničesar ne dolguješ; sicer plačaj, zvišaj ali odstopi.',
  'holdem.rules.minRaise': 'Zvišanje mora biti vsaj tolikšno kot prejšnje.',
  'holdem.rules.allIn':
    'Nikoli ne moreš vložiti več, kot imaš žetonov, all-in pa je vedno dovoljen — tudi če je manjši od polnega zvišanja.',
  'holdem.rules.foldedOut': 'Ko enkrat odstopiš, si zunaj do naslednje delitve.',
  'holdem.remedy.callOrFold': 'Dolguješ {n} — plačaj, zvišaj ali odstopi.',
  'holdem.remedy.checkOrRaise': 'Nič ne dolguješ — čekiraj ali zvišaj.',
  'holdem.remedy.callAllInOrFold': 'Tvoji žetoni ne bodo presegli stave — plačaj {n} z all-in ali odstopi.',
  'holdem.remedy.raiseAtLeast': 'Zvišaj vsaj na {n}.',
  'holdem.remedy.raiseAtMost': 'Zvišaj največ na {n} — to so vsi tvoji žetoni.',
  'holdem.remedy.nameAnAmount': 'Povej, na koliko zvišaš — med {min} in {max}.',
  'holdem.remedy.waitForNextHand': 'Iz te deljene roke si zunaj — počakaj na naslednjo delitev.',
  ...
  'canasta.round.closed': '{player} je zaprl(a) z razliko {diff} točk',
  ...
  'zolik.seat.contractMet': 'Pogodba izpolnjena',
  'results.you': '(ti)',
  ...
  'err.NOTHING_TO_SKIP': 'Ni poteze za preskok',
  ...
  'err.SEQUENCE_NO_WILDS': 'Zaporedje ne sme vsebovati jokerjev',
  'err.SEQUENCE_NEEDS_ONE_SUIT': 'Vse karte v zaporedju morajo biti iste barve',
  'err.RUN_NOT_CONSECUTIVE': 'Zaporedje mora teči po vrsti, brez vrzeli',
  ...
  'err.BLACK_THREE_GO_OUT_ONLY': 'Črne trojke se položijo le kot poteza, ki izprazni tvojo roko',
  ...
  'err.CANNOT_RAISE': 'Ne moreš zvišati — tvoji žetoni ne presežejo stave',
  ...
  'canasta.offer.sequence': 'Zaporedje',
  'canasta.remedy.drawOrTakePile':
    'Najprej vleci iz kupa ali prevzemi odlagalni kup, šele nato polagaj kombinacije.',
  'canasta.remedy.meldOrDiscard':
    'Karto si že vlekel — položi kombinacijo ali odvrzi karto in končaj potezo.',
  'canasta.remedy.drawFromStock': 'Namesto tega vleci iz kupa.',
  'canasta.remedy.takePileInstead': 'Kup je prazen — namesto tega prevzemi odlagalni kup.',
  'canasta.remedy.pileBlocked': 'Vleci iz kupa — črna trojka na vrhu drži odlagalni kup zaprt.',
  'canasta.remedy.pileFrozen':
    'Vleci iz kupa ali prevzemi kup z dvema naravnima kartama iz roke, ki se podata na {card}.',
  'canasta.remedy.topCardUnusable': 'Vleci iz kupa — tvoja stran z vrhnjo karto {card} ne more ničesar.',
  ...
  'ginrummy.rules.upcardDance':
    'Pred prvim vlečenjem lahko obrnjeno karto vzame tisti, ki ni delil, nato delivec; če oba odklonita, mora nedelivec vleči iz kupa.',
  'ginrummy.rules.knockOnDiscard':
    'Trkanje nadomesti tvoj odmet, zato se lahko zgodi le na koncu tvoje poteze.',
  ...
  'ginrummy.remedy.takeOrPassUpcard': 'Vzemi obrnjeno karto ali jo spusti.',
  'ginrummy.remedy.drawFirst': 'Najprej vleci karto — iz kupa ali z odlagalnega kupa.',
  'ginrummy.remedy.discardToEndTurn': 'Odvrzi eno karto in končaj potezo.',
  'ginrummy.remedy.finishLayoff': 'Nič več tvojega se ne poda — končaj dodajanje.',
  'ginrummy.remedy.stockDrawForced': 'To karto sta oba spustila — vleci iz kupa.',
  'ginrummy.remedy.drawElsewhere': 'Ta kup je prazen — vleci z drugega.',
  'ginrummy.remedy.getDeadwoodDown': 'Potrkaš lahko, ko tvoje mrtve karte padejo na {n} ali manj.',
  ...
  'err.TILE_DOES_NOT_FIT': 'Ta ploščica ne sodi v ta niz',
  ...
  'err.TABLE_NOT_VALID': 'Neki niz na mizi ni veljavna skupina ali zaporedje',
  ...
  'rummytiles.remedy.emptyTheTray': 'Postavi {n} ploščic, ki so še na pladnju, ali ponastavi potezo.',
  'rummytiles.remedy.playFromHandOrDraw':
    'Preurejanje ni poteza — odigraj vsaj eno ploščico iz roke ali vleci.',
  'rummytiles.remedy.fixOrReset':
    'Vsak niz na mizi mora biti veljavna skupina ali zaporedje — popravi jih ali ponastavi potezo.',
  'rummytiles.remedy.needMorePoints': 'Tvojemu prvemu polaganju manjka {n} točk do {floor}.',
  'rummytiles.remedy.ownNewSetsOnly':
    'Do svojega prvega polaganja {n} točk lahko preurejaš samo nize, ki si jih naredil v tej potezi.',
  'rummytiles.remedy.startANewSet': 'Namesto tega jo daj v nov niz.',
  'rummytiles.remedy.splitLeavesThree':
    'Zaporedje razdeli tako, da obema polovicama ostaneta vsaj {n} ploščici.',
  'rummytiles.remedy.matchTheJoker': 'Zamenjaj džokerja točno za ploščico, ki jo nadomešča.',
  ...
  'blackjack.rules.roundOrder':
    'Krog poteka po vrsti: stave, deljenje kart, zavarovanje če delivec kaže asa, nato vsako mesto po vrsti odigra svojo roko.',
  'blackjack.rules.oneStakePerRound': 'Ena stava na krog — ko je enkrat postavljena, se ne spreminja.',
  'blackjack.rules.stakeFromStack': 'Staviš lahko le žetone, ki jih res imaš.',
  'blackjack.remedy.putAStakeUp': 'Najprej postavi stavo — {n} ali več.',
  'blackjack.remedy.answerInsurance': 'Najprej reci da ali ne zavarovanju.',
  'blackjack.remedy.playThisHand': 'Odigraj roko pred sabo — vzemi karto ali ostani.',
  'blackjack.remedy.stakeIsUp': 'Tvoja stava je že postavljena — počakaj na delitev.',
  'blackjack.remedy.stakeAtLeast': 'Stavi vsaj {n}.',
  'blackjack.remedy.stakeAtMost': 'Stavi največ {n} — to so vsi tvoji žetoni.',
  'blackjack.remedy.sayHowMuch': 'Povej, koliko staviš — {n} ali več.',
  'blackjack.remedy.hitOrStand': 'Vzemi karto ali ostani.',
  'blackjack.remedy.waitForNextRound': 'Iz tega kroga si zunaj — počakaj na naslednjo delitev.',
  ...
  'blackjack.quick.doubleMin': '2× Najnižja stava',
  ...
  'gate.body':
    'Tabele točk in statistika se hranijo pri tvojem računu, zato te spremljajo na drugo napravo. Gost jih nima kam shraniti.',
  ...
  'intro.tagline': 'Klasične igre s kartami, igrane na spletu s pravimi ljudmi',
  'intro.bulletFriends': 'Igraj s prijatelji ali se pridruži drugim na spletu',
  'intro.bulletCrossDevice': 'En sam račun, telefon ali brskalnik — nadaljuj, kjer si končal',
  ...
  'lobby.join.needCode': 'Vnesi kodo, povezavo ali ID tekme',
  'lobby.games.signInFirst': 'Najprej se prijavi',
  ...
  'match.you': 'ti',
  'match.yourTeam': 'Tvoja ekipa',
  'match.teammates': 'Ekipa: {names}',
  ...
  'scoring.nameCountError': 'Vnesi 2–8 imen igralcev, ločenih z vejicami',
  ...
  'stats.unavailable': '(ni na voljo: {reason})',
  ...
  'option.openDiscardPile': 'Kup odvrženih',
  'choice.openDiscardPile.1': 'Lahko se pregleduje',
  'choice.openDiscardPile.0': 'Samo zgornja karta',
  ...
  'verb.takeTopForSequence': 'Vzemi vrhnjo karto v zaporedje',
  ...
  'holdem.seat.folded': 'Odstopil',
  'holdem.seat.allIn': 'All in',
  'holdem.seat.out': 'Izpadel',
  ...
  'replay.round': 'Krog',
  'replay.track.all': 'Vse',
  'replay.track.yours': 'Tvoje poteze',
  'replay.track.rounds': 'Krogi',
  'replay.track.marks': 'Oznake',
  ...
  'home.playOffline': 'Igraj brez povezave',
  'offline.title': 'Igraj brez povezave',
  'offline.subtitle': 'Brez interneta',
  'offline.body': 'Ta telefon sam gosti mizo, zato lahko proti botom igrate kjer koli — tudi v načinu za letalo.',
  'offline.nameLabel': 'Vaše ime za mizo',
  'offline.start': 'Odpri mizo brez povezave',
  'offline.starting': 'Zaganjanje…',
  'offline.active': 'Ste za mizo brez povezave tega telefona. Igre, ki jih začnete tukaj, ostanejo na tem telefonu.',
  'offline.chooseGame': 'Izberite igro',
  'offline.backOnline': 'Nazaj na igro prek spleta',
  'offline.failed': 'Miza brez povezave se ni zagnala: {reason}',
  'offline.nearbyTitle': 'Mize v bližini',
  'offline.nearbyLooking': 'Iščem mize v tem omrežju…',
  'offline.nearbyNothing': 'Mize še niso najdene. Preverite, ali ste v istem Wi-Fi omrežju ali dostopni točki kot gostitelj in ali sme Zolik uporabljati lokalno omrežje.',
  'offline.joinThis': 'Pridruži se',
  'offline.byAddressTitle': 'Pridruži se prek naslova',
  'offline.versionMismatch': 'Ta miza uporablja drugo različico Zolika. Posodobite aplikacijo na obeh telefonih.',
  'offline.roomTitle': 'Igralci v bližini',
  'offline.roomBody': 'Dovolite drugim telefonom v tem Wi-Fi omrežju ali dostopni točki, da se pridružijo vaši mizi. Internet ni potreben.',
  'offline.roomOpenButton': 'Povabi igralce v bližini',
  'offline.roomOpen': 'Drugi telefoni v tem omrežju zdaj lahko najdejo vašo mizo. Če je ne vidijo, lahko vnesejo naslov ali skenirajo kodo.',
  'offline.roomClose': 'Ustavi povabila',
  'offline.guestActive': 'Ste za mizo, ki jo gosti drug telefon ({host}).',
  'offline.joinFailed': 'Pridružitev tej mizi ni uspela: {reason}',
  'invite.offlineExplain': 'Igralci za to mizo brez povezave se pridružijo s to kodo, pod »{menu}«.',
  'invite.offlineCode': 'Koda:',
  'offline.bleTitle': 'Prek Bluetootha',
  'offline.bleLook': 'Išči mize prek Bluetootha',
  'offline.bleLooking': 'Iščem mize prek Bluetootha…',
  'offline.bleOff': 'Vklopite Bluetooth, da najdete mize brez Wi-Fi omrežja.',
  'offline.bleDenied': 'V Nastavitvah dovolite Zoliku uporabo Bluetootha, da boste igrali brez Wi-Fi omrežja.',
  'offline.bleInvite': 'Povabi prek Bluetootha',
  'offline.bleInviteBody': 'Za telefone, ki z vašim ne delijo Wi-Fi omrežja. Seznanjanje ni potrebno.',
  'offline.bleOpen': 'Telefoni v bližini se lahko pridružijo prek Bluetootha. Povezani: {n}.',
  'offline.bleStop': 'Ustavi Bluetooth',
  'offline.bleCheck': 'Kontrolna koda: {code}',
  'offline.guestBle': 'Prek Bluetootha ste za mizo, ki jo gosti drug telefon.',
  'offline.keyChanged': 'To ni telefon, pri katerem ste prej igrali pod tem imenom. Vprašajte gostitelja ali se pridružite prek Wi-Fi omrežja.',
  // --- game notifications: invites, the game circle, push (src/notify) ---
  'err.NOT_PLAYED_TOGETHER': 'Dodate lahko samo ljudi, s katerimi ste igrali. Pošljite jim svojo povezavo za prijatelje ali jih prosite prek uporabniškega imena.',
  'err.UNKNOWN_PLAYER': 'Pod tem imenom nihče ne igra.',
  'err.UNKNOWN_FRIEND_CODE': 'Ta povezava za prijatelje ne deluje več.',
  'err.CANNOT_ADD_SELF': 'To ste vi. Dodajte koga drugega.',
  'err.RATE_LIMITED': 'Preveč naenkrat. Poskusite znova čez nekaj minut.',
  'err.PUSH_UNAVAILABLE': 'Na tem strežniku obvestila niso nastavljena.',
  'notify.someone': 'Nekdo',
  'notify.join': 'Pridruži se',
  'notify.joining': 'Pridruževanje…',
  'notify.goToTable': 'K mizi',
  'notify.notNow': 'Ne zdaj',
  'notify.moreOptions': 'Več možnosti',
  'notify.muteHost': 'Brez povabil od igralca {host}',
  'notify.joinFailed': 'Pridružitev ni uspela: {reason}',
  'notify.hostingOffline': 'Na tem telefonu gostite mizo. Najprej jo zapustite, da se pridružite drugi.',
  'notify.on': 'Vklopljeno',
  'notify.off': 'Izklopljeno',
  'notify.channelName': 'Povabila k igri',
  'notify.banner.online': '{host} je odprl mizo: {game}',
  'notify.banner.onlineNoGame': '{host} je odprl mizo',
  'notify.banner.nearby': '{host} gosti mizo v bližini',
  'notify.banner.seated': 'Posedli so vas za mizo',
  'notify.banner.fromCircle': 'Iz vašega igralnega kroga',
  'notify.banner.known': 'Že ste igrali skupaj',
  'notify.banner.nearbyDetail': 'Na telefonu v vaši bližini',
  'notify.banner.seatedDetail': 'Gostitelj vas je izbral iz čakalnice',
  'notify.banner.more': '+{n} več',
  'notify.pillOne': 'Čaka 1 miza',
  'notify.pillMany': 'Mize na čakanju: {n}',
  'notify.waitingCard.title': 'Mize, ki vas čakajo',
  'notify.waitingCard.empty': 'Nobena miza vas ne čaka.',
  'notify.prompt.title': 'Izvedite, ko vaš krog začne igro',
  'notify.prompt.body': 'Samo mize, ki jih odprejo ljudje iz vašega igralnega kroga. To lahko izklopite v Nastavitvah.',
  'notify.prompt.enable': 'Vklopi',
  'notify.prompt.later': 'Pozneje',
  'notify.settings.heading': 'Obvestila',
  'notify.settings.invites': 'Povabila k igri',
  'notify.settings.invitesBody': 'Kdo vam sme sporočiti, da je odprl mizo.',
  'notify.settings.invitesCircle': 'Moj krog',
  'notify.settings.invitesOff': 'Nihče',
  'notify.settings.nearby': 'Mize v bližini',
  'notify.settings.nearbyBody': 'Pokaži pasico, ko telefon v bližini odpre mizo. Deluje, ko je aplikacija odprta.',
  'notify.settings.push': 'Obvestila na tej napravi',
  'notify.settings.pushOn': 'Vklopljeno. Za mize izveste, tudi ko je aplikacija zaprta.',
  'notify.settings.pushOff': 'Izklopljeno. Povabila se prikažejo le v odprti aplikaciji.',
  'notify.settings.pushBlocked': 'Blokirano. Dovolite obvestila za to aplikacijo v nastavitvah telefona.',
  'notify.settings.pushBlockedWeb': 'Blokirano. Dovolite obvestila za to spletno mesto v nastavitvah brskalnika.',
  'notify.settings.pushInstall': 'Na iPhonu in iPadu najprej dodajte to spletno mesto na začetni zaslon in tam vklopite obvestila.',
  'notify.settings.pushUnavailable': 'Ta strežnik ne pošilja obvestil.',
  'notify.settings.pushUnsupported': 'Ta naprava ali brskalnik ne more prikazovati obvestil.',
  'notify.settings.signIn': 'Prijavite se ali igrajte kot gost, da boste prejemali povabila k igri.',
  'notify.announce.heading': 'Obvesti moj krog',
  'notify.announce.body': 'Ljudje iz vašega igralnega kroga izvejo za to mizo in se lahko pridružijo z enim dotikom.',
  'notify.announce.toggle': 'Obvesti moj krog, ko odprem mizo',
  'notify.announce.sending': 'Obveščamo vaš krog…',
  'notify.announce.toldOne': 'Obveščen 1 igralec',
  'notify.announce.toldMany': 'Obveščeni igralci: {n}',
  'notify.announce.already': 'Vaš krog že ve za to mizo.',
  'notify.announce.nobody': 'Še ni koga obvestiti. Dodajte ljudi v svoj krog.',
  'notify.announce.circleLink': 'Igralni krog',
  'notify.addToCircle': 'Dodaj igralca {name} v krog',
  ...
  'offline.tellNearbyBody': 'Telefonom v prostoru z odprto aplikacijo se ponudi ta miza.',
  'circle.title': 'Igralni krog',
  'circle.subtitle': 'Ljudje, ki jih obvestite, ko odprete mizo, in ljudje, ki obveščajo vas.',
  'circle.signInRequired': 'Prijavite se ali igrajte kot gost, da ustvarite igralni krog.',
  'circle.requests.heading': 'Prošnje',
  'circle.requests.body': 'Radi bi vas obveščali, ko odprejo mizo.',
  'circle.accept': 'Sprejmi',
  'circle.decline': 'Zavrni',
  'circle.members.heading': 'Vaš krog',
  'circle.members.body': 'Izvejo za mize, ki jih odprete za prijatelje.',
  'circle.members.empty': 'Še nihče. Dodajte ljudi spodaj.',
  'circle.pending': 'Čaka na sprejem',
  'circle.since': 'Od {date}',
  'circle.remove': 'Odstrani',
  'circle.notifiers.heading': 'Kdo vas lahko povabi',
  'circle.notifiers.body': 'Utišajte vsakogar, o čigar mizah ne želite slišati.',
  'circle.notifiers.empty': 'Nihče vas še ni dodal.',
  'circle.mute': 'Utišaj',
  'circle.unmute': 'Vklopi zvok',
  'circle.muted': 'Utišano',
  'circle.suggestions.heading': 'Nedavno igrano',
  'circle.suggestions.body': 'Ljudje, s katerimi ste sedeli za mizo. Dodajte jih, da bodo izvedeli za vaše mize.',
  'circle.lastPlayed': 'Nazadnje igrano {date}',
  'circle.add': 'Dodaj',
  'circle.added': '{name} je v vašem krogu.',
  'circle.addSomeone.heading': 'Dodaj nekoga',
  'circle.friendLink.body': 'Kdor odpre vašo povezavo za prijatelje, se pridruži vašemu krogu, vi pa njegovemu.',
  'circle.shareMessage': 'Pridruži se mojemu igralnemu krogu na Jokerless',
  'circle.username.body': 'Ali prosite prek uporabniškega imena. Druga oseba mora sprejeti.',
  'circle.username.placeholder': 'Uporabniško ime',
  'circle.username.submit': 'Pošlji prošnjo',
  'circle.username.sent': 'Prošnja poslana igralcu {name}.',
  'circle.settingsLink': 'Nastavitve obvestil',
  'circle.addFriend.title': 'Dodaj v igralni krog',
  'circle.addFriend.loading': 'Preverjanje povezave…',
  'circle.addFriend.missing': 'Ta povezava nima kode prijatelja.',
  'circle.addFriend.body': '{name} vas vabi v svoj igralni krog. Oba boste izvedeli, ko drugi odpre mizo.',
