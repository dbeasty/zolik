...
export const ro: Record<string, string> = {
  ...
  'match.abandonedWaitingFor': 'Se așteaptă ca {names} să revină la masă.',
  ...
  'build.app': 'aplicație',
  'build.server': 'server',
  'about.subtitle': 'Versiunea cu care joci și scrisul mărunt.',
  ...
  'option.openDiscardPile': 'Teancul de aruncate',
  'choice.openDiscardPile.1': 'Poate fi răsfoit',
  'choice.openDiscardPile.0': 'Doar cartea de deasupra',
  ...
  'replay.round': 'Rundă',
  'replay.track.all': 'Tot',
  'replay.track.yours': 'Mutările tale',
  'replay.track.rounds': 'Runde',
  'replay.track.marks': 'Marcaje',
  'replay.play': 'Redă',
  'replay.pause': 'Pauză',
  ...
  'home.playOffline': 'Joacă offline',
  'offline.title': 'Joacă offline',
  'offline.subtitle': 'Fără internet',
  'offline.body': 'Acest telefon găzduiește singur masa, așa că poți juca împotriva boților oriunde — chiar și în modul avion.',
  'offline.nameLabel': 'Numele tău la masă',
  'offline.start': 'Deschide o masă offline',
  'offline.starting': 'Se pornește…',
  'offline.active': 'Ești la masa offline a acestui telefon. Jocurile începute aici rămân pe acest telefon.',
  'offline.chooseGame': 'Alege un joc',
  'offline.backOnline': 'Înapoi la jocul online',
  'offline.failed': 'Masa offline nu a pornit: {reason}',
  'offline.nearbyTitle': 'Mese în apropiere',
  'offline.nearbyLooking': 'Caut mese în această rețea…',
  'offline.nearbyNothing': 'Nicio masă găsită încă. Verifică dacă ești pe aceeași rețea Wi-Fi sau hotspot ca gazda și dacă Zolik poate folosi rețeaua locală.',
  'offline.joinThis': 'Intră',
  'offline.byAddressTitle': 'Intră după adresă',
  'offline.versionMismatch': 'Această masă rulează altă versiune Zolik. Actualizează aplicația pe ambele telefoane.',
  'offline.roomTitle': 'Jucători în apropiere',
  'offline.roomBody': 'Lasă alte telefoane din această rețea Wi-Fi sau hotspot să intre la masa ta. Fără internet.',
  'offline.roomOpenButton': 'Invită jucătorii din apropiere',
  'offline.roomOpen': 'Celelalte telefoane din rețea îți pot găsi acum masa. Dacă nu o văd, pot introduce adresa sau scana codul.',
  'offline.roomClose': 'Oprește invitațiile',
  'offline.guestActive': 'Ești la o masă găzduită de alt telefon ({host}).',
  'offline.joinFailed': 'Nu s-a putut intra la această masă: {reason}',
  'invite.offlineExplain': 'Jucătorii de la această masă offline intră cu acest cod, din „{menu}”.',
  'invite.offlineCode': 'Cod:',
  'offline.bleTitle': 'Prin Bluetooth',
  'offline.bleLook': 'Caută mese prin Bluetooth',
  'offline.bleLooking': 'Caut mese prin Bluetooth…',
  'offline.bleOff': 'Pornește Bluetooth pentru a găsi mese fără Wi-Fi.',
  'offline.bleDenied': 'Permite-i lui Zolik să folosească Bluetooth din Setări pentru a juca fără Wi-Fi.',
  'offline.bleInvite': 'Invită prin Bluetooth',
  'offline.bleInviteBody': 'Pentru telefoanele care nu împart Wi-Fi cu al tău. Nu e nevoie de asociere.',
  'offline.bleOpen': 'Telefoanele din apropiere pot intra prin Bluetooth. Conectate: {n}.',
  'offline.bleStop': 'Oprește Bluetooth',
  'offline.bleCheck': 'Cod de verificare: {code}',
  'offline.guestBle': 'Ești, prin Bluetooth, la o masă găzduită de alt telefon.',
  'offline.keyChanged': 'Acesta nu este telefonul la care ai jucat înainte sub acest nume. Întreabă gazda sau intră prin Wi-Fi.',
  // --- game notifications: invites, the game circle, push (src/notify) ---
  'err.NOT_PLAYED_TOGETHER': 'Poți adăuga doar persoane cu care ai jucat. Trimite-le linkul tău de prieten sau cere după numele de utilizator.',
  'err.UNKNOWN_PLAYER': 'Nimeni nu joacă sub acest nume.',
  'err.UNKNOWN_FRIEND_CODE': 'Acest link de prieten nu mai funcționează.',
  'err.CANNOT_ADD_SELF': 'Acesta ești tu. Adaugă pe altcineva.',
  'err.RATE_LIMITED': 'Prea multe deodată. Încearcă din nou peste câteva minute.',
  'err.PUSH_UNAVAILABLE': 'Notificările nu sunt configurate pe acest server.',
  'notify.someone': 'Cineva',
  'notify.join': 'Alătură-te',
  'notify.joining': 'Te alături…',
  'notify.goToTable': 'La masă',
  'notify.notNow': 'Nu acum',
  'notify.moreOptions': 'Mai multe opțiuni',
  'notify.muteHost': 'Fără invitații de la {host}',
  'notify.joinFailed': 'Nu te-ai putut alătura: {reason}',
  'notify.hostingOffline': 'Găzduiești o masă pe acest telefon. Părăsește-o mai întâi ca să te alături alteia.',
  'notify.on': 'Pornit',
  'notify.off': 'Oprit',
  'notify.channelName': 'Invitații la joc',
  'notify.banner.online': '{host} a deschis o masă de {game}',
  'notify.banner.onlineNoGame': '{host} a deschis o masă',
  'notify.banner.nearby': '{host} găzduiește o masă în apropiere',
  'notify.banner.seated': 'Ai fost așezat la o masă',
  'notify.banner.fromCircle': 'Din cercul tău de joc',
  'notify.banner.known': 'Ați mai jucat împreună',
  'notify.banner.nearbyDetail': 'Pe un telefon din apropiere',
  'notify.banner.seatedDetail': 'O gazdă te-a ales din sala de așteptare',
  'notify.banner.more': '+{n} în plus',
  'notify.pillOne': '1 masă în așteptare',
  'notify.pillMany': 'Mese în așteptare: {n}',
  'notify.waitingCard.title': 'Mese care te așteaptă',
  'notify.waitingCard.empty': 'Nicio masă nu te așteaptă.',
  'notify.prompt.title': 'Află când cercul tău începe un joc',
  'notify.prompt.body': 'Doar mese deschise de persoane din cercul tău de joc. Poți dezactiva din Setări.',
  'notify.prompt.enable': 'Activează',
  'notify.prompt.later': 'Mai târziu',
  'notify.settings.heading': 'Notificări',
  'notify.settings.invites': 'Invitații la joc',
  'notify.settings.invitesBody': 'Cine te poate anunța când deschide o masă.',
  'notify.settings.invitesCircle': 'Cercul meu',
  'notify.settings.invitesOff': 'Nimeni',
  'notify.settings.nearby': 'Mese în apropiere',
  'notify.settings.nearbyBody': 'Afișează un banner când un telefon din apropiere deschide o masă. Funcționează cât timp aplicația e deschisă.',
  'notify.settings.push': 'Notificări pe acest dispozitiv',
  'notify.settings.pushOn': 'Pornite. Afli de mese chiar și cu aplicația închisă.',
  'notify.settings.pushOff': 'Oprite. Invitațiile apar doar cu aplicația deschisă.',
  'notify.settings.pushBlocked': 'Blocate. Permite notificările pentru această aplicație în setările telefonului.',
  'notify.settings.pushBlockedWeb': 'Blocate. Permite notificările pentru acest site în setările browserului.',
  'notify.settings.pushInstall': 'Pe iPhone și iPad, adaugă mai întâi acest site pe ecranul principal, apoi activează notificările acolo.',
  'notify.settings.pushUnavailable': 'Acest server nu trimite notificări.',
  'notify.settings.pushUnsupported': 'Acest dispozitiv sau browser nu poate afișa notificări.',
  'notify.settings.signIn': 'Autentifică-te sau joacă ca invitat pentru a primi invitații la joc.',
  'notify.announce.heading': 'Anunță-mi cercul',
  'notify.announce.body': 'Persoanele din cercul tău de joc află de această masă și se pot alătura cu o atingere.',
  'notify.announce.toggle': 'Anunță-mi cercul când deschid o masă',
  'notify.announce.sending': 'Îți anunțăm cercul…',
  'notify.announce.toldOne': '1 jucător anunțat',
  'notify.announce.toldMany': 'Jucători anunțați: {n}',
  'notify.announce.already': 'Cercul tău știe deja de această masă.',
  'notify.announce.nobody': 'Încă nu ai pe cine anunța. Adaugă persoane în cercul tău.',
  'notify.announce.circleLink': 'Cerc de joc',
  'notify.addToCircle': 'Adaugă-l pe {name} în cercul tău',
  ...
  'offline.tellNearbyBody': 'Telefoanelor din cameră cu aplicația deschisă li se oferă această masă.',
  'circle.title': 'Cerc de joc',
  'circle.subtitle': 'Persoanele pe care le anunți când deschizi o masă și cele care te anunță pe tine.',
  'circle.signInRequired': 'Autentifică-te sau joacă ca invitat pentru a-ți crea un cerc de joc.',
  'circle.requests.heading': 'Cereri',
  'circle.requests.body': 'Ar vrea să te anunțe când deschid o masă.',
  'circle.accept': 'Acceptă',
  'circle.decline': 'Refuză',
  'circle.members.heading': 'Cercul tău',
  'circle.members.body': 'Află de mesele pe care le deschizi pentru prieteni.',
  'circle.members.empty': 'Nimeni deocamdată. Adaugă persoane mai jos.',
  'circle.pending': 'Așteaptă acceptarea',
  'circle.since': 'Din {date}',
  'circle.remove': 'Elimină',
  'circle.notifiers.heading': 'Cine te poate invita',
  'circle.notifiers.body': 'Pune pe mut pe oricine ale cărui mese nu vrei să le auzi.',
  'circle.notifiers.empty': 'Nimeni nu te-a adăugat încă.',
  'circle.mute': 'Mut',
  'circle.unmute': 'Anulează mut',
  'circle.muted': 'Pe mut',
  'circle.suggestions.heading': 'Jucat recent',
  'circle.suggestions.body': 'Persoane cu care ai stat la aceeași masă. Adaugă-le ca să afle de mesele tale.',
  'circle.lastPlayed': 'Ultimul joc {date}',
  'circle.add': 'Adaugă',
  'circle.added': '{name} este în cercul tău.',
  'circle.addSomeone.heading': 'Adaugă pe cineva',
  'circle.friendLink.body': 'Oricine deschide linkul tău de prieten intră în cercul tău, iar tu în al lui.',
  'circle.shareMessage': 'Intră în cercul meu de joc pe Jokerless',
  'circle.username.body': 'Sau cere după numele de utilizator. Celălalt trebuie să accepte.',
  'circle.username.placeholder': 'Nume de utilizator',
  'circle.username.submit': 'Trimite cererea',
  'circle.username.sent': 'Cerere trimisă către {name}.',
  'circle.settingsLink': 'Setări notificări',
  'circle.addFriend.title': 'Adaugă în cercul de joc',
  'circle.addFriend.loading': 'Se verifică linkul…',
  'circle.addFriend.missing': 'Acest link nu are cod de prieten.',
  'circle.addFriend.body': '{name} te invită în cercul său de joc. Veți afla fiecare când celălalt deschide o masă.',
