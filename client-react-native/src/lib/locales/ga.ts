...
export const ga: Record<string, string> = {
  ...
  'lobby.table.side': 'Taobh {n}',
  'lobby.table.shuffleSeats': 'Suaith na suíocháin',
  'lobby.table.moveSeatUp': 'Bog {name} suas suíochán',
  ...
  'option.openDiscardPile': 'Carn caite',
  'choice.openDiscardPile.1': 'Is féidir breathnú tríd',
  'choice.openDiscardPile.0': 'An cárta uachtair amháin',
  ...
  'replay.round': 'Babhta',
  'replay.track.all': 'Uile',
  'replay.track.yours': 'Do bhearta',
  'replay.track.rounds': 'Babhtaí',
  'replay.track.marks': 'Marcanna',
  'replay.play': 'Seinn',
  'replay.pause': 'Sos',
  ...
  'home.playOffline': 'Imir as líne',
  'offline.title': 'Imir as líne',
  'offline.subtitle': 'Níl gá le hidirlíon',
  'offline.body': 'Is é an fón seo féin a óstálann an bord, mar sin is féidir leat imirt in aghaidh bots áit ar bith — fiú i mód eitleáin.',
  'offline.nameLabel': 'D’ainm ag an mbord',
  'offline.start': 'Oscail bord as líne',
  'offline.starting': 'Á thosú…',
  'offline.active': 'Tá tú ag bord as líne an fhóin seo. Fanann na cluichí a thosaíonn tú anseo ar an bhfón seo.',
  'offline.chooseGame': 'Roghnaigh cluiche',
  'offline.backOnline': 'Ar ais chuig imirt ar líne',
  'offline.failed': 'Níor thosaigh an bord as líne: {reason}',
  'offline.nearbyTitle': 'Boird in aice láimhe',
  'offline.nearbyLooking': 'Ag lorg bord ar an líonra seo…',
  'offline.nearbyNothing': 'Níor aimsíodh bord fós. Deimhnigh go bhfuil tú ar an Wi-Fi nó hotspot céanna leis an óstach, agus go bhfuil cead ag Zolik an líonra áitiúil a úsáid.',
  'offline.joinThis': 'Glac páirt',
  'offline.byAddressTitle': 'Glac páirt de réir seolta',
  'offline.versionMismatch': 'Tá leagan eile de Zolik ar an mbord seo. Nuashonraigh an aip ar an dá fhón.',
  'offline.roomTitle': 'Imreoirí in aice láimhe',
  'offline.roomBody': 'Lig d’fhóin eile ar an Wi-Fi nó hotspot seo suí ag do bhord. Níl gá le hidirlíon.',
  'offline.roomOpenButton': 'Tabhair cuireadh d’imreoirí in aice láimhe',
  'offline.roomOpen': 'Is féidir le fóin eile ar an líonra seo do bhord a aimsiú anois. Mura bhfeiceann siad é, is féidir leo an seoladh a chlóscríobh nó an cód a scanadh.',
  'offline.roomClose': 'Stop ag tabhairt cuirí',
  'offline.guestActive': 'Tá tú ag bord atá á óstáil ag fón eile ({host}).',
  'offline.joinFailed': 'Níorbh fhéidir páirt a ghlacadh ag an mbord sin: {reason}',
  'invite.offlineExplain': 'Glacann imreoirí ag an mbord as líne seo páirt leis an gcód seo, faoi “{menu}”.',
  'invite.offlineCode': 'Cód:',
  'offline.bleTitle': 'Thar Bluetooth',
  'offline.bleLook': 'Lorg boird thar Bluetooth',
  'offline.bleLooking': 'Ag lorg bord thar Bluetooth…',
  'offline.bleOff': 'Cas air Bluetooth chun boird gan Wi-Fi a aimsiú.',
  'offline.bleDenied': 'Ceadaigh do Zolik Bluetooth a úsáid sna Socruithe chun imirt gan Wi-Fi.',
  'offline.bleInvite': 'Tabhair cuireadh thar Bluetooth',
  'offline.bleInviteBody': 'Le haghaidh fón nach roinneann Wi-Fi le do cheannsa. Níl gá le péireáil.',
  'offline.bleOpen': 'Is féidir le fóin in aice láimhe páirt a ghlacadh thar Bluetooth. Ceangailte: {n}.',
  'offline.bleStop': 'Stop Bluetooth',
  'offline.bleCheck': 'Cód seiceála: {code}',
  'offline.guestBle': 'Tá tú thar Bluetooth ag bord atá á óstáil ag fón eile.',
  'offline.keyChanged': 'Ní hé seo an fón ag ar imir tú roimhe faoin ainm sin. Fiafraigh den óstach, nó glac páirt thar Wi-Fi.',
  // --- game notifications: invites, the game circle, push (src/notify) ---
  'err.NOT_PLAYED_TOGETHER': 'Ní féidir leat ach daoine a d’imir tú leo a chur leis. Seol do nasc cairde chucu nó iarr trí ainm úsáideora.',
  'err.UNKNOWN_PLAYER': 'Níl aon duine ag imirt faoin ainm sin.',
  'err.UNKNOWN_FRIEND_CODE': 'Ní oibríonn an nasc cairde sin a thuilleadh.',
  'err.CANNOT_ADD_SELF': 'Tusa atá ann. Cuir duine eile leis.',
  'err.RATE_LIMITED': 'An iomarca ag an am céanna. Bain triail eile as i gceann cúpla nóiméad.',
  'err.PUSH_UNAVAILABLE': 'Níl fógraí socraithe ar an bhfreastalaí seo.',
  'notify.someone': 'Duine éigin',
  'notify.join': 'Glac páirt',
  'notify.joining': 'Ag glacadh páirte…',
  'notify.goToTable': 'Chuig an mbord',
  'notify.notNow': 'Ní anois',
  'notify.moreOptions': 'Tuilleadh roghanna',
  'notify.muteHost': 'Gan cuirí ó {host}',
  'notify.joinFailed': 'Níorbh fhéidir páirt a ghlacadh: {reason}',
  'notify.hostingOffline': 'Tá bord á óstáil agat ar an bhfón seo. Fág é ar dtús chun páirt a ghlacadh i gceann eile.',
  'notify.on': 'Ar siúl',
  'notify.off': 'Múchta',
  'notify.channelName': 'Cuirí chun cluiche',
  'notify.banner.online': 'D’oscail {host} bord: {game}',
  'notify.banner.onlineNoGame': 'D’oscail {host} bord',
  'notify.banner.nearby': 'Tá bord á óstáil ag {host} in aice leat',
  'notify.banner.seated': 'Cuireadh ina shuí thú ag bord',
  'notify.banner.fromCircle': 'Ó do chiorcal cluiche',
  'notify.banner.known': 'D’imir sibh le chéile cheana',
  'notify.banner.nearbyDetail': 'Ar fhón in aice leat',
  'notify.banner.seatedDetail': 'Roghnaigh óstach thú ón seomra feithimh',
  'notify.banner.more': '+{n} eile',
  'notify.pillOne': '1 bhord ag fanacht',
  'notify.pillMany': 'Boird ag fanacht: {n}',
  'notify.waitingCard.title': 'Boird atá ag fanacht leat',
  'notify.waitingCard.empty': 'Níl aon bhord ag fanacht leat.',
  'notify.prompt.title': 'Faigh scéala nuair a thosaíonn do chiorcal cluiche',
  'notify.prompt.body': 'Boird a osclaíonn daoine i do chiorcal cluiche amháin. Is féidir é a mhúchadh sna Socruithe.',
  'notify.prompt.enable': 'Cumasaigh',
  'notify.prompt.later': 'Ar ball',
  'notify.settings.heading': 'Fógraí',
  'notify.settings.invites': 'Cuirí chun cluiche',
  'notify.settings.invitesBody': 'Cé a fhéadfaidh insint duit nuair a osclaíonn siad bord.',
  'notify.settings.invitesCircle': 'Mo chiorcal',
  'notify.settings.invitesOff': 'Duine ar bith',
  'notify.settings.nearby': 'Boird in aice láimhe',
  'notify.settings.nearbyBody': 'Taispeáin meirge nuair a osclaíonn fón in aice leat bord. Oibríonn sé fad is atá an aip oscailte.',
  'notify.settings.push': 'Fógraí ar an ngléas seo',
  'notify.settings.pushOn': 'Ar siúl. Cloiseann tú faoi bhoird fiú nuair atá an aip dúnta.',
  'notify.settings.pushOff': 'Múchta. Ní thaispeántar cuirí ach nuair atá an aip oscailte.',
  'notify.settings.pushBlocked': 'Blocáilte. Ceadaigh fógraí don aip seo i socruithe an fhóin.',
  'notify.settings.pushBlockedWeb': 'Blocáilte. Ceadaigh fógraí don suíomh seo i socruithe an bhrabhsálaí.',
  'notify.settings.pushInstall': 'Ar iPhone agus iPad, cuir an suíomh seo leis an scáileán baile ar dtús, ansin cumasaigh fógraí ansin.',
  'notify.settings.pushUnavailable': 'Ní sheolann an freastalaí seo fógraí.',
  'notify.settings.pushUnsupported': 'Ní féidir leis an ngléas nó leis an mbrabhsálaí seo fógraí a thaispeáint.',
  'notify.settings.signIn': 'Sínigh isteach nó imir mar aoi chun cuirí chun cluiche a fháil.',
  'notify.announce.heading': 'Inis do mo chiorcal',
  'notify.announce.body': 'Cloiseann na daoine i do chiorcal cluiche faoin mbord seo agus is féidir leo páirt a ghlacadh le tadhall amháin.',
  'notify.announce.toggle': 'Inis do mo chiorcal nuair a osclaím bord',
  'notify.announce.sending': 'Ag insint do do chiorcal…',
  'notify.announce.toldOne': 'Insíodh do 1 imreoir',
  'notify.announce.toldMany': 'Imreoirí ar insíodh dóibh: {n}',
  'notify.announce.already': 'Tá a fhios ag do chiorcal faoin mbord seo cheana.',
  'notify.announce.nobody': 'Níl aon duine le hinsint dó fós. Cuir daoine le do chiorcal.',
  'notify.announce.circleLink': 'Ciorcal cluiche',
  'notify.addToCircle': 'Cuir {name} le do chiorcal',
  ...
  'offline.tellNearbyBody': 'Tairgtear an bord seo do na fóin sa seomra a bhfuil an aip oscailte orthu.',
  'circle.title': 'Ciorcal cluiche',
  'circle.subtitle': 'Na daoine a n-insíonn tú dóibh nuair a osclaíonn tú bord, agus na daoine a insíonn duitse.',
  'circle.signInRequired': 'Sínigh isteach nó imir mar aoi chun ciorcal cluiche a chruthú.',
  'circle.requests.heading': 'Iarratais',
  'circle.requests.body': 'Ba mhaith leo insint duit nuair a osclaíonn siad bord.',
  'circle.accept': 'Glac leis',
  'circle.decline': 'Diúltaigh',
  'circle.members.heading': 'Do chiorcal',
  'circle.members.body': 'Cloiseann siad faoi na boird a osclaíonn tú do chairde.',
  'circle.members.empty': 'Duine ar bith fós. Cuir daoine leis thíos.',
  'circle.pending': 'Ag fanacht go nglacfaidh siad leis',
  'circle.since': 'Ó {date}',
  'circle.remove': 'Bain',
  'circle.notifiers.heading': 'Cé atá in ann cuireadh a thabhairt duit',
  'circle.notifiers.body': 'Balbhaigh aon duine nach mian leat cloisteáil faoina mboird.',
  'circle.notifiers.empty': 'Níor chuir aon duine leis thú fós.',
  'circle.mute': 'Balbhaigh',
  'circle.unmute': 'Díbhalbhaigh',
  'circle.muted': 'Balbhaithe',
  'circle.suggestions.heading': 'Imrithe le déanaí',
  'circle.suggestions.body': 'Daoine a raibh tú ag an mbord céanna leo. Cuir leis iad chun insint dóibh faoi do bhoird.',
  'circle.lastPlayed': 'Imrithe go deireanach {date}',
  'circle.add': 'Cuir leis',
  'circle.added': 'Tá {name} i do chiorcal.',
  'circle.addSomeone.heading': 'Cuir duine leis',
  'circle.friendLink.body': 'Aon duine a osclaíonn do nasc cairde, téann siad isteach i do chiorcal, agus tusa ina gciorcal siúd.',
  'circle.shareMessage': 'Bí i mo chiorcal cluiche ar Jokerless',
  'circle.username.body': 'Nó iarr trí ainm úsáideora. Caithfidh an duine eile glacadh leis.',
  'circle.username.placeholder': 'Ainm úsáideora',
  'circle.username.submit': 'Seol iarratas',
  'circle.username.sent': 'Seoladh iarratas chuig {name}.',
  'circle.settingsLink': 'Socruithe fógraí',
  'circle.addFriend.title': 'Cuir leis an gciorcal cluiche',
  'circle.addFriend.loading': 'Ag seiceáil an naisc…',
  'circle.addFriend.missing': 'Níl cód cara sa nasc seo.',
  'circle.addFriend.body': 'Tugann {name} cuireadh duit chuig a c(h)iorcal cluiche. Cloisfidh gach duine agaibh nuair a osclaíonn an duine eile bord.',
