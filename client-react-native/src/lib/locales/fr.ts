...
export const fr: Record<string, string> = {
  ...
  'err.DISPLACED': 'Ouverte dans un autre onglet — celle-ci ne se synchronise plus',
  ...
  'holdem.status.pot': '{winners} gagne {amount} avec {hand} — {cards}',
  'holdem.status.potSplit': '{winners} gagne {amount} avec {hand}',
  ...
  'canasta.round.closed': '{player} a fermé avec un écart de {diff} points',
  ...
  'holdem.cost.pot': 'pot après avoir suivi',
  ...
  'option.openDiscardPile': 'Défausse',
  'choice.openDiscardPile.1': 'Consultable',
  'choice.openDiscardPile.0': 'Carte du dessus seulement',
  ...
  'replay.round': 'Manche',
  'replay.track.all': 'Tout',
  'replay.track.yours': 'Tes coups',
  'replay.track.rounds': 'Manches',
  'replay.track.marks': 'Repères',
  'replay.play': 'Lecture',
  'replay.pause': 'Pause',
  ...
  'err.ALREADY_SHOWN': 'Votre main est déjà face visible',
  'err.NOTHING_TO_SHOW': 'Vous n\'avez aucune main à montrer',
  'holdem.offer.show': 'Montrer ma main',
  'holdem.offer.finish': 'Terminer la partie',
  'holdem.remedy.nothingToShow': 'Vous n\'avez pas participé à cette main — attendez la suivante.',
  'holdem.rules.section.showdown': 'Après la main',
  'holdem.rules.stopEveryHand': 'Le jeu s\'arrête après chaque main, pour que les cartes soient vues.',
  'holdem.rules.revealEveryone': 'À l\'abattage, toutes les mains suivies sont retournées.',
  'holdem.rules.revealWinners': 'À l\'abattage, seule la main gagnante est retournée.',
  'holdem.rules.showYourOwn': 'Vous pouvez toujours retourner votre propre main, jusqu\'à ce que vous acceptiez de continuer.',
  'holdem.rules.showOnce': 'Une main ne peut être montrée qu\'une fois.',
  'holdem.seat.won': 'Gagné',
  'holdem.seat.mucked': 'Non montrée',
  'holdem.status.mucked': '{playerId} n\'a pas montré',
  'holdem.status.shownVoluntary': '{playerId} a montré sa main',
  'zone.shownHand': 'Montrée',
  'option.showdownReveal': 'Montrer à l\'abattage',
  'choice.showdownReveal.2': 'Tous ceux qui ont suivi',
  'choice.showdownReveal.1': 'Le gagnant seulement',
  'home.playOffline': 'Jouer hors ligne',
  'offline.title': 'Jouer hors ligne',
  'offline.subtitle': 'Sans internet',
  'offline.body': 'Ce téléphone héberge lui-même la table : jouez contre des bots partout, même en mode avion.',
  'offline.nameLabel': 'Votre nom à la table',
  'offline.start': 'Ouvrir une table hors ligne',
  'offline.starting': 'Démarrage…',
  'offline.active': 'Vous êtes à la table hors ligne de ce téléphone. Les parties lancées ici restent sur ce téléphone.',
  'offline.chooseGame': 'Choisir un jeu',
  'offline.backOnline': 'Revenir au jeu en ligne',
  'offline.failed': 'La table hors ligne n\'a pas démarré : {reason}',
  'offline.nearbyTitle': 'Tables à proximité',
  'offline.nearbyLooking': 'Recherche de tables sur ce réseau…',
  'offline.nearbyNothing': 'Aucune table pour l\'instant. Vérifiez que vous êtes sur le même Wi-Fi ou point d\'accès que l\'hôte, et que Zolik peut utiliser le réseau local.',
  'offline.joinThis': 'Rejoindre',
  'offline.byAddressTitle': 'Rejoindre par adresse',
  'offline.versionMismatch': 'Cette table utilise une autre version de Zolik. Mettez l\'application à jour sur les deux téléphones.',
  'offline.roomTitle': 'Joueurs à proximité',
  'offline.roomBody': 'Laissez les autres téléphones de ce Wi-Fi ou point d\'accès rejoindre votre table. Aucun internet nécessaire.',
  'offline.roomOpenButton': 'Inviter les joueurs à proximité',
  'offline.roomOpen': 'Les autres téléphones de ce réseau peuvent maintenant trouver votre table. S\'ils ne la voient pas, ils peuvent saisir l\'adresse ou scanner le code.',
  'offline.roomClose': 'Arrêter les invitations',
  'offline.guestActive': 'Vous êtes à une table hébergée par un autre téléphone ({host}).',
  'offline.joinFailed': 'Impossible de rejoindre cette table : {reason}',
  'invite.offlineExplain': 'Les joueurs de cette table hors ligne la rejoignent avec ce code, via « {menu} ».',
  'invite.offlineCode': 'Code :',
  'offline.bleTitle': 'Par Bluetooth',
  'offline.bleLook': 'Chercher des tables par Bluetooth',
  'offline.bleLooking': 'Recherche de tables par Bluetooth…',
  'offline.bleOff': 'Activez le Bluetooth pour trouver des tables sans Wi-Fi.',
  'offline.bleDenied': 'Autorisez Zolik à utiliser le Bluetooth dans les Réglages pour jouer sans Wi-Fi.',
  'offline.bleInvite': 'Inviter par Bluetooth',
  'offline.bleInviteBody': 'Pour les téléphones qui ne partagent pas de Wi-Fi avec le vôtre. Aucun appairage nécessaire.',
  'offline.bleOpen': 'Les téléphones à proximité peuvent rejoindre par Bluetooth. Connectés : {n}.',
  'offline.bleStop': 'Arrêter le Bluetooth',
  'offline.bleCheck': 'Code de vérification : {code}',
  'offline.guestBle': 'Vous êtes à une table hébergée par un autre téléphone, par Bluetooth.',
  'offline.keyChanged': 'Ce n’est pas le téléphone auquel vous avez joué sous ce nom. Demandez à l’hôte, ou rejoignez par Wi-Fi.',
  // --- game notifications: invites, the game circle, push (src/notify) ---
  'err.NOT_PLAYED_TOGETHER': 'Vous ne pouvez ajouter que des personnes avec qui vous avez joué. Envoyez-leur votre lien d’ami ou demandez par nom d’utilisateur.',
  'err.UNKNOWN_PLAYER': 'Personne ne joue sous ce nom.',
  'err.UNKNOWN_FRIEND_CODE': 'Ce lien d’ami ne fonctionne plus.',
  'err.CANNOT_ADD_SELF': 'C’est vous. Ajoutez quelqu’un d’autre.',
  'err.RATE_LIMITED': 'Trop de demandes à la fois. Réessayez dans quelques minutes.',
  'err.PUSH_UNAVAILABLE': 'Les notifications ne sont pas configurées sur ce serveur.',
  'notify.someone': 'Quelqu’un',
  'notify.join': 'Rejoindre',
  'notify.joining': 'Connexion…',
  'notify.goToTable': 'Aller à la table',
  'notify.notNow': 'Pas maintenant',
  'notify.moreOptions': 'Plus d’options',
  'notify.muteHost': 'Ne plus recevoir d’invitations de {host}',
  'notify.joinFailed': 'Impossible de rejoindre : {reason}',
  'notify.hostingOffline': 'Vous hébergez une table sur ce téléphone. Quittez-la d’abord pour en rejoindre une autre.',
  'notify.on': 'Activé',
  'notify.off': 'Désactivé',
  'notify.channelName': 'Invitations de jeu',
  'notify.banner.online': '{host} a ouvert une table de {game}',
  'notify.banner.onlineNoGame': '{host} a ouvert une table',
  'notify.banner.nearby': '{host} héberge une table près de vous',
  'notify.banner.seated': 'Vous avez été placé à une table',
  'notify.banner.fromCircle': 'De votre cercle de jeu',
  'notify.banner.known': 'Vous avez déjà joué ensemble',
  'notify.banner.nearbyDetail': 'Sur un téléphone près de vous',
  'notify.banner.seatedDetail': 'Un hôte vous a choisi dans la salle d’attente',
  'notify.banner.more': '+{n} de plus',
  'notify.pillOne': '1 table vous attend',
  'notify.pillMany': '{n} tables vous attendent',
  'notify.waitingCard.title': 'Tables qui vous attendent',
  'notify.waitingCard.empty': 'Aucune table ne vous attend.',
  'notify.prompt.title': 'Soyez prévenu quand votre cercle lance une partie',
  'notify.prompt.body': 'Uniquement les tables ouvertes par votre cercle de jeu. Vous pouvez le désactiver dans les Réglages.',
  'notify.prompt.enable': 'Activer',
  'notify.prompt.later': 'Plus tard',
  'notify.settings.heading': 'Notifications',
  'notify.settings.invites': 'Invitations de jeu',
  'notify.settings.invitesBody': 'Qui peut vous prévenir quand il ouvre une table.',
  'notify.settings.invitesCircle': 'Mon cercle',
  'notify.settings.invitesOff': 'Personne',
  'notify.settings.nearby': 'Tables à proximité',
  'notify.settings.nearbyBody': 'Afficher une bannière quand un téléphone près de vous ouvre une table. Fonctionne quand l’app est ouverte.',
  'notify.settings.push': 'Notifications sur cet appareil',
  'notify.settings.pushOn': 'Activées. Vous êtes prévenu des tables même app fermée.',
  'notify.settings.pushOff': 'Désactivées. Les invitations n’apparaissent que dans l’app ouverte.',
  'notify.settings.pushBlocked': 'Bloquées. Autorisez les notifications pour cette app dans les réglages du téléphone.',
  'notify.settings.pushBlockedWeb': 'Bloquées. Autorisez les notifications pour ce site dans les réglages du navigateur.',
  'notify.settings.pushInstall': 'Sur iPhone et iPad, ajoutez d’abord ce site à l’écran d’accueil, puis activez-y les notifications.',
  'notify.settings.pushUnavailable': 'Ce serveur n’envoie pas de notifications.',
  'notify.settings.pushUnsupported': 'Cet appareil ou ce navigateur ne peut pas afficher de notifications.',
  'notify.settings.signIn': 'Connectez-vous ou jouez en invité pour recevoir des invitations de jeu.',
  'notify.announce.heading': 'Prévenir mon cercle',
  'notify.announce.body': 'Les personnes de votre cercle de jeu sont prévenues de cette table et peuvent la rejoindre d’un geste.',
  'notify.announce.toggle': 'Prévenir mon cercle quand j’ouvre une table',
  'notify.announce.sending': 'Nous prévenons votre cercle…',
  'notify.announce.toldOne': '1 joueur prévenu',
  'notify.announce.toldMany': '{n} joueurs prévenus',
  'notify.announce.already': 'Votre cercle connaît déjà cette table.',
  'notify.announce.nobody': 'Personne à prévenir pour l’instant. Ajoutez des personnes à votre cercle.',
  'notify.announce.circleLink': 'Cercle de jeu',
  'notify.addToCircle': 'Ajouter {name} à votre cercle',
  ...
  'offline.tellNearbyBody': 'Les téléphones de la pièce avec l’app ouverte se voient proposer cette table.',
  'circle.title': 'Cercle de jeu',
  'circle.subtitle': 'Les personnes que vous prévenez quand vous ouvrez une table, et celles qui vous préviennent.',
  'circle.signInRequired': 'Connectez-vous ou jouez en invité pour créer un cercle de jeu.',
  'circle.requests.heading': 'Demandes',
  'circle.requests.body': 'Ces personnes aimeraient vous prévenir quand elles ouvrent une table.',
  'circle.accept': 'Accepter',
  'circle.decline': 'Refuser',
  'circle.members.heading': 'Votre cercle',
  'circle.members.body': 'Ils sont prévenus des tables que vous ouvrez pour vos amis.',
  'circle.members.empty': 'Personne pour l’instant. Ajoutez des personnes ci-dessous.',
  'circle.pending': 'En attente d’acceptation',
  'circle.since': 'Depuis le {date}',
  'circle.remove': 'Retirer',
  'circle.notifiers.heading': 'Qui peut vous inviter',
  'circle.notifiers.body': 'Mettez en sourdine ceux dont vous ne voulez pas entendre parler des tables.',
  'circle.notifiers.empty': 'Personne ne vous a encore ajouté.',
  'circle.mute': 'Sourdine',
  'circle.unmute': 'Réactiver',
  'circle.muted': 'En sourdine',
  'circle.suggestions.heading': 'Joué récemment',
  'circle.suggestions.body': 'Des personnes avec qui vous avez partagé une table. Ajoutez-les pour les prévenir de vos tables.',
  'circle.lastPlayed': 'Dernière partie le {date}',
  'circle.add': 'Ajouter',
  'circle.added': '{name} est dans votre cercle.',
  'circle.addSomeone.heading': 'Ajouter quelqu’un',
  'circle.friendLink.body': 'Quiconque ouvre votre lien d’ami rejoint votre cercle, et vous le sien.',
  'circle.shareMessage': 'Rejoins mon cercle de jeu sur Jokerless',
  'circle.username.body': 'Ou demandez par nom d’utilisateur. L’autre personne doit accepter.',
  'circle.username.placeholder': 'Nom d’utilisateur',
  'circle.username.submit': 'Envoyer la demande',
  'circle.username.sent': 'Demande envoyée à {name}.',
  'circle.settingsLink': 'Réglages des notifications',
  'circle.addFriend.title': 'Ajouter au cercle de jeu',
  'circle.addFriend.loading': 'Vérification du lien…',
  'circle.addFriend.missing': 'Ce lien ne contient pas de code d’ami.',
  'circle.addFriend.body': '{name} vous invite dans son cercle de jeu. Chacun sera prévenu quand l’autre ouvre une table.',
