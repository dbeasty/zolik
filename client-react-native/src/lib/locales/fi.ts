...
export const fi: Record<string, string> = {
  ...
  'option.openDiscardPile': 'Poistopino',
  'choice.openDiscardPile.1': 'Saa selata',
  'choice.openDiscardPile.0': 'Vain päällimmäinen kortti',
  ...
  'replay.track.all': 'Kaikki',
  'replay.track.yours': 'Omat siirrot',
  'replay.track.rounds': 'Kierrokset',
  'replay.track.marks': 'Merkit',
  'replay.play': 'Toista',
  'replay.pause': 'Tauko',
  ...
  'err.ALREADY_SHOWN': 'Kätesi on jo näkyvissä',
  'err.NOTHING_TO_SHOW': 'Sinulla ei ole kättä näytettäväksi',
  'holdem.offer.show': 'Näytä käteni',
  'holdem.offer.finish': 'Päätä ottelu',
  'holdem.remedy.nothingToShow': 'Et ollut mukana tässä jaossa — odota seuraavaa.',
  'holdem.rules.section.showdown': 'Jaon jälkeen',
  'holdem.rules.stopEveryHand': 'Peli pysähtyy jokaisen jaon jälkeen, jotta kortit ehtii nähdä.',
  'holdem.rules.revealEveryone': 'Showdownissa käännetään esiin kaikki maksaneet kädet.',
  'holdem.rules.revealWinners': 'Showdownissa käännetään esiin vain voittava käsi.',
  'holdem.rules.showYourOwn': 'Voit aina kääntää oman kätesi esiin, kunnes hyväksyt jatkamisen.',
  'holdem.rules.showOnce': 'Käden voi näyttää vain kerran.',
  'holdem.seat.won': 'Voitti',
  'holdem.seat.mucked': 'Ei näyttänyt',
  'holdem.status.mucked': '{playerId} ei näyttänyt',
  'holdem.status.shownVoluntary': '{playerId} näytti kätensä',
  'zone.shownHand': 'Näytetty',
  'option.showdownReveal': 'Näyttäminen showdownissa',
  'choice.showdownReveal.2': 'Kaikki maksaneet',
  'choice.showdownReveal.1': 'Vain voittaja',
  'home.playOffline': 'Pelaa offline',
  'offline.title': 'Pelaa offline',
  'offline.subtitle': 'Internetiä ei tarvita',
  'offline.body': 'Tämä puhelin isännöi pöytää itse, joten voit pelata botteja vastaan missä tahansa – jopa lentotilassa.',
  'offline.nameLabel': 'Nimesi pöydässä',
  'offline.start': 'Avaa offline-pöytä',
  'offline.starting': 'Käynnistetään…',
  'offline.active': 'Olet tämän puhelimen offline-pöydässä. Täällä aloittamasi pelit jäävät tähän puhelimeen.',
  'offline.chooseGame': 'Valitse peli',
  'offline.backOnline': 'Takaisin verkkopeliin',
  'offline.failed': 'Offline-pöytä ei käynnistynyt: {reason}',
  'offline.nearbyTitle': 'Pöydät lähellä',
  'offline.nearbyLooking': 'Etsitään pöytiä tästä verkosta…',
  'offline.nearbyNothing': 'Pöytiä ei vielä löytynyt. Varmista, että olet samassa Wi-Fissä tai hotspotissa kuin isäntä ja että Zolik saa käyttää paikallisverkkoa.',
  'offline.joinThis': 'Liity',
  'offline.byAddressTitle': 'Liity osoitteella',
  'offline.versionMismatch': 'Tämä pöytä käyttää eri Zolik-versiota. Päivitä sovellus molempiin puhelimiin.',
  'offline.roomTitle': 'Pelaajat lähellä',
  'offline.roomBody': 'Anna muiden tämän Wi-Fin tai hotspotin puhelimien liittyä pöytääsi. Internetiä ei tarvita.',
  'offline.roomOpenButton': 'Kutsu lähellä olevia pelaajia',
  'offline.roomOpen': 'Tämän verkon muut puhelimet löytävät nyt pöytäsi. Jos he eivät näe sitä, he voivat kirjoittaa osoitteen tai skannata koodin.',
  'offline.roomClose': 'Lopeta kutsuminen',
  'offline.guestActive': 'Olet pöydässä, jota isännöi toinen puhelin ({host}).',
  'offline.joinFailed': 'Pöytään liittyminen epäonnistui: {reason}',
  'invite.offlineExplain': 'Tämän offline-pöydän pelaajat liittyvät tällä koodilla kohdasta ”{menu}”.',
  'invite.offlineCode': 'Koodi:',
  'offline.bleTitle': 'Bluetoothilla',
  'offline.bleLook': 'Etsi pöytiä Bluetoothilla',
  'offline.bleLooking': 'Etsitään pöytiä Bluetoothilla…',
  'offline.bleOff': 'Laita Bluetooth päälle löytääksesi pöytiä ilman Wi-Fiä.',
  'offline.bleDenied': 'Salli Zolikin käyttää Bluetoothia asetuksissa pelataksesi ilman Wi-Fiä.',
  'offline.bleInvite': 'Kutsu Bluetoothilla',
  'offline.bleInviteBody': 'Puhelimille, joilla ei ole yhteistä Wi-Fiä kanssasi. Pariliitosta ei tarvita.',
  'offline.bleOpen': 'Lähellä olevat puhelimet voivat liittyä Bluetoothilla. Yhdistetty: {n}.',
  'offline.bleStop': 'Lopeta Bluetooth',
  'offline.bleCheck': 'Tarkistuskoodi: {code}',
  'offline.guestBle': 'Olet Bluetoothin kautta pöydässä, jota isännöi toinen puhelin.',
  'offline.keyChanged': 'Tämä ei ole puhelin, jonka pöydässä pelasit aiemmin tällä nimellä. Kysy isännältä tai liity Wi-Fillä.',
  // --- game notifications: invites, the game circle, push (src/notify) ---
  'err.NOT_PLAYED_TOGETHER': 'Voit lisätä vain ihmisiä, joiden kanssa olet pelannut. Lähetä heille ystävälinkkisi tai pyydä käyttäjänimellä.',
  'err.UNKNOWN_PLAYER': 'Kukaan ei pelaa tällä nimellä.',
  'err.UNKNOWN_FRIEND_CODE': 'Tämä ystävälinkki ei enää toimi.',
  'err.CANNOT_ADD_SELF': 'Se olet sinä. Lisää joku muu.',
  'err.RATE_LIMITED': 'Liian monta kerralla. Yritä uudelleen muutaman minuutin kuluttua.',
  'err.PUSH_UNAVAILABLE': 'Tällä palvelimella ei ole ilmoituksia käytössä.',
  'notify.someone': 'Joku',
  'notify.join': 'Liity',
  'notify.joining': 'Liitytään…',
  'notify.goToTable': 'Pöytään',
  'notify.notNow': 'Ei nyt',
  'notify.moreOptions': 'Lisää vaihtoehtoja',
  'notify.muteHost': 'Ei kutsuja pelaajalta {host}',
  'notify.joinFailed': 'Liittyminen epäonnistui: {reason}',
  'notify.hostingOffline': 'Isännöit pöytää tällä puhelimella. Poistu siitä ensin liittyäksesi toiseen.',
  'notify.on': 'Päällä',
  'notify.off': 'Pois',
  'notify.channelName': 'Pelikutsut',
  'notify.banner.online': '{host} avasi pöydän: {game}',
  'notify.banner.onlineNoGame': '{host} avasi pöydän',
  'notify.banner.nearby': '{host} isännöi pöytää lähelläsi',
  'notify.banner.seated': 'Sinut on istutettu pöytään',
  'notify.banner.fromCircle': 'Pelipiiristäsi',
  'notify.banner.known': 'Olette pelanneet yhdessä ennenkin',
  'notify.banner.nearbyDetail': 'Lähelläsi olevassa puhelimessa',
  'notify.banner.seatedDetail': 'Isäntä valitsi sinut odotushuoneesta',
  'notify.banner.more': '+{n} lisää',
  'notify.pillOne': '1 pöytä odottaa',
  'notify.pillMany': 'Odottavia pöytiä: {n}',
  'notify.waitingCard.title': 'Sinua odottavat pöydät',
  'notify.waitingCard.empty': 'Mikään pöytä ei odota sinua.',
  'notify.prompt.title': 'Saat tiedon, kun piirisi aloittaa pelin',
  'notify.prompt.body': 'Vain pelipiirisi jäsenten avaamat pöydät. Voit poistaa tämän käytöstä asetuksissa.',
  'notify.prompt.enable': 'Ota käyttöön',
  'notify.prompt.later': 'Myöhemmin',
  'notify.settings.heading': 'Ilmoitukset',
  'notify.settings.invites': 'Pelikutsut',
  'notify.settings.invitesBody': 'Kuka saa kertoa sinulle avaamastaan pöydästä.',
  'notify.settings.invitesCircle': 'Oma piiri',
  'notify.settings.invitesOff': 'Ei kukaan',
  'notify.settings.nearby': 'Lähellä olevat pöydät',
  'notify.settings.nearbyBody': 'Näytä ilmoitus, kun lähellä oleva puhelin avaa pöydän. Toimii, kun sovellus on auki.',
  'notify.settings.push': 'Ilmoitukset tällä laitteella',
  'notify.settings.pushOn': 'Päällä. Kuulet pöydistä, vaikka sovellus olisi suljettu.',
  'notify.settings.pushOff': 'Pois. Kutsut näkyvät vain, kun sovellus on auki.',
  'notify.settings.pushBlocked': 'Estetty. Salli tämän sovelluksen ilmoitukset puhelimen asetuksissa.',
  'notify.settings.pushBlockedWeb': 'Estetty. Salli tämän sivuston ilmoitukset selaimen asetuksissa.',
  'notify.settings.pushInstall': 'Lisää iPhonessa ja iPadissa tämä sivusto ensin kotinäyttöön ja ota ilmoitukset käyttöön siellä.',
  'notify.settings.pushUnavailable': 'Tämä palvelin ei lähetä ilmoituksia.',
  'notify.settings.pushUnsupported': 'Tämä laite tai selain ei voi näyttää ilmoituksia.',
  'notify.settings.signIn': 'Kirjaudu sisään tai pelaa vieraana saadaksesi pelikutsuja.',
  'notify.announce.heading': 'Kerro piirilleni',
  'notify.announce.body': 'Pelipiirisi jäsenet saavat tiedon tästä pöydästä ja voivat liittyä yhdellä napautuksella.',
  'notify.announce.toggle': 'Kerro piirilleni, kun avaan pöydän',
  'notify.announce.sending': 'Kerrotaan piirillesi…',
  'notify.announce.toldOne': 'Kerrottu 1 pelaajalle',
  'notify.announce.toldMany': 'Kerrottu pelaajille: {n}',
  'notify.announce.already': 'Piirisi tietää jo tästä pöydästä.',
  'notify.announce.nobody': 'Ei vielä ketään, jolle kertoa. Lisää ihmisiä piiriisi.',
  'notify.announce.circleLink': 'Pelipiiri',
  'notify.addToCircle': 'Lisää {name} piiriisi',
  ...
  'offline.tellNearbyBody': 'Huoneen puhelimille, joissa sovellus on auki, tarjotaan tätä pöytää.',
  'circle.title': 'Pelipiiri',
  'circle.subtitle': 'Ihmiset, joille kerrot avaamistasi pöydistä, ja ihmiset, jotka kertovat sinulle.',
  'circle.signInRequired': 'Kirjaudu sisään tai pelaa vieraana luodaksesi pelipiirin.',
  'circle.requests.heading': 'Pyynnöt',
  'circle.requests.body': 'He haluaisivat kertoa sinulle, kun avaavat pöydän.',
  'circle.accept': 'Hyväksy',
  'circle.decline': 'Hylkää',
  'circle.members.heading': 'Piirisi',
  'circle.members.body': 'He saavat tiedon pöydistä, jotka avaat ystäville.',
  'circle.members.empty': 'Ei vielä ketään. Lisää ihmisiä alla.',
  'circle.pending': 'Odottaa hyväksyntää',
  'circle.since': 'Alkaen {date}',
  'circle.remove': 'Poista',
  'circle.notifiers.heading': 'Kuka voi kutsua sinut',
  'circle.notifiers.body': 'Mykistä kaikki, joiden pöydistä et halua kuulla.',
  'circle.notifiers.empty': 'Kukaan ei ole vielä lisännyt sinua.',
  'circle.mute': 'Mykistä',
  'circle.unmute': 'Poista mykistys',
  'circle.muted': 'Mykistetty',
  'circle.suggestions.heading': 'Pelattu äskettäin',
  'circle.suggestions.body': 'Ihmiset, joiden kanssa olet istunut samassa pöydässä. Lisää heidät, niin he kuulevat pöydistäsi.',
  'circle.lastPlayed': 'Viimeksi pelattu {date}',
  'circle.add': 'Lisää',
  'circle.added': '{name} on piirissäsi.',
  'circle.addSomeone.heading': 'Lisää joku',
  'circle.friendLink.body': 'Jokainen ystävälinkkisi avaaja liittyy piiriisi, ja sinä hänen piiriinsä.',
  'circle.shareMessage': 'Liity pelipiiriini Jokerlessissa',
  'circle.username.body': 'Tai pyydä käyttäjänimellä. Toisen on hyväksyttävä.',
  'circle.username.placeholder': 'Käyttäjänimi',
  'circle.username.submit': 'Lähetä pyyntö',
  'circle.username.sent': 'Pyyntö lähetetty: {name}.',
  'circle.settingsLink': 'Ilmoitusasetukset',
  'circle.addFriend.title': 'Lisää pelipiiriin',
  'circle.addFriend.loading': 'Tarkistetaan linkkiä…',
  'circle.addFriend.missing': 'Tässä linkissä ei ole ystäväkoodia.',
  'circle.addFriend.body': '{name} kutsuu sinut pelipiiriinsä. Kumpikin saa tiedon, kun toinen avaa pöydän.',
