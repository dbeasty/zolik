...
export const bg: Record<string, string> = {
  ...
  'err.REPLAY_UNAVAILABLE': 'Прегледът на игри не е достъпен на този сървър',
  ...
  'canasta.rules.blackThreesGoOut':
    'Черната тройка блокира купчината и струва {n} точки. Три или четири от тях може да се свалят направо от ръката, никога с жокер между тях, и само като ходът, с който страната ти излиза.',
  'canasta.rules.blackThreesNeverMeld':
    'Черната тройка никога не се сваля. Изхвърлена, тя блокира купчината, а останала в ръката ти в края на раздаването, струва {n} точки против теб.',
  ...
  'canasta.rules.pileOntoMeld': 'Ако страната ти вече има незавършена комбинация със стойността на горната карта, можеш да вземеш цялата купчина с изхвърлени и да добавиш тази карта към нея — двойка от ръката не ти трябва.',
  'canasta.rules.pileNoMeldCapture': 'Комбинация, която вече е на масата, не може да вземе купчината с изхвърлени: за да я вземеш, трябва да допълниш горната ѝ карта с две карти от собствената си ръка.',
  ...
  'canasta.remedy.needMorePoints': 'На първата комбинация на твоята страна ѝ липсват {n} точки до {floor}.',
  ...
  'option.openDiscardPile': 'Изхвърлени',
  'choice.openDiscardPile.1': 'Може да се преглежда',
  'choice.openDiscardPile.0': 'Само горната карта',
  ...
  'replay.round': 'Рунд',
  'replay.track.all': 'Всички',
  'replay.track.yours': 'Твоите ходове',
  'replay.track.rounds': 'Рундове',
  'replay.track.marks': 'Отметки',
  'replay.play': 'Пусни',
  'replay.pause': 'Пауза',
  ...
  'home.playOffline': 'Игра офлайн',
  'offline.title': 'Игра офлайн',
  'offline.subtitle': 'Без интернет',
  'offline.body': 'Този телефон сам поддържа масата, така че можете да играете срещу ботове навсякъде — дори в самолетен режим.',
  'offline.nameLabel': 'Вашето име на масата',
  'offline.start': 'Отвори офлайн маса',
  'offline.starting': 'Стартиране…',
  'offline.active': 'Вие сте на офлайн масата на този телефон. Игрите, започнати тук, остават на този телефон.',
  'offline.chooseGame': 'Изберете игра',
  'offline.backOnline': 'Обратно към онлайн игра',
  'offline.failed': 'Офлайн масата не стартира: {reason}',
  'offline.nearbyTitle': 'Маси наблизо',
  'offline.nearbyLooking': 'Търсене на маси в тази мрежа…',
  'offline.nearbyNothing': 'Още няма намерени маси. Уверете се, че сте в същата Wi-Fi мрежа или hotspot като домакина и че Zolik може да използва локалната мрежа.',
  'offline.joinThis': 'Присъедини се',
  'offline.byAddressTitle': 'Присъединяване по адрес',
  'offline.versionMismatch': 'Тази маса работи с друга версия на Zolik. Обновете приложението и на двата телефона.',
  'offline.roomTitle': 'Играчи наблизо',
  'offline.roomBody': 'Позволете на други телефони в тази Wi-Fi мрежа или hotspot да седнат на масата ви. Без интернет.',
  'offline.roomOpenButton': 'Покани играчи наблизо',
  'offline.roomOpen': 'Другите телефони в мрежата вече могат да намерят масата ви. Ако не я виждат, могат да въведат адреса или да сканират кода.',
  'offline.roomClose': 'Спри поканите',
  'offline.guestActive': 'Вие сте на маса, домакинствана от друг телефон ({host}).',
  'offline.joinFailed': 'Не успяхте да се присъедините към тази маса: {reason}',
  'invite.offlineExplain': 'Играчите на тази офлайн маса се присъединяват с този код от „{menu}“.',
  'invite.offlineCode': 'Код:',
  'offline.bleTitle': 'През Bluetooth',
  'offline.bleLook': 'Търси маси през Bluetooth',
  'offline.bleLooking': 'Търсене на маси през Bluetooth…',
  'offline.bleOff': 'Включете Bluetooth, за да намерите маси без Wi-Fi.',
  'offline.bleDenied': 'Разрешете на Zolik да използва Bluetooth в Настройки, за да играете без Wi-Fi.',
  'offline.bleInvite': 'Покани през Bluetooth',
  'offline.bleInviteBody': 'За телефони, които не споделят Wi-Fi с вашия. Не е нужно сдвояване.',
  'offline.bleOpen': 'Телефоните наблизо могат да се присъединят през Bluetooth. Свързани: {n}.',
  'offline.bleStop': 'Спри Bluetooth',
  'offline.bleCheck': 'Код за проверка: {code}',
  'offline.guestBle': 'Вие сте през Bluetooth на маса, домакинствана от друг телефон.',
  'offline.keyChanged': 'Това не е телефонът, на който сте играли преди с това име. Попитайте домакина или се присъединете през Wi-Fi.',
  // --- game notifications: invites, the game circle, push (src/notify) ---
  'err.NOT_PLAYED_TOGETHER': 'Можете да добавяте само хора, с които сте играли. Изпратете им своята връзка за приятели или поискайте чрез потребителско име.',
  'err.UNKNOWN_PLAYER': 'Никой не играе с това име.',
  'err.UNKNOWN_FRIEND_CODE': 'Тази връзка за приятели вече не работи.',
  'err.CANNOT_ADD_SELF': 'Това сте вие. Добавете някой друг.',
  'err.RATE_LIMITED': 'Твърде много наведнъж. Опитайте отново след няколко минути.',
  'err.PUSH_UNAVAILABLE': 'На този сървър не са настроени известия.',
  'notify.someone': 'Някой',
  'notify.join': 'Присъедини се',
  'notify.joining': 'Присъединяване…',
  'notify.goToTable': 'Към масата',
  'notify.notNow': 'Не сега',
  'notify.moreOptions': 'Още опции',
  'notify.muteHost': 'Без покани от {host}',
  'notify.joinFailed': 'Неуспешно присъединяване: {reason}',
  'notify.hostingOffline': 'Домакин сте на маса на този телефон. Първо я напуснете, за да се присъедините към друга.',
  'notify.on': 'Вкл.',
  'notify.off': 'Изкл.',
  'notify.channelName': 'Покани за игра',
  'notify.banner.online': '{host} отвори маса: {game}',
  'notify.banner.onlineNoGame': '{host} отвори маса',
  'notify.banner.nearby': '{host} е домакин на маса наблизо',
  'notify.banner.seated': 'Настанени сте на маса',
  'notify.banner.fromCircle': 'От вашия игрален кръг',
  'notify.banner.known': 'Играли сте заедно преди',
  'notify.banner.nearbyDetail': 'На телефон близо до вас',
  'notify.banner.seatedDetail': 'Домакин ви избра от чакалнята',
  'notify.banner.more': '+{n} още',
  'notify.pillOne': '1 маса чака',
  'notify.pillMany': 'Чакащи маси: {n}',
  'notify.waitingCard.title': 'Маси, които ви чакат',
  'notify.waitingCard.empty': 'Никоя маса не ви чака.',
  'notify.prompt.title': 'Научавайте, когато кръгът ви започва игра',
  'notify.prompt.body': 'Само маси, отворени от хора от вашия игрален кръг. Можете да го изключите в Настройки.',
  'notify.prompt.enable': 'Включи',
  'notify.prompt.later': 'По-късно',
  'notify.settings.heading': 'Известия',
  'notify.settings.invites': 'Покани за игра',
  'notify.settings.invitesBody': 'Кой може да ви съобщи, че е отворил маса.',
  'notify.settings.invitesCircle': 'Моят кръг',
  'notify.settings.invitesOff': 'Никой',
  'notify.settings.nearby': 'Маси наблизо',
  'notify.settings.nearbyBody': 'Показване на банер, когато телефон наблизо отвори маса. Работи, докато приложението е отворено.',
  'notify.settings.push': 'Известия на това устройство',
  'notify.settings.pushOn': 'Включени. Научавате за маси дори при затворено приложение.',
  'notify.settings.pushOff': 'Изключени. Поканите се показват само в отвореното приложение.',
  'notify.settings.pushBlocked': 'Блокирани. Разрешете известията за това приложение в настройките на телефона.',
  'notify.settings.pushBlockedWeb': 'Блокирани. Разрешете известията за този сайт в настройките на браузъра.',
  'notify.settings.pushInstall': 'На iPhone и iPad първо добавете този сайт към началния екран и там включете известията.',
  'notify.settings.pushUnavailable': 'Този сървър не изпраща известия.',
  'notify.settings.pushUnsupported': 'Това устройство или браузър не може да показва известия.',
  'notify.settings.signIn': 'Влезте или играйте като гост, за да получавате покани за игра.',
  'notify.announce.heading': 'Съобщи на кръга ми',
  'notify.announce.body': 'Хората от вашия игрален кръг научават за тази маса и могат да се присъединят с едно докосване.',
  'notify.announce.toggle': 'Съобщавай на кръга ми, когато отворя маса',
  'notify.announce.sending': 'Съобщаваме на кръга ви…',
  'notify.announce.toldOne': 'Съобщено на 1 играч',
  'notify.announce.toldMany': 'Съобщено на играчи: {n}',
  'notify.announce.already': 'Кръгът ви вече знае за тази маса.',
  'notify.announce.nobody': 'Все още няма на кого да съобщите. Добавете хора към кръга си.',
  'notify.announce.circleLink': 'Игрален кръг',
  'notify.addToCircle': 'Добави {name} към кръга си',
  ...
  'offline.tellNearbyBody': 'На телефоните в стаята с отворено приложение ще бъде предложена тази маса.',
  'circle.title': 'Игрален кръг',
  'circle.subtitle': 'Хората, на които съобщавате, когато отворите маса, и хората, които съобщават на вас.',
  'circle.signInRequired': 'Влезте или играйте като гост, за да създадете игрален кръг.',
  'circle.requests.heading': 'Заявки',
  'circle.requests.body': 'Биха искали да ви съобщават, когато отворят маса.',
  'circle.accept': 'Приеми',
  'circle.decline': 'Откажи',
  'circle.members.heading': 'Вашият кръг',
  'circle.members.body': 'Те научават за масите, които отваряте за приятели.',
  'circle.members.empty': 'Все още никой. Добавете хора по-долу.',
  'circle.pending': 'Чака приемане',
  'circle.since': 'От {date}',
  'circle.remove': 'Премахни',
  'circle.notifiers.heading': 'Кой може да ви кани',
  'circle.notifiers.body': 'Заглушете всеки, за чиито маси не искате да чувате.',
  'circle.notifiers.empty': 'Още никой не ви е добавил.',
  'circle.mute': 'Заглуши',
  'circle.unmute': 'Включи звука',
  'circle.muted': 'Заглушен',
  'circle.suggestions.heading': 'Играли наскоро',
  'circle.suggestions.body': 'Хора, с които сте седели на една маса. Добавете ги, за да научават за масите ви.',
  'circle.lastPlayed': 'Последна игра {date}',
  'circle.add': 'Добави',
  'circle.added': '{name} е във вашия кръг.',
  'circle.addSomeone.heading': 'Добавете някого',
  'circle.friendLink.body': 'Всеки, който отвори вашата връзка за приятели, влиза в кръга ви, а вие в неговия.',
  'circle.shareMessage': 'Присъедини се към моя игрален кръг в Jokerless',
  'circle.username.body': 'Или поискайте чрез потребителско име. Другият трябва да приеме.',
  'circle.username.placeholder': 'Потребителско име',
  'circle.username.submit': 'Изпрати заявка',
  'circle.username.sent': 'Заявката е изпратена до {name}.',
  'circle.settingsLink': 'Настройки за известия',
  'circle.addFriend.title': 'Добавяне в игрален кръг',
  'circle.addFriend.loading': 'Проверка на връзката…',
  'circle.addFriend.missing': 'В тази връзка няма код за приятел.',
  'circle.addFriend.body': '{name} ви кани в своя игрален кръг. И двамата ще научавате, когато другият отвори маса.',
