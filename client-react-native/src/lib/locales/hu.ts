...
export const hu: Record<string, string> = {
  ...
  'option.openDiscardPile': 'Dobópakli',
  'choice.openDiscardPile.1': 'Átnézhető',
  'choice.openDiscardPile.0': 'Csak a felső lap',
  ...
  'replay.round': 'Kör',
  'replay.track.all': 'Mind',
  'replay.track.yours': 'A te lépéseid',
  'replay.track.rounds': 'Körök',
  'replay.track.marks': 'Jelölők',
  ...
  'home.playOffline': 'Offline játék',
  'offline.title': 'Offline játék',
  'offline.subtitle': 'Nem kell internet',
  'offline.body': 'Ez a telefon maga tartja az asztalt, így bárhol játszhatsz botok ellen – akár repülő módban is.',
  'offline.nameLabel': 'A neved az asztalnál',
  'offline.start': 'Offline asztal indítása',
  'offline.starting': 'Indítás…',
  'offline.active': 'Ennek a telefonnak az offline asztalánál ülsz. Az itt indított játékok ezen a telefonon maradnak.',
  'offline.chooseGame': 'Válassz játékot',
  'offline.backOnline': 'Vissza az online játékhoz',
  'offline.failed': 'Az offline asztal nem indult el: {reason}',
  'offline.nearbyTitle': 'Asztalok a közelben',
  'offline.nearbyLooking': 'Asztalok keresése ezen a hálózaton…',
  'offline.nearbyNothing': 'Még nincs asztal. Ellenőrizd, hogy ugyanazon a Wi-Fin vagy hotspoton vagy-e, mint a házigazda, és hogy a Zolik használhatja-e a helyi hálózatot.',
  'offline.joinThis': 'Csatlakozás',
  'offline.byAddressTitle': 'Csatlakozás cím alapján',
  'offline.versionMismatch': 'Ez az asztal a Zolik másik verzióját futtatja. Frissítsd az alkalmazást mindkét telefonon.',
  'offline.roomTitle': 'Játékosok a közelben',
  'offline.roomBody': 'Engedd, hogy a Wi-Fi vagy hotspot többi telefonja csatlakozzon az asztalodhoz. Nem kell internet.',
  'offline.roomOpenButton': 'Közeli játékosok meghívása',
  'offline.roomOpen': 'A hálózat többi telefonja most már megtalálja az asztalodat. Ha nem látják, beírhatják a címet vagy beolvashatják a kódot.',
  'offline.roomClose': 'Meghívás leállítása',
  'offline.guestActive': 'Egy másik telefon által tartott asztalnál ülsz ({host}).',
  'offline.joinFailed': 'Nem sikerült csatlakozni ehhez az asztalhoz: {reason}',
  'invite.offlineExplain': 'Ennek az offline asztalnak a játékosai ezzel a kóddal csatlakoznak a „{menu}” menüben.',
  'invite.offlineCode': 'Kód:',
  'offline.bleTitle': 'Bluetooth-on',
  'offline.bleLook': 'Asztalok keresése Bluetooth-on',
  'offline.bleLooking': 'Asztalok keresése Bluetooth-on…',
  'offline.bleOff': 'Kapcsold be a Bluetooth-t, hogy Wi-Fi nélkül is találj asztalt.',
  'offline.bleDenied': 'Engedélyezd a Zoliknak a Bluetooth-t a Beállításokban, hogy Wi-Fi nélkül játszhass.',
  'offline.bleInvite': 'Meghívás Bluetooth-on',
  'offline.bleInviteBody': 'Olyan telefonoknak, amelyek nem osztoznak Wi-Fin a tiéddel. Párosítás nem kell.',
  'offline.bleOpen': 'A közeli telefonok Bluetooth-on csatlakozhatnak. Csatlakozva: {n}.',
  'offline.bleStop': 'Bluetooth leállítása',
  'offline.bleCheck': 'Ellenőrző kód: {code}',
  'offline.guestBle': 'Bluetooth-on ülsz egy másik telefon által tartott asztalnál.',
  'offline.keyChanged': 'Ez nem az a telefon, amelynél korábban ezen a néven játszottál. Kérdezd meg a házigazdát, vagy csatlakozz Wi-Fin.',
  // --- game notifications: invites, the game circle, push (src/notify) ---
  'err.NOT_PLAYED_TOGETHER': 'Csak olyanokat adhatsz hozzá, akikkel már játszottál. Küldd el nekik a barátlinkedet, vagy kérd felhasználónév alapján.',
  'err.UNKNOWN_PLAYER': 'Ezen a néven senki sem játszik.',
  'err.UNKNOWN_FRIEND_CODE': 'Ez a barátlink már nem működik.',
  'err.CANNOT_ADD_SELF': 'Ez te vagy. Adj hozzá valaki mást.',
  'err.RATE_LIMITED': 'Túl sok egyszerre. Próbáld újra néhány perc múlva.',
  'err.PUSH_UNAVAILABLE': 'Ezen a szerveren nincsenek beállítva értesítések.',
  'notify.someone': 'Valaki',
  'notify.join': 'Csatlakozás',
  'notify.joining': 'Csatlakozás…',
  'notify.goToTable': 'Az asztalhoz',
  'notify.notNow': 'Most nem',
  'notify.moreOptions': 'További lehetőségek',
  'notify.muteHost': 'Nem kérek meghívást tőle: {host}',
  'notify.joinFailed': 'Nem sikerült csatlakozni: {reason}',
  'notify.hostingOffline': 'Ezen a telefonon asztalt vezetsz. Előbb hagyd el, hogy máshová csatlakozhass.',
  'notify.on': 'Be',
  'notify.off': 'Ki',
  'notify.channelName': 'Játékmeghívások',
  'notify.banner.online': '{host} asztalt nyitott: {game}',
  'notify.banner.onlineNoGame': '{host} asztalt nyitott',
  'notify.banner.nearby': '{host} asztalt vezet a közelben',
  'notify.banner.seated': 'Leültettek egy asztalhoz',
  'notify.banner.fromCircle': 'A játékkörödből',
  'notify.banner.known': 'Játszottatok már együtt',
  'notify.banner.nearbyDetail': 'Egy közeli telefonon',
  'notify.banner.seatedDetail': 'Egy házigazda kiválasztott a váróteremből',
  'notify.banner.more': '+{n} további',
  'notify.pillOne': '1 asztal vár',
  'notify.pillMany': 'Váró asztalok: {n}',
  'notify.waitingCard.title': 'Rád váró asztalok',
  'notify.waitingCard.empty': 'Egy asztal sem vár rád.',
  'notify.prompt.title': 'Tudd meg, amikor a köröd játékot kezd',
  'notify.prompt.body': 'Csak a játékkörödbe tartozók által nyitott asztalok. A Beállításokban kikapcsolhatod.',
  'notify.prompt.enable': 'Bekapcsolás',
  'notify.prompt.later': 'Később',
  'notify.settings.heading': 'Értesítések',
  'notify.settings.invites': 'Játékmeghívások',
  'notify.settings.invitesBody': 'Ki szólhat neked, ha asztalt nyit.',
  'notify.settings.invitesCircle': 'A köröm',
  'notify.settings.invitesOff': 'Senki',
  'notify.settings.nearby': 'Közeli asztalok',
  'notify.settings.nearbyBody': 'Értesítés megjelenítése, ha egy közeli telefon asztalt nyit. Nyitott alkalmazásnál működik.',
  'notify.settings.push': 'Értesítések ezen az eszközön',
  'notify.settings.pushOn': 'Be. Akkor is hallasz az asztalokról, ha az alkalmazás be van zárva.',
  'notify.settings.pushOff': 'Ki. A meghívások csak nyitott alkalmazásban jelennek meg.',
  'notify.settings.pushBlocked': 'Letiltva. Engedélyezd az alkalmazás értesítéseit a telefon beállításaiban.',
  'notify.settings.pushBlockedWeb': 'Letiltva. Engedélyezd az oldal értesítéseit a böngésző beállításaiban.',
  'notify.settings.pushInstall': 'iPhone-on és iPaden előbb add hozzá ezt az oldalt a kezdőképernyőhöz, és ott kapcsold be az értesítéseket.',
  'notify.settings.pushUnavailable': 'Ez a szerver nem küld értesítéseket.',
  'notify.settings.pushUnsupported': 'Ez az eszköz vagy böngésző nem tud értesítéseket megjeleníteni.',
  'notify.settings.signIn': 'Jelentkezz be, vagy játssz vendégként, hogy játékmeghívásokat kapj.',
  'notify.announce.heading': 'Szólj a körömnek',
  'notify.announce.body': 'A játékkörödben lévők értesülnek erről az asztalról, és egy koppintással csatlakozhatnak.',
  'notify.announce.toggle': 'Szólj a körömnek, amikor asztalt nyitok',
  'notify.announce.sending': 'Szólunk a körödnek…',
  'notify.announce.toldOne': '1 játékos értesítve',
  'notify.announce.toldMany': 'Értesített játékosok: {n}',
  'notify.announce.already': 'A köröd már tud erről az asztalról.',
  'notify.announce.nobody': 'Még nincs kinek szólni. Adj hozzá embereket a körödhöz.',
  'notify.announce.circleLink': 'Játékkör',
  'notify.addToCircle': '{name} hozzáadása a körödhöz',
  ...
  'offline.tellNearbyBody': 'A teremben lévő, nyitott alkalmazású telefonok felajánlják ezt az asztalt.',
  'circle.title': 'Játékkör',
  'circle.subtitle': 'Akiknek szólsz, ha asztalt nyitsz, és akik neked szólnak.',
  'circle.signInRequired': 'Jelentkezz be, vagy játssz vendégként, hogy játékkört építhess.',
  'circle.requests.heading': 'Kérések',
  'circle.requests.body': 'Szólnának neked, amikor asztalt nyitnak.',
  'circle.accept': 'Elfogadás',
  'circle.decline': 'Elutasítás',
  'circle.members.heading': 'A köröd',
  'circle.members.body': 'Ők értesülnek a barátoknak nyitott asztalaidról.',
  'circle.members.empty': 'Még senki. Adj hozzá embereket lent.',
  'circle.pending': 'Elfogadásra vár',
  'circle.since': '{date} óta',
  'circle.remove': 'Eltávolítás',
  'circle.notifiers.heading': 'Kik hívhatnak meg',
  'circle.notifiers.body': 'Némíts el bárkit, akinek az asztalairól nem akarsz hallani.',
  'circle.notifiers.empty': 'Még senki sem adott hozzá.',
  'circle.mute': 'Némítás',
  'circle.unmute': 'Némítás feloldása',
  'circle.muted': 'Némítva',
  'circle.suggestions.heading': 'Nemrég játszottál',
  'circle.suggestions.body': 'Akikkel egy asztalnál ültél. Add hozzá őket, hogy értesüljenek az asztalaidról.',
  'circle.lastPlayed': 'Utoljára játszva: {date}',
  'circle.add': 'Hozzáadás',
  'circle.added': '{name} a körödben van.',
  'circle.addSomeone.heading': 'Valaki hozzáadása',
  'circle.friendLink.body': 'Aki megnyitja a barátlinkedet, bekerül a körödbe, te pedig az övébe.',
  'circle.shareMessage': 'Csatlakozz a játékkörömhöz a Jokerlessen',
  'circle.username.body': 'Vagy kérd felhasználónév alapján. A másiknak el kell fogadnia.',
  'circle.username.placeholder': 'Felhasználónév',
  'circle.username.submit': 'Kérés küldése',
  'circle.username.sent': 'Kérés elküldve neki: {name}.',
  'circle.settingsLink': 'Értesítési beállítások',
  'circle.addFriend.title': 'Hozzáadás a játékkörhöz',
  'circle.addFriend.loading': 'Link ellenőrzése…',
  'circle.addFriend.missing': 'Ebben a linkben nincs barátkód.',
  'circle.addFriend.body': '{name} meghív a játékkörébe. Mindketten értesültök, ha a másik asztalt nyit.',
