...
export const es: Record<string, string> = {
  ...
  'canasta.rules.deck': 'Se juega con {value} cartas — dos barajas más comodines.',
  ...
  'settings.notSignedIn': 'No has iniciado sesión — inicia sesión o continúa como invitado para jugar online.',
  ...
  'gate.body': 'Las tablas de puntos y las estadísticas se guardan con tu cuenta, así te acompañan a otro dispositivo. Un invitado no tiene dónde guardarlas.',
};
