...
export const es: Record<string, string> = {
  ...
  'err.WRONG_PHASE': 'No en este momento del turno',
  ...
  'err.DISPLACED': 'Abierta en otra pestaña — esta ha dejado de sincronizarse',
  ...
  'err.REPLAY_UNAVAILABLE': 'La reproducción de partidas no está disponible en este servidor',
  ...
  'prsi.remedy.matchOrDraw': 'Juega una carta de {suit} o una que case con {card}; si no, roba.',
  'prsi.remedy.answerSevenOrTake': 'Responde con un siete tuyo, o llévate las {n} cartas.',
  'prsi.remedy.playOrDraw': 'No hay ningún turno que saltarte: juega una carta de {suit} o roba.',
  'prsi.remedy.nameASuit': 'Di qué palo sigue a tu dama.',
  'prsi.remedy.nothingLeftToDraw': 'No queda nada que robar: juega una carta si puedes.',
  ...
  'canasta.rules.section.turn': 'Tu turno',
  ...
  'canasta.rules.turnDiscard':
    'El descarte es lo que cierra el turno, así que siempre debes reservar una carta para él.',
  'canasta.rules.pileTopCard':
    'El descarte solo puede tomarse con una jugada que use su carta superior de inmediato.',
  ...
  'canasta.rules.wildRatio':
    'Una combinación necesita {n} cartas naturales por cada comodín, y nunca más de {wilds} comodines en total.',
  'canasta.rules.oneMeldPerRank':
    'Tu bando mantiene una combinación por valor: las cartas siguientes de ese valor se añaden a ella.',
  'canasta.rules.meldsPerRankUnlimited': 'Tu bando puede tener varias combinaciones del mismo valor.',
  'canasta.rules.canastaCloses': 'Una canasta de {n} está completa y no admite más cartas.',
  'canasta.rules.meldsAreShared':
    'Las combinaciones son de la pareja: cualquiera de los dos puede ampliarlas, y nadie toca las del rival.',
  'canasta.rules.layOffAfterOpening':
    'Hasta que tu bando no haga su combinación inicial, no puede añadir cartas a nada de la mesa.',
  'canasta.rules.goOutKeepsACard':
    'Siempre tienes que poder terminar tu turno, así que nunca bajes toda la mano salvo que sea la jugada con la que te cierras.',
  ...
  'holdem.rules.checkOrCall': 'Solo puedes pasar cuando no debes nada; si no, iguala, sube o retírate.',
  'holdem.rules.minRaise': 'Una subida tiene que ser al menos tan grande como la anterior.',
  'holdem.rules.allIn':
    'Nunca puedes poner más que tu pila, y el all-in siempre está permitido, aunque sea menos que una subida completa.',
  'holdem.rules.foldedOut': 'Una vez que te retiras, quedas fuera hasta que se reparta la siguiente mano.',
  'holdem.remedy.callOrFold': 'Debes {n}: iguala, sube o retírate.',
  'holdem.remedy.checkOrRaise': 'No se debe nada: pasa o sube.',
  'holdem.remedy.callAllInOrFold':
    'Tu pila no llega por encima de la apuesta: iguala {n} en all-in o retírate.',
  'holdem.remedy.raiseAtLeast': 'Sube al menos a {n}.',
  'holdem.remedy.raiseAtMost': 'Sube como mucho a {n}: esa es toda tu pila.',
  'holdem.remedy.nameAnAmount': 'Di a cuánto subes, entre {min} y {max}.',
  'holdem.remedy.waitForNextHand': 'Estás fuera de esta mano: espera al siguiente reparto.',
  ...
  'canasta.round.closed': '{player} cerró con una diferencia de {diff} puntos',
  ...
  'err.NOTHING_TO_SKIP': 'No hay ningún turno que saltarse',
  ...
  'err.CANNOT_RAISE': 'No puedes subir: tu pila no llega por encima de la apuesta',
  ...
  'err.BAD_SEATING': 'Ese orden de asientos no coincide con quién está en la mesa',
  ...
  'canasta.remedy.drawOrTakePile': 'Roba del mazo o llévate el descarte antes de bajar combinaciones.',
  'canasta.remedy.meldOrDiscard': 'Ya has robado: baja una combinación o descarta para terminar el turno.',
  'canasta.remedy.drawFromStock': 'Roba del mazo en su lugar.',
  'canasta.remedy.takePileInstead': 'El mazo está vacío: llévate el descarte en su lugar.',
  'canasta.remedy.pileBlocked': 'Roba del mazo: el tres negro de arriba mantiene cerrado el descarte.',
  'canasta.remedy.pileFrozen':
    'Roba del mazo, o llévate el descarte con dos cartas naturales de tu mano que casen con {card}.',
  'canasta.remedy.topCardUnusable': 'Roba del mazo: tu bando no puede hacer nada con el {card} de arriba.',
  ...
  'holdem.cost.pot': 'bote tras igualar',
  ...
  'ginrummy.rules.upcardDance':
    'Antes del primer robo, el no repartidor puede tomar la carta vuelta y luego el repartidor; si ambos pasan, el no repartidor debe robar del mazo.',
  'ginrummy.rules.knockOnDiscard':
    'Llamar sustituye a tu descarte, así que solo ocurre al final de tu turno.',
  ...
  'ginrummy.remedy.takeOrPassUpcard': 'Toma la carta vuelta o pásala.',
  'ginrummy.remedy.drawFirst': 'Roba primero una carta, del mazo o del descarte.',
  'ginrummy.remedy.discardToEndTurn': 'Descarta una carta para terminar el turno.',
  'ginrummy.remedy.finishLayoff': 'Ya no te encaja nada más: termina de añadir cartas.',
  'ginrummy.remedy.stockDrawForced': 'Los dos habéis pasado esa carta: roba del mazo.',
  'ginrummy.remedy.drawElsewhere': 'Ese montón está vacío: roba del otro.',
  'ginrummy.remedy.getDeadwoodDown': 'Puedes llamar cuando tu madera muerta baje a {n} o menos.',
  ...
  'err.TILE_DOES_NOT_FIT': 'Esa ficha no encaja en ese juego',
  ...
  'err.TABLE_NOT_VALID': 'Algún juego de la mesa no es un grupo ni una escalera válidos',
  ...
  'rummytiles.remedy.emptyTheTray': 'Coloca las {n} fichas que siguen en tu bandeja, o reinicia el turno.',
  'rummytiles.remedy.playFromHandOrDraw':
    'Reordenar no es un turno: juega al menos una ficha de tu mano o roba.',
  'rummytiles.remedy.fixOrReset':
    'Cada juego de la mesa debe ser un grupo o una escalera válidos: arréglalos o reinicia el turno.',
  'rummytiles.remedy.needMorePoints': 'A tu primera bajada le faltan {n} puntos para llegar a {floor}.',
  'rummytiles.remedy.ownNewSetsOnly':
    'Hasta tu primera bajada de {n} puntos, solo puedes reordenar los juegos que hayas creado en este turno.',
  'rummytiles.remedy.startANewSet': 'Ponla en un juego nuevo.',
  'rummytiles.remedy.splitLeavesThree':
    'Divide la escalera de modo que ambas mitades conserven al menos {n} fichas.',
  'rummytiles.remedy.matchTheJoker': 'Cambia el comodín por la ficha exacta que representa.',
  ...
  'blackjack.rules.roundOrder':
    'Una ronda va en orden: apuestas, reparto, seguro si el crupier muestra un as y luego cada asiento juega su mano por turno.',
  'blackjack.rules.oneStakePerRound': 'Una apuesta por ronda: una vez puesta, no se cambia.',
  'blackjack.rules.stakeFromStack': 'Solo puedes apostar fichas que tengas realmente.',
  'blackjack.remedy.putAStakeUp': 'Pon primero una apuesta: {n} o más.',
  'blackjack.remedy.answerInsurance': 'Di primero sí o no al seguro.',
  'blackjack.remedy.playThisHand': 'Juega la mano que tienes delante: pide o plántate.',
  'blackjack.remedy.stakeIsUp': 'Tu apuesta ya está puesta: espera al reparto.',
  'blackjack.remedy.stakeAtLeast': 'Apuesta al menos {n}.',
  'blackjack.remedy.stakeAtMost': 'Apuesta como mucho {n}: eso es toda tu pila.',
  'blackjack.remedy.sayHowMuch': 'Di cuánto apuestas: {n} o más.',
  'blackjack.remedy.hitOrStand': 'Pide carta o plántate.',
  'blackjack.remedy.waitForNextRound': 'Estás fuera de esta ronda: espera al siguiente reparto.',
  ...
  'intro.tagline': 'Juegos de cartas clásicos, jugados online con personas reales',
  'intro.bulletFriends': 'Juega con amigos o siéntate con otros jugadores online',
  'intro.bulletCrossDevice': 'Una sola cuenta, móvil o navegador — continúa donde lo dejaste',
  ...
  'lobby.table.side': 'Bando {n}',
  'lobby.table.shuffleSeats': 'Barajar los asientos',
  'lobby.table.moveSeatUp': 'Subir a {name} un puesto',
  ...
  'about.subtitle': 'La versión con la que juegas y la letra pequeña.',
  ...
  'option.openDiscardPile': 'Montón de descarte',
  'choice.openDiscardPile.1': 'Se puede consultar',
  'choice.openDiscardPile.0': 'Solo la carta superior',
  ...
  'mine.replay': 'Repetición',
  'replay.loading': 'Abriendo la repetición…',
  'replay.failed': 'No se pudo cargar la repetición',
  'replay.openHands': 'todas las manos a la vista',
  'replay.truncated': 'Esta partida se reproduce hasta la jugada {at} — sus reglas han cambiado desde entonces',
  'replay.position': '{at} de {of}',
  'replay.theDeal': 'El reparto',
  'replay.round': 'Ronda',
  'replay.track.all': 'Todo',
  'replay.track.yours': 'Tus jugadas',
  'replay.track.rounds': 'Rondas',
  'replay.track.marks': 'Marcas',
  ...
  'err.ALREADY_SHOWN': 'Tu mano ya está boca arriba',
  'err.NOTHING_TO_SHOW': 'No tienes ninguna mano que mostrar',
  'holdem.offer.show': 'Mostrar mi mano',
  'holdem.offer.finish': 'Terminar la partida',
  'holdem.remedy.nothingToShow': 'No participaste en esta mano — espera a la siguiente.',
  'holdem.rules.section.showdown': 'Después de la mano',
  'holdem.rules.stopEveryHand': 'El juego se detiene tras cada mano, para que se vean las cartas.',
  'holdem.rules.revealEveryone': 'En el showdown se descubren todas las manos que pagaron.',
  'holdem.rules.revealWinners': 'En el showdown solo se descubre la mano ganadora.',
  'holdem.rules.showYourOwn': 'Siempre puedes descubrir tu propia mano, hasta que aceptes continuar.',
  'holdem.rules.showOnce': 'Una mano solo se puede mostrar una vez.',
  'holdem.seat.won': 'Ganó',
  'holdem.seat.mucked': 'No mostró',
  'holdem.status.mucked': '{playerId} no mostró',
  'holdem.status.shownVoluntary': '{playerId} mostró su mano',
  'zone.shownHand': 'Mostrada',
  'option.showdownReveal': 'Mostrar en el showdown',
  'choice.showdownReveal.2': 'Todos los que pagaron',
  'choice.showdownReveal.1': 'Solo el ganador',
  'home.playOffline': 'Jugar sin conexión',
  'offline.title': 'Jugar sin conexión',
  'offline.subtitle': 'Sin internet',
  'offline.body': 'Este teléfono aloja la mesa él mismo, así que puedes jugar contra bots en cualquier lugar, incluso en modo avión.',
  'offline.nameLabel': 'Tu nombre en la mesa',
  'offline.start': 'Abrir una mesa sin conexión',
  'offline.starting': 'Iniciando…',
  'offline.active': 'Estás en la mesa sin conexión de este teléfono. Las partidas que empieces aquí se quedan en este teléfono.',
  'offline.chooseGame': 'Elegir un juego',
  'offline.backOnline': 'Volver al juego en línea',
  'offline.failed': 'La mesa sin conexión no se inició: {reason}',
  'offline.nearbyTitle': 'Mesas cercanas',
  'offline.nearbyLooking': 'Buscando mesas en esta red…',
  'offline.nearbyNothing': 'Aún no hay mesas. Comprueba que estás en la misma Wi-Fi o punto de acceso que el anfitrión y que Zolik puede usar la red local.',
  'offline.joinThis': 'Unirse',
  'offline.byAddressTitle': 'Unirse por dirección',
  'offline.versionMismatch': 'Esta mesa usa otra versión de Zolik. Actualiza la app en ambos teléfonos.',
  'offline.roomTitle': 'Jugadores cercanos',
  'offline.roomBody': 'Deja que otros teléfonos de esta Wi-Fi o punto de acceso se unan a tu mesa. Sin internet.',
  'offline.roomOpenButton': 'Invitar a jugadores cercanos',
  'offline.roomOpen': 'Los demás teléfonos de esta red ya pueden encontrar tu mesa. Si no la ven, pueden escribir la dirección o escanear el código.',
  'offline.roomClose': 'Dejar de invitar',
  'offline.guestActive': 'Estás en una mesa alojada por otro teléfono ({host}).',
  'offline.joinFailed': 'No se pudo unir a esa mesa: {reason}',
  'invite.offlineExplain': 'Los jugadores de esta mesa sin conexión se unen con este código, en «{menu}».',
  'invite.offlineCode': 'Código:',
  'offline.bleTitle': 'Por Bluetooth',
  'offline.bleLook': 'Buscar mesas por Bluetooth',
  'offline.bleLooking': 'Buscando mesas por Bluetooth…',
  'offline.bleOff': 'Activa el Bluetooth para encontrar mesas sin Wi-Fi.',
  'offline.bleDenied': 'Permite que Zolik use el Bluetooth en Ajustes para jugar sin Wi-Fi.',
  'offline.bleInvite': 'Invitar por Bluetooth',
  'offline.bleInviteBody': 'Para teléfonos que no comparten Wi-Fi con el tuyo. No hace falta emparejar.',
  'offline.bleOpen': 'Los teléfonos cercanos pueden unirse por Bluetooth. Conectados: {n}.',
  'offline.bleStop': 'Detener Bluetooth',
  'offline.bleCheck': 'Código de comprobación: {code}',
  'offline.guestBle': 'Estás en una mesa alojada por otro teléfono, por Bluetooth.',
  'offline.keyChanged': 'Este no es el teléfono en el que jugaste antes con ese nombre. Pregunta al anfitrión o únete por Wi-Fi.',
  // --- game notifications: invites, the game circle, push (src/notify) ---
  'err.NOT_PLAYED_TOGETHER': 'Solo puedes añadir a personas con las que has jugado. Envíales tu enlace de amigo o pídelo por nombre de usuario.',
  'err.UNKNOWN_PLAYER': 'Nadie juega con ese nombre.',
  'err.UNKNOWN_FRIEND_CODE': 'Ese enlace de amigo ya no funciona.',
  'err.CANNOT_ADD_SELF': 'Ese eres tú. Añade a otra persona.',
  'err.RATE_LIMITED': 'Demasiadas a la vez. Vuelve a intentarlo en unos minutos.',
  'err.PUSH_UNAVAILABLE': 'Las notificaciones no están configuradas en este servidor.',
  'notify.someone': 'Alguien',
  'notify.join': 'Unirse',
  'notify.joining': 'Uniéndote…',
  'notify.goToTable': 'Ir a la mesa',
  'notify.notNow': 'Ahora no',
  'notify.moreOptions': 'Más opciones',
  'notify.muteHost': 'No recibir invitaciones de {host}',
  'notify.joinFailed': 'No se pudo unir: {reason}',
  'notify.hostingOffline': 'Estás alojando una mesa en este teléfono. Déjala primero para unirte a otra.',
  'notify.on': 'Activado',
  'notify.off': 'Desactivado',
  'notify.channelName': 'Invitaciones de juego',
  'notify.banner.online': '{host} abrió una mesa de {game}',
  'notify.banner.onlineNoGame': '{host} abrió una mesa',
  'notify.banner.nearby': '{host} aloja una mesa cerca',
  'notify.banner.seated': 'Te han sentado en una mesa',
  'notify.banner.fromCircle': 'De tu círculo de juego',
  'notify.banner.known': 'Ya habéis jugado juntos',
  'notify.banner.nearbyDetail': 'En un teléfono cerca de ti',
  'notify.banner.seatedDetail': 'Un anfitrión te eligió de la sala de espera',
  'notify.banner.more': '+{n} más',
  'notify.pillOne': '1 mesa esperando',
  'notify.pillMany': '{n} mesas esperando',
  'notify.waitingCard.title': 'Mesas que te esperan',
  'notify.waitingCard.empty': 'Ninguna mesa te espera.',
  'notify.prompt.title': 'Entérate cuando tu círculo empiece una partida',
  'notify.prompt.body': 'Solo mesas abiertas por personas de tu círculo de juego. Puedes desactivarlo en Ajustes.',
  'notify.prompt.enable': 'Activar',
  'notify.prompt.later': 'Más tarde',
  'notify.settings.heading': 'Notificaciones',
  'notify.settings.invites': 'Invitaciones de juego',
  'notify.settings.invitesBody': 'Quién puede avisarte cuando abre una mesa.',
  'notify.settings.invitesCircle': 'Mi círculo',
  'notify.settings.invitesOff': 'Nadie',
  'notify.settings.nearby': 'Mesas cercanas',
  'notify.settings.nearbyBody': 'Mostrar un aviso cuando un teléfono cercano abra una mesa. Funciona con la app abierta.',
  'notify.settings.push': 'Notificaciones en este dispositivo',
  'notify.settings.pushOn': 'Activadas. Te enterarás de las mesas aunque la app esté cerrada.',
  'notify.settings.pushOff': 'Desactivadas. Las invitaciones solo aparecen con la app abierta.',
  'notify.settings.pushBlocked': 'Bloqueadas. Permite las notificaciones de esta app en los ajustes del teléfono.',
  'notify.settings.pushBlockedWeb': 'Bloqueadas. Permite las notificaciones de este sitio en los ajustes del navegador.',
  'notify.settings.pushInstall': 'En iPhone y iPad, añade primero este sitio a la pantalla de inicio y activa allí las notificaciones.',
  'notify.settings.pushUnavailable': 'Este servidor no envía notificaciones.',
  'notify.settings.pushUnsupported': 'Este dispositivo o navegador no puede mostrar notificaciones.',
  'notify.settings.signIn': 'Inicia sesión o juega como invitado para recibir invitaciones de juego.',
  'notify.announce.heading': 'Avisar a mi círculo',
  'notify.announce.body': 'Las personas de tu círculo de juego sabrán de esta mesa y podrán unirse con un toque.',
  'notify.announce.toggle': 'Avisar a mi círculo cuando abra una mesa',
  'notify.announce.sending': 'Avisando a tu círculo…',
  'notify.announce.toldOne': '1 jugador avisado',
  'notify.announce.toldMany': '{n} jugadores avisados',
  'notify.announce.already': 'Tu círculo ya sabe de esta mesa.',
  'notify.announce.nobody': 'Aún no hay a quién avisar. Añade personas a tu círculo.',
  'notify.announce.circleLink': 'Círculo de juego',
  'notify.addToCircle': 'Añadir a {name} a tu círculo',
  ...
  'offline.tellNearbyBody': 'A los teléfonos de la sala con la app abierta se les ofrece esta mesa.',
  'circle.title': 'Círculo de juego',
  'circle.subtitle': 'Las personas a las que avisas cuando abres una mesa y las que te avisan a ti.',
  'circle.signInRequired': 'Inicia sesión o juega como invitado para crear un círculo de juego.',
  'circle.requests.heading': 'Solicitudes',
  'circle.requests.body': 'Quieren avisarte cuando abran una mesa.',
  'circle.accept': 'Aceptar',
  'circle.decline': 'Rechazar',
  'circle.members.heading': 'Tu círculo',
  'circle.members.body': 'Se enteran de las mesas que abres para tus amigos.',
  'circle.members.empty': 'Nadie todavía. Añade personas abajo.',
  'circle.pending': 'Esperando que acepte',
  'circle.since': 'Desde {date}',
  'circle.remove': 'Quitar',
  'circle.notifiers.heading': 'Quién puede invitarte',
  'circle.notifiers.body': 'Silencia a quien no quieras oír cuando abra una mesa.',
  'circle.notifiers.empty': 'Nadie te ha añadido todavía.',
  'circle.mute': 'Silenciar',
  'circle.unmute': 'Reactivar',
  'circle.muted': 'Silenciado',
  'circle.suggestions.heading': 'Jugado recientemente',
  'circle.suggestions.body': 'Personas con las que has compartido mesa. Añádelas para avisarles de tus mesas.',
  'circle.lastPlayed': 'Última partida: {date}',
  'circle.add': 'Añadir',
  'circle.added': '{name} está en tu círculo.',
  'circle.addSomeone.heading': 'Añadir a alguien',
  'circle.friendLink.body': 'Quien abra tu enlace de amigo entra en tu círculo, y tú en el suyo.',
  'circle.shareMessage': 'Únete a mi círculo de juego en Jokerless',
  'circle.username.body': 'O pídelo por nombre de usuario. La otra persona tiene que aceptar.',
  'circle.username.placeholder': 'Nombre de usuario',
  'circle.username.submit': 'Enviar solicitud',
  'circle.username.sent': 'Solicitud enviada a {name}.',
  'circle.settingsLink': 'Ajustes de notificaciones',
  'circle.addFriend.title': 'Añadir al círculo de juego',
  'circle.addFriend.loading': 'Comprobando el enlace…',
  'circle.addFriend.missing': 'Este enlace no tiene código de amigo.',
  'circle.addFriend.body': '{name} te invita a su círculo de juego. Cada uno sabrá cuándo el otro abre una mesa.',
